...
public class PT_CUSingPlay : MonoBehaviour
{
        ...
        if (csSingleton.getInstance.g_bTarget)
        {
            ...
            if (Round <= RoundStop && !isRead && !isSpace && !isEnd)
            {
                if (Counting == 0 && !isRead && !isSpace)
                {
                    ...
                    PlayersScore += DartScore[0];
                    RoundScore(DartScore[0]);
                    gmg.DartScoreActor(csSingleton.getInstance.g_nTargetLine, DartBasicScore[0], Counting);
                    g_MScore.GetComponent<csNumber>().SetNumber(PlayersScore);
                    g_PScore.GetComponent<csNumber>().SetNumber(PlayersScore);
                    Counting = 1;
                }
    ...
    public void RoundScore(int n)
    {
        ...
        {
            if (RScore == 0)
                t_RScoreText[0].text = n.ToString();
            else if (RScore == 1)
                t_RScoreText[1].text = n.ToString();
            else if (RScore == 2)
                t_RScoreText[2].text = n.ToString();
            else if (RScore == 3)
                t_RScoreText[3].text = n.ToString();
            else if (RScore == 4)
                t_RScoreText[4].text = n.ToString();
            else if (RScore == 5)
            {
    ...
    public void RScoreImageUp()
    {
        if (RScore == 5)
        {
            ...
            t_RScoreText[4].text = "0".ToString();
        }
        if (RScore == 6)
        {
