...
public class PT_CUFourPlay : MonoBehaviour
{
    public Text t_RoundText;
    public Text t_PPDText_P1;
    public Text t_PPDText_P2;
    public Text t_PPDText_P3;
    public Text t_PPDText_P4;
    public Text[] t_RScoreText_P1 = new Text[5];
    public Text[] t_RScoreText_P2 = new Text[5];
    public Text[] t_RScoreText_P3 = new Text[5];
    public Text[] t_RScoreText_P4 = new Text[5];
    ...
    public GameObject[] g_RScore = new GameObject[4];
    ...
    public Image[] i_Rscore_P3 = new Image[5];
    public Image[] i_Rscore_P4 = new Image[5];
    ...
    public int[] P4_ScoreSave = new int[8];
    ...
    void Update()
    {
        ...
        if (csSingleton.getInstance.g_bTarget)
        {
            ...
            if (Round <= RoundStop && !isRead && !isSpace && !isEnd)
            {
                ...
                else if (Players == 3 && !isRead && !isSpace && !isEnd)
                {
                    if (Counting == 0 && !isRead && !isSpace)
                    {
                        P4_AverageCounting++;
                        ...
                        m_oDartInfo[0].nLine = csSingleton.getInstance.g_nTargetLine;
                        PPDScore(DartScore[0]);
                        PlayerScore[3] += DartScore[0];
                        RoundScore(DartScore[0]);
                        gmg.DartScoreActor(csSingleton.getInstance.g_nTargetLine, DartBasicScore[0], Counting);
                        g_MScore[3].GetComponent<csNumber>().SetNumber(PlayerScore[3]);
                        g_PScore[3].GetComponent<csNumber>().SetNumber(PlayerScore[3]);
                        DartS = 0;
                        DartM = 0;
                        Counting = 1;
                    }
        ...
        if (Input.GetKeyDown(KeyCode.Space) && gmg.isAni == false && isSpace && Counting == 4 && !isEnd)
        {
            ...
            else if (Players == 2 && !isRead && !isEnd)
            {
                a_source.PlayOneShot(ac_shoot2, 1.0f);
                for (int i = 0; i < g_Dart.Length; i++)
                    g_Dart[i].GetComponent<Image>().sprite = s_OffDart;
            ...
            else if (Players == 3 && !isRead && !isEnd)
            {
                a_source.PlayOneShot(ac_shoot2, 1.0f);
                for (int i = 0; i < g_Dart.Length; i++)
                    g_Dart[i].GetComponent<Image>().sprite = s_OffDart;
    ...
    void MyTure()
    {
        if (isP1 && !isP2 && !isP3 && !isP4)
        {
            ...
            t_PPDText_P3.enabled = false;
            t_PPDText_P4.enabled = false;

            for (int i = 0; i < i_Rscore_P1.Length; i++)
            {
                i_Rscore_P1[i].enabled = true;
                i_Rscore_P2[i].enabled = false;
                i_Rscore_P3[i].enabled = false;
                i_Rscore_P4[i].enabled = false;
            }
        }
    ...
    public void RoundScore(int n)
    {
        ...
        if (isP3 && !isP4 && !isP1 && !isP2)
        {
            ...
            {
                if (RScore == 0)
                    t_RScoreText_P3[0].text = P3_ScoreSave[0].ToString();
                else if (RScore == 1)
                    t_RScoreText_P3[1].text = P3_ScoreSave[1].ToString();
                else if (RScore == 2)
                    t_RScoreText_P3[2].text = P3_ScoreSave[2].ToString();
                else if (RScore == 3)
                    t_RScoreText_P3[3].text = P3_ScoreSave[3].ToString();
                else if (RScore == 4)
                    t_RScoreText_P3[4].text = P3_ScoreSave[4].ToString();
                else if (RScore == 5)
                {
                    t_RScoreText_P3[0].text = P3_ScoreSave[1].ToString();
                    t_RScoreText_P3[1].text = P3_ScoreSave[2].ToString();
                    t_RScoreText_P3[2].text = P3_ScoreSave[3].ToString();
                    t_RScoreText_P3[3].text = P3_ScoreSave[4].ToString();
                    t_RScoreText_P3[4].text = P3_ScoreSave[5].ToString();
                }
                else if (RScore == 6)
                {
                    t_RScoreText_P3[0].text = P3_ScoreSave[2].ToString();
                    t_RScoreText_P3[1].text = P3_ScoreSave[3].ToString();
                    t_RScoreText_P3[2].text = P3_ScoreSave[4].ToString();
                    t_RScoreText_P3[3].text = P3_ScoreSave[5].ToString();
                    t_RScoreText_P3[4].text = P3_ScoreSave[6].ToString();
                }
                else if (RScore == 7)
                {
                    t_RScoreText_P3[0].text = P3_ScoreSave[3].ToString();
                    t_RScoreText_P3[1].text = P3_ScoreSave[4].ToString();
                    t_RScoreText_P3[2].text = P3_ScoreSave[5].ToString();
                    t_RScoreText_P3[3].text = P3_ScoreSave[6].ToString();
                    t_RScoreText_P3[4].text = P3_ScoreSave[7].ToString();
                }
                else if (RScore == 8)
                {
                    t_RScoreText_P3[0].text = P3_ScoreSave[4].ToString();
                    t_RScoreText_P3[1].text = P3_ScoreSave[5].ToString();
                    t_RScoreText_P3[2].text = P3_ScoreSave[6].ToString();
                    t_RScoreText_P3[3].text = P3_ScoreSave[7].ToString();
                    t_RScoreText_P3[4].text = P3_ScoreSave[8].ToString();
                }
            }
        }
        if (isP4 && !isP1 && !isP2 && !isP3)
        {
            P4_ScoreSave[RScore] = n;
            if (Round <= RoundStop)
            {
                if (RScore == 0)
                    t_RScoreText_P4[0].text = P4_ScoreSave[0].ToString();
                else if (RScore == 1)
                    t_RScoreText_P4[1].text = P4_ScoreSave[1].ToString();
                else if (RScore == 2)
                    t_RScoreText_P4[2].text = P4_ScoreSave[2].ToString();
                else if (RScore == 3)
                    t_RScoreText_P4[3].text = P4_ScoreSave[3].ToString();
                else if (RScore == 4)
                    t_RScoreText_P4[4].text = P4_ScoreSave[4].ToString();
                else if (RScore == 5)
                {
                    t_RScoreText_P4[0].text = P4_ScoreSave[1].ToString();
                    t_RScoreText_P4[1].text = P4_ScoreSave[2].ToString();
                    t_RScoreText_P4[2].text = P4_ScoreSave[3].ToString();
                    t_RScoreText_P4[3].text = P4_ScoreSave[4].ToString();
                    t_RScoreText_P4[4].text = P4_ScoreSave[5].ToString();
                }
                else if (RScore == 6)
                {
                    t_RScoreText_P4[0].text = P4_ScoreSave[2].ToString();
                    t_RScoreText_P4[1].text = P4_ScoreSave[3].ToString();
                    t_RScoreText_P4[2].text = P4_ScoreSave[4].ToString();
                    t_RScoreText_P4[3].text = P4_ScoreSave[5].ToString();
                    t_RScoreText_P4[4].text = P4_ScoreSave[6].ToString();
                }
                else if (RScore == 7)
                {
                    t_RScoreText_P4[0].text = P4_ScoreSave[3].ToString();
                    t_RScoreText_P4[1].text = P4_ScoreSave[4].ToString();
                    t_RScoreText_P4[2].text = P4_ScoreSave[5].ToString();
                    t_RScoreText_P4[3].text = P4_ScoreSave[6].ToString();
                    t_RScoreText_P4[4].text = P4_ScoreSave[7].ToString();
                }
                else if (RScore == 8)
                {
                    t_RScoreText_P4[0].text = P4_ScoreSave[4].ToString();
                    t_RScoreText_P4[1].text = P4_ScoreSave[5].ToString();
                    t_RScoreText_P4[2].text = P4_ScoreSave[6].ToString();
                    t_RScoreText_P4[3].text = P4_ScoreSave[7].ToString();
                    t_RScoreText_P4[4].text = P4_ScoreSave[8].ToString();
                }
            }
        }
    }
    public void RScoreImageUp()
    {
        ...
        if (isP3 && !isP4 && !isP1 && !isP2)
        {
            if (Round <= RoundStop)
            {
                if (RScore == 5)
                {
                    i_Rscore_P3[0].GetComponent<Image>().sprite = s_RScore[1];
                    i_Rscore_P3[1].GetComponent<Image>().sprite = s_RScore[2];
                    i_Rscore_P3[2].GetComponent<Image>().sprite = s_RScore[3];
                    i_Rscore_P3[3].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_P3[4].GetComponent<Image>().sprite = s_RScore[5];
                }
                if (RScore == 6)
                {
                    i_Rscore_P3[0].GetComponent<Image>().sprite = s_RScore[2];
                    i_Rscore_P3[1].GetComponent<Image>().sprite = s_RScore[3];
                    i_Rscore_P3[2].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_P3[3].GetComponent<Image>().sprite = s_RScore[5];
                    i_Rscore_P3[4].GetComponent<Image>().sprite = s_RScore[6];
                }
                if (RScore == 7)
                {
                    i_Rscore_P3[0].GetComponent<Image>().sprite = s_RScore[3];
                    i_Rscore_P3[1].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_P3[2].GetComponent<Image>().sprite = s_RScore[5];
                    i_Rscore_P3[3].GetComponent<Image>().sprite = s_RScore[6];
                    i_Rscore_P3[4].GetComponent<Image>().sprite = s_RScore[7];
                }
                if (RScore == 8)
                {
                    i_Rscore_P3[0].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_P3[1].GetComponent<Image>().sprite = s_RScore[5];
                    i_Rscore_P3[2].GetComponent<Image>().sprite = s_RScore[6];
                    i_Rscore_P3[3].GetComponent<Image>().sprite = s_RScore[7];
                    i_Rscore_P3[4].GetComponent<Image>().sprite = s_RScore[8];
                }
            }
        }
        if (isP4 && !isP1 && !isP2 && !isP3)
        {
            if (Round <= RoundStop)
            {
                if (RScore == 5)
                {
                    i_Rscore_P4[0].GetComponent<Image>().sprite = s_RScore[1];
                    i_Rscore_P4[1].GetComponent<Image>().sprite = s_RScore[2];
                    i_Rscore_P4[2].GetComponent<Image>().sprite = s_RScore[3];
                    i_Rscore_P4[3].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_P4[4].GetComponent<Image>().sprite = s_RScore[5];
                }
                if (RScore == 6)
                {
                    i_Rscore_P4[0].GetComponent<Image>().sprite = s_RScore[2];
                    i_Rscore_P4[1].GetComponent<Image>().sprite = s_RScore[3];
                    i_Rscore_P4[2].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_P4[3].GetComponent<Image>().sprite = s_RScore[5];
                    i_Rscore_P4[4].GetComponent<Image>().sprite = s_RScore[6];
                }
                if (RScore == 7)
                {
                    i_Rscore_P4[0].GetComponent<Image>().sprite = s_RScore[3];
                    i_Rscore_P4[1].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_P4[2].GetComponent<Image>().sprite = s_RScore[5];
                    i_Rscore_P4[3].GetComponent<Image>().sprite = s_RScore[6];
                    i_Rscore_P4[4].GetComponent<Image>().sprite = s_RScore[7];
                }
                if (RScore == 8)
                {
                    i_Rscore_P4[0].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_P4[1].GetComponent<Image>().sprite = s_RScore[5];
                    i_Rscore_P4[2].GetComponent<Image>().sprite = s_RScore[6];
                    i_Rscore_P4[3].GetComponent<Image>().sprite = s_RScore[7];
                    i_Rscore_P4[4].GetComponent<Image>().sprite = s_RScore[8];
                }
            }
        }
    }
    ...
    void PPDScore(int n)
    {
        if (Players == 0)
        {
            ...
            t_PPDText_P1.text = string.Format("{0:N2}", P1_Average);
        }
        else if (Players == 1)
        {
            P2_DartTotal += n;
            P2_Average = P2_DartTotal / P2_AverageCounting;
            t_PPDText_P2.text = string.Format("{0:N2}", P2_Average);
        }
        else if (Players == 2)
        {
            P3_DartTotal += n;
            P3_Average = P3_DartTotal / P3_AverageCounting;
            t_PPDText_P3.text = string.Format("{0:N2}", P3_Average);
        }
        else if (Players == 3)
        {
            P4_DartTotal += n;
            P4_Average = P4_DartTotal / P4_AverageCounting;
            t_PPDText_P4.text = string.Format("{0:N2}", P4_Average);
        }
    }
