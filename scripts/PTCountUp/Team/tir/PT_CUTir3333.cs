...
public class PT_CUTir3333 : MonoBehaviour
{
    ...
    public Text t_PPDText_D1;
    public Text t_PPDText_D2;
    public Text t_PPDText_D3;
    ...
    public Text[] t_RScoreText_D1 = new Text[5];
    public Text[] t_RScoreText_D2 = new Text[5];
    public Text[] t_RScoreText_D3 = new Text[5];
    ...
    public GameObject[] g_MScore = new GameObject[4];
    public GameObject[] g_PScore = new GameObject[4];
    ...
    public Sprite[] s_OnTeambar = new Sprite[4];
    public Sprite[] s_OffTeambar = new Sprite[4];
    ...
    public Image[] i_Rscore_D1 = new Image[5];
    public Image[] i_Rscore_D2 = new Image[5];
    public Image[] i_Rscore_D3 = new Image[5];
    ...
    public int D1_DartTotal = 0;
    public int D2_DartTotal = 0;
    public int D3_DartTotal = 0;
    public int DartS = 0;
    public int DartM = 0;
    public int RScore = 0;
    ...
    public int D1_Average = 0;
    public int D2_Average = 0;
    public int D3_Average = 0;
    public int AT_Average = 0;
    public int BT_Average = 0;
    public int CT_Average = 0;
    public int DT_Average = 0;
    ...
    public int D1_AverageCounting = 0;
    public int D2_AverageCounting = 0;
    public int D3_AverageCounting = 0;
    ...
    public int[] D1_ScoreSave = new int[8];
    public int[] D2_ScoreSave = new int[8];
    public int[] D3_ScoreSave = new int[8];
    ...
    void Update()
    {
        ...
        if (csSingleton.getInstance.g_bTarget)
        {
            ...
            if (Round <= RoundStop && !isRead && !isSpace && !isEnd)
            {
                ...
                else if (Teams == 3 && Players == 0 && !isRead && !isSpace && !isEnd)
                {
                    if (Counting == 0 && !isRead && !isSpace)
                    {
                        D1_AverageCounting++;
                        ...
                        m_oDartInfo[0].nLine = csSingleton.getInstance.g_nTargetLine;
                        PPDScore(DartScore[0]);
                        TeamScore[3] += DartScore[0];
                        RoundScore(DartScore[0]);
                        gmg.DartScoreActor(csSingleton.getInstance.g_nTargetLine, DartBasicScore[0], Counting);
                        g_MScore[3].GetComponent<csNumber>().SetNumber(TeamScore[3]);
                        g_PScore[3].GetComponent<csNumber>().SetNumber(TeamScore[3]);
                        DartS = 0;
                        DartM = 0;
                        Counting = 1;
                    }
                    ...
                    {
                        GetMovie();
                        g_MScore[3].SetActive(false);
                        g_PAni.SetActive(true);
                        isSpace = true;
                        Counting = 4;
                    }
                }
                else if (Teams == 3 && Players == 1 && !isRead && !isSpace && !isEnd)
                {
                    if (Counting == 0 && !isRead && !isSpace)
                    {
                        D2_AverageCounting++;
                ...
                else if (Teams == 3 && Players == 2 && !isRead && !isSpace && !isEnd)
                {
                    if (Counting == 0 && !isRead && !isSpace)
                    {
                        D3_AverageCounting++;
        ...
        if (Input.GetKeyDown(KeyCode.Space) && isSpace && Counting == 4 && !isEnd)
        {
            ...
            else if (Teams == 3 && Players == 0 && !isRead && !isEnd)
            {
                a_source.PlayOneShot(ac_shoot2, 1.0f);
                for (int i = 0; i < g_Dart.Length; i++)
                    g_Dart[i].GetComponent<Image>().sprite = s_OffDart;
            ...
            else if (Teams == 3 && Players == 1 && !isRead && !isEnd)
            {
                a_source.PlayOneShot(ac_shoot2, 1.0f);
                for (int i = 0; i < g_Dart.Length; i++)
                    g_Dart[i].GetComponent<Image>().sprite = s_OffDart;
            ...
            else if (Teams == 3 && Players == 2 && !isRead && !isEnd)
            {
                a_source.PlayOneShot(ac_shoot2, 1.0f);
                for (int i = 0; i < g_Dart.Length; i++)
                    g_Dart[i].GetComponent<Image>().sprite = s_OffDart;
    ...
    void MyTure()
    {
        if (isAT && !isBT && !isCT && !isDT && Players == 0)
        {
            ...
            g_Playerbar[3].GetComponent<Image>().sprite = s_OffPlayer[0];
            ...
            g_Teambar[3].GetComponent<Image>().sprite = s_OffTeambar[3];
            ...
            t_PPDText_D1.enabled = false;
            t_PPDText_D2.enabled = false;
            t_PPDText_D3.enabled = false;
            ...
            for (int i = 0; i < i_Rscore_A1.Length; i++)
            {
                ...
                i_Rscore_D1[i].enabled = false;
                i_Rscore_D2[i].enabled = false;
                i_Rscore_D3[i].enabled = false;
            }
        }

        else if (isBT && !isCT && !isDT && !isAT && Players == 0)
        {
        ...
        else if (isCT && !isDT && !isAT && !isBT && Players == 0)
        {
            g_AT.transform.position = new Vector3(g_AT.transform.position.x, g_AT.transform.position.y, 0f);
            g_BT.transform.position = new Vector3(g_BT.transform.position.x, g_BT.transform.position.y, 0f);
        ...
        else if (isDT && !isAT && !isBT && !isCT && Players == 0)
        {
            g_AT.transform.position = new Vector3(g_AT.transform.position.x, g_AT.transform.position.y, 0f);
            g_BT.transform.position = new Vector3(g_BT.transform.position.x, g_BT.transform.position.y, 0f);
            g_CT.transform.position = new Vector3(g_CT.transform.position.x, g_CT.transform.position.y, 0f);
            ...
            g_Playerbar[0].GetComponent<Image>().sprite = s_OffPlayer[0];
            g_Playerbar[2].GetComponent<Image>().sprite = s_OffPlayer[0];
            g_Playerbar[3].GetComponent<Image>().sprite = s_OnPlayer[0];

            g_Teambar[0].GetComponent<Image>().sprite = s_OffTeambar[0];
            g_Teambar[1].GetComponent<Image>().sprite = s_OffTeambar[1];
            g_Teambar[2].GetComponent<Image>().sprite = s_OffTeambar[2];
            g_Teambar[3].GetComponent<Image>().sprite = s_OnTeambar[3];
            ...
            for (int i = 0; i < i_Rscore_A2.Length; i++)
            {
                ...
                i_Rscore_C2[i].enabled = false;
                i_Rscore_C3[i].enabled = false;
                i_Rscore_D1[i].enabled = true;
                i_Rscore_D2[i].enabled = false;
                i_Rscore_D3[i].enabled = false;
            }
        }

        else if (isAT && !isBT && !isCT && !isDT && Players == 1)
        {
            g_AT.transform.position = new Vector3(g_AT.transform.position.x, g_AT.transform.position.y, -10f);
            g_BT.transform.position = new Vector3(g_BT.transform.position.x, g_BT.transform.position.y, 0f);
            g_CT.transform.position = new Vector3(g_CT.transform.position.x, g_CT.transform.position.y, 0f);
            ...
            g_Playerbar[3].GetComponent<Image>().sprite = s_OffPlayer[1];
        ...
        else if (isBT && !isCT && !isDT && !isAT && Players == 1)
        {
            g_AT.transform.position = new Vector3(g_AT.transform.position.x, g_AT.transform.position.y, 0f);
            g_BT.transform.position = new Vector3(g_BT.transform.position.x, g_BT.transform.position.y, -10f);
            g_CT.transform.position = new Vector3(g_CT.transform.position.x, g_CT.transform.position.y, 0f);
        ...
        else if (isCT && !isDT && !isAT && !isBT && Players == 1)
        {
            g_AT.transform.position = new Vector3(g_AT.transform.position.x, g_AT.transform.position.y, 0f);
            g_BT.transform.position = new Vector3(g_BT.transform.position.x, g_BT.transform.position.y, 0f);
            g_CT.transform.position = new Vector3(g_CT.transform.position.x, g_CT.transform.position.y, -10f);
        ...
        else if (isDT && !isAT && !isBT && !isCT && Players == 1)
        {
            g_AT.transform.position = new Vector3(g_AT.transform.position.x, g_AT.transform.position.y, 0f);
            g_BT.transform.position = new Vector3(g_BT.transform.position.x, g_BT.transform.position.y, 0f);
            g_CT.transform.position = new Vector3(g_CT.transform.position.x, g_CT.transform.position.y, 0f);
            ...
            g_Playerbar[0].GetComponent<Image>().sprite = s_OffPlayer[1];
            g_Playerbar[2].GetComponent<Image>().sprite = s_OffPlayer[1];
            g_Playerbar[3].GetComponent<Image>().sprite = s_OnPlayer[1];
            ...
            for (int i = 0; i < i_Rscore_A2.Length; i++)
            {
                ...
                i_Rscore_C3[i].enabled = false;
                i_Rscore_D1[i].enabled = false;
                i_Rscore_D2[i].enabled = true;
                i_Rscore_D3[i].enabled = false;
            }
        }

        else if (isAT && !isBT && !isCT && !isDT && Players == 2)
        {
            g_AT.transform.position = new Vector3(g_AT.transform.position.x, g_AT.transform.position.y, -10f);
            g_BT.transform.position = new Vector3(g_BT.transform.position.x, g_BT.transform.position.y, 0f);
            g_CT.transform.position = new Vector3(g_CT.transform.position.x, g_CT.transform.position.y, 0f);
            ...
            g_Playerbar[3].GetComponent<Image>().sprite = s_OffPlayer[2];
        ...
        else if (isBT && !isCT && !isDT && !isAT && Players == 2)
        {
            g_AT.transform.position = new Vector3(g_AT.transform.position.x, g_AT.transform.position.y, 0f);
            g_BT.transform.position = new Vector3(g_BT.transform.position.x, g_BT.transform.position.y, -10f);
            g_CT.transform.position = new Vector3(g_CT.transform.position.x, g_CT.transform.position.y, 0f);
        ...
        else if (isCT && !isDT && !isAT && !isBT && Players == 2)
        {
            g_AT.transform.position = new Vector3(g_AT.transform.position.x, g_AT.transform.position.y, 0f);
            g_BT.transform.position = new Vector3(g_BT.transform.position.x, g_BT.transform.position.y, 0f);
            g_CT.transform.position = new Vector3(g_CT.transform.position.x, g_CT.transform.position.y, -10f);
        ...
        else if (isDT && !isAT && !isBT && !isCT && Players == 2)
        {
            g_AT.transform.position = new Vector3(g_AT.transform.position.x, g_AT.transform.position.y, 0f);
            g_BT.transform.position = new Vector3(g_BT.transform.position.x, g_BT.transform.position.y, 0f);
            g_CT.transform.position = new Vector3(g_CT.transform.position.x, g_CT.transform.position.y, 0f);
            ...
            g_Playerbar[1].GetComponent<Image>().sprite = s_OffPlayer[2];
            g_Playerbar[2].GetComponent<Image>().sprite = s_OffPlayer[2];
            g_Playerbar[3].GetComponent<Image>().sprite = s_OnPlayer[2];
    ...
    public void RoundScore(int n)
    {
        ...
        {
            D1_ScoreSave[RScore] = n;
            if (Round <= RoundStop)
            {
                if (RScore == 0)
                    t_RScoreText_D1[0].text = D1_ScoreSave[0].ToString();
                else if (RScore == 1)
                    t_RScoreText_D1[1].text = D1_ScoreSave[1].ToString();
                else if (RScore == 2)
                    t_RScoreText_D1[2].text = D1_ScoreSave[2].ToString();
                else if (RScore == 3)
                    t_RScoreText_D1[3].text = D1_ScoreSave[3].ToString();
                else if (RScore == 4)
                    t_RScoreText_D1[4].text = D1_ScoreSave[4].ToString();
                else if (RScore == 5)
                {
                    t_RScoreText_D1[0].text = D1_ScoreSave[1].ToString();
                    t_RScoreText_D1[1].text = D1_ScoreSave[2].ToString();
                    t_RScoreText_D1[2].text = D1_ScoreSave[3].ToString();
                    t_RScoreText_D1[3].text = D1_ScoreSave[4].ToString();
                    t_RScoreText_D1[4].text = D1_ScoreSave[5].ToString();
                }
                else if (RScore == 6)
                {
                    t_RScoreText_D1[0].text = D1_ScoreSave[2].ToString();
                    t_RScoreText_D1[1].text = D1_ScoreSave[3].ToString();
                    t_RScoreText_D1[2].text = D1_ScoreSave[4].ToString();
                    t_RScoreText_D1[3].text = D1_ScoreSave[5].ToString();
                    t_RScoreText_D1[4].text = D1_ScoreSave[6].ToString();
                }
                else if (RScore == 7)
                {
                    t_RScoreText_D1[0].text = D1_ScoreSave[3].ToString();
                    t_RScoreText_D1[1].text = D1_ScoreSave[4].ToString();
                    t_RScoreText_D1[2].text = D1_ScoreSave[5].ToString();
                    t_RScoreText_D1[3].text = D1_ScoreSave[6].ToString();
                    t_RScoreText_D1[4].text = D1_ScoreSave[7].ToString();
                }
                else if (RScore == 8)
                {
                    t_RScoreText_D1[0].text = D1_ScoreSave[4].ToString();
                    t_RScoreText_D1[1].text = D1_ScoreSave[5].ToString();
                    t_RScoreText_D1[2].text = D1_ScoreSave[6].ToString();
                    t_RScoreText_D1[3].text = D1_ScoreSave[7].ToString();
                    t_RScoreText_D1[4].text = D1_ScoreSave[8].ToString();
                }
            }
        }
        else if (isDT && !isAT && !isBT && !isCT && Players == 1)
        {
            D2_ScoreSave[RScore] = n;
            if (Round <= RoundStop)
            {
                if (RScore == 0)
                    t_RScoreText_D2[0].text = D2_ScoreSave[0].ToString();
                else if (RScore == 1)
                    t_RScoreText_D2[1].text = D2_ScoreSave[1].ToString();
                else if (RScore == 2)
                    t_RScoreText_D2[2].text = D2_ScoreSave[2].ToString();
                else if (RScore == 3)
                    t_RScoreText_D2[3].text = D2_ScoreSave[3].ToString();
                else if (RScore == 4)
                    t_RScoreText_D2[4].text = D2_ScoreSave[4].ToString();
                else if (RScore == 5)
                {
                    t_RScoreText_D2[0].text = D2_ScoreSave[1].ToString();
                    t_RScoreText_D2[1].text = D2_ScoreSave[2].ToString();
                    t_RScoreText_D2[2].text = D2_ScoreSave[3].ToString();
                    t_RScoreText_D2[3].text = D2_ScoreSave[4].ToString();
                    t_RScoreText_D2[4].text = D2_ScoreSave[5].ToString();
                }
                else if (RScore == 6)
                {
                    t_RScoreText_D2[0].text = D2_ScoreSave[2].ToString();
                    t_RScoreText_D2[1].text = D2_ScoreSave[3].ToString();
                    t_RScoreText_D2[2].text = D2_ScoreSave[4].ToString();
                    t_RScoreText_D2[3].text = D2_ScoreSave[5].ToString();
                    t_RScoreText_D2[4].text = D2_ScoreSave[6].ToString();
                }
                else if (RScore == 7)
                {
                    t_RScoreText_D2[0].text = D2_ScoreSave[3].ToString();
                    t_RScoreText_D2[1].text = D2_ScoreSave[4].ToString();
                    t_RScoreText_D2[2].text = D2_ScoreSave[5].ToString();
                    t_RScoreText_D2[3].text = D2_ScoreSave[6].ToString();
                    t_RScoreText_D2[4].text = D2_ScoreSave[7].ToString();
                }
                else if (RScore == 8)
                {
                    t_RScoreText_D2[0].text = D2_ScoreSave[4].ToString();
                    t_RScoreText_D2[1].text = D2_ScoreSave[5].ToString();
                    t_RScoreText_D2[2].text = D2_ScoreSave[6].ToString();
                    t_RScoreText_D2[3].text = D2_ScoreSave[7].ToString();
                    t_RScoreText_D2[4].text = D2_ScoreSave[8].ToString();
                }
            }
        }
        else if (isDT && !isAT && !isBT && !isCT && Players == 2)
        {
            D3_ScoreSave[RScore] = n;
            if (Round <= RoundStop)
            {
                if (RScore == 0)
                    t_RScoreText_D3[0].text = D3_ScoreSave[0].ToString();
                else if (RScore == 1)
                    t_RScoreText_D3[1].text = D3_ScoreSave[1].ToString();
                else if (RScore == 2)
                    t_RScoreText_D3[2].text = D3_ScoreSave[2].ToString();
                else if (RScore == 3)
                    t_RScoreText_D3[3].text = D3_ScoreSave[3].ToString();
                else if (RScore == 4)
                    t_RScoreText_D3[4].text = D3_ScoreSave[4].ToString();
                else if (RScore == 5)
                {
                    t_RScoreText_D3[0].text = D3_ScoreSave[1].ToString();
                    t_RScoreText_D3[1].text = D3_ScoreSave[2].ToString();
                    t_RScoreText_D3[2].text = D3_ScoreSave[3].ToString();
                    t_RScoreText_D3[3].text = D3_ScoreSave[4].ToString();
                    t_RScoreText_D3[4].text = D3_ScoreSave[5].ToString();
                }
                else if (RScore == 6)
                {
                    t_RScoreText_D3[0].text = D3_ScoreSave[2].ToString();
                    t_RScoreText_D3[1].text = D3_ScoreSave[3].ToString();
                    t_RScoreText_D3[2].text = D3_ScoreSave[4].ToString();
                    t_RScoreText_D3[3].text = D3_ScoreSave[5].ToString();
                    t_RScoreText_D3[4].text = D3_ScoreSave[6].ToString();
                }
                else if (RScore == 7)
                {
                    t_RScoreText_D3[0].text = D3_ScoreSave[3].ToString();
                    t_RScoreText_D3[1].text = D3_ScoreSave[4].ToString();
                    t_RScoreText_D3[2].text = D3_ScoreSave[5].ToString();
                    t_RScoreText_D3[3].text = D3_ScoreSave[6].ToString();
                    t_RScoreText_D3[4].text = D3_ScoreSave[7].ToString();
                }
                else if (RScore == 8)
                {
                    t_RScoreText_D3[0].text = D3_ScoreSave[4].ToString();
                    t_RScoreText_D3[1].text = D3_ScoreSave[5].ToString();
                    t_RScoreText_D3[2].text = D3_ScoreSave[6].ToString();
                    t_RScoreText_D3[3].text = D3_ScoreSave[7].ToString();
                    t_RScoreText_D3[4].text = D3_ScoreSave[8].ToString();
                }
            }
        }
    }
    public void RScoreImageUp()
    {
        ...
        if (isDT && !isAT && !isBT && !isCT && Players == 0)
        {
            if (Round <= RoundStop)
            {
                if (RScore == 5)
                {
                    i_Rscore_D1[0].GetComponent<Image>().sprite = s_RScore[1];
                    i_Rscore_D1[1].GetComponent<Image>().sprite = s_RScore[2];
                    i_Rscore_D1[2].GetComponent<Image>().sprite = s_RScore[3];
                    i_Rscore_D1[3].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_D1[4].GetComponent<Image>().sprite = s_RScore[5];
                }
                if (RScore == 6)
                {
                    i_Rscore_D1[0].GetComponent<Image>().sprite = s_RScore[2];
                    i_Rscore_D1[1].GetComponent<Image>().sprite = s_RScore[3];
                    i_Rscore_D1[2].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_D1[3].GetComponent<Image>().sprite = s_RScore[5];
                    i_Rscore_D1[4].GetComponent<Image>().sprite = s_RScore[6];
                }
                if (RScore == 7)
                {
                    i_Rscore_D1[0].GetComponent<Image>().sprite = s_RScore[3];
                    i_Rscore_D1[1].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_D1[2].GetComponent<Image>().sprite = s_RScore[5];
                    i_Rscore_D1[3].GetComponent<Image>().sprite = s_RScore[6];
                    i_Rscore_D1[4].GetComponent<Image>().sprite = s_RScore[7];
                }
                if (RScore == 8)
                {
                    i_Rscore_D1[0].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_D1[1].GetComponent<Image>().sprite = s_RScore[5];
                    i_Rscore_D1[2].GetComponent<Image>().sprite = s_RScore[6];
                    i_Rscore_D1[3].GetComponent<Image>().sprite = s_RScore[7];
                    i_Rscore_D1[4].GetComponent<Image>().sprite = s_RScore[8];
                }
            }
        }
        if (isDT && !isAT && !isBT && !isCT && Players == 1)
        {
            if (Round <= RoundStop)
            {
                if (RScore == 5)
                {
                    i_Rscore_D2[0].GetComponent<Image>().sprite = s_RScore[1];
                    i_Rscore_D2[1].GetComponent<Image>().sprite = s_RScore[2];
                    i_Rscore_D2[2].GetComponent<Image>().sprite = s_RScore[3];
                    i_Rscore_D2[3].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_D2[4].GetComponent<Image>().sprite = s_RScore[5];
                }
                if (RScore == 6)
                {
                    i_Rscore_D2[0].GetComponent<Image>().sprite = s_RScore[2];
                    i_Rscore_D2[1].GetComponent<Image>().sprite = s_RScore[3];
                    i_Rscore_D2[2].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_D2[3].GetComponent<Image>().sprite = s_RScore[5];
                    i_Rscore_D2[4].GetComponent<Image>().sprite = s_RScore[6];
                }
                if (RScore == 7)
                {
                    i_Rscore_D2[0].GetComponent<Image>().sprite = s_RScore[3];
                    i_Rscore_D2[1].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_D2[2].GetComponent<Image>().sprite = s_RScore[5];
                    i_Rscore_D2[3].GetComponent<Image>().sprite = s_RScore[6];
                    i_Rscore_D2[4].GetComponent<Image>().sprite = s_RScore[7];
                }
                if (RScore == 8)
                {
                    i_Rscore_D2[0].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_D2[1].GetComponent<Image>().sprite = s_RScore[5];
                    i_Rscore_D2[2].GetComponent<Image>().sprite = s_RScore[6];
                    i_Rscore_D2[3].GetComponent<Image>().sprite = s_RScore[7];
                    i_Rscore_D2[4].GetComponent<Image>().sprite = s_RScore[8];
                }
            }
        }
        if (isDT && !isAT && !isBT && !isCT && Players == 2)
        {
            if (Round <= RoundStop)
            {
                if (RScore == 5)
                {
                    i_Rscore_D3[0].GetComponent<Image>().sprite = s_RScore[1];
                    i_Rscore_D3[1].GetComponent<Image>().sprite = s_RScore[2];
                    i_Rscore_D3[2].GetComponent<Image>().sprite = s_RScore[3];
                    i_Rscore_D3[3].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_D3[4].GetComponent<Image>().sprite = s_RScore[5];
                }
                if (RScore == 6)
                {
                    i_Rscore_D3[0].GetComponent<Image>().sprite = s_RScore[2];
                    i_Rscore_D3[1].GetComponent<Image>().sprite = s_RScore[3];
                    i_Rscore_D3[2].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_D3[3].GetComponent<Image>().sprite = s_RScore[5];
                    i_Rscore_D3[4].GetComponent<Image>().sprite = s_RScore[6];
                }
                if (RScore == 7)
                {
                    i_Rscore_D3[0].GetComponent<Image>().sprite = s_RScore[3];
                    i_Rscore_D3[1].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_D3[2].GetComponent<Image>().sprite = s_RScore[5];
                    i_Rscore_D3[3].GetComponent<Image>().sprite = s_RScore[6];
                    i_Rscore_D3[4].GetComponent<Image>().sprite = s_RScore[7];
                }
                if (RScore == 8)
                {
                    i_Rscore_D3[0].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_D3[1].GetComponent<Image>().sprite = s_RScore[5];
                    i_Rscore_D3[2].GetComponent<Image>().sprite = s_RScore[6];
                    i_Rscore_D3[3].GetComponent<Image>().sprite = s_RScore[7];
                    i_Rscore_D3[4].GetComponent<Image>().sprite = s_RScore[8];
                }
            }
        }
    }
    ...
    {
        g_PScore[Players].GetComponent<csNumber>().SetNumber(TeamScore[Players]);
        g_CAni.SetActive(true);
    ...
    void GameEndRead()
    {
        ...
        {
            if (BT_Average < AT_Average && CT_Average < AT_Average && DT_Average < AT_Average)
            {
                isEnd = true;
                isAT = true;
                isBT = false;
            ...
            if (AT_Average < BT_Average && CT_Average < BT_Average && DT_Average < BT_Average)
            {
                isEnd = true;
                isAT = false;
                isBT = true;
            ...
            if (AT_Average < CT_Average && BT_Average < CT_Average && DT_Average < CT_Average)
            {
                isEnd = true;
                isAT = false;
                isBT = false;
            ...
            if (AT_Average < DT_Average && BT_Average < DT_Average && CT_Average < DT_Average)
            {
                isEnd = true;
                isAT = false;
                isBT = false;
            ...
            if (AT_Average == BT_Average && AT_Average == CT_Average && AT_Average == DT_Average)
            {
                isEnd = true;
                isAT = true;
                isBT = false;
            ...
            if (BT_Average == CT_Average && BT_Average == DT_Average &&
                AT_Average != BT_Average && AT_Average != CT_Average &&
                AT_Average != DT_Average)
            {
                isEnd = true;
                isAT = false;
                isBT = true;
            ...
            if (CT_Average == DT_Average
                && BT_Average != CT_Average && BT_Average != DT_Average
                && AT_Average != BT_Average && AT_Average != CT_Average
                && AT_Average != DT_Average)
            {
                isEnd = true;
           ...
           TeamScore[2] != TeamScore[3])
        {
            ...
            if (BT_Average == DT_Average && AT_Average != BT_Average && AT_Average != CT_Average)
            {
                isEnd = true;
                isAT = false;
                isBT = true;
            ...
            if (AT_Average == DT_Average && AT_Average != BT_Average && DT_Average != BT_Average)
            {
                isEnd = true;
                isAT = true;
                isBT = false;
            ...
            if (AT_Average == BT_Average && AT_Average == CT_Average)
            {
                isEnd = true;
                isAT = true;
                isBT = false;
        ...
        {
            if (BT_Average < AT_Average && DT_Average < AT_Average)
            {
                isEnd = false;
                isAT = true;
                isBT = false;
            ...
            if (AT_Average < BT_Average && DT_Average < BT_Average)
            {
                isEnd = false;
                isAT = false;
                isBT = true;
            ...
            if (AT_Average < DT_Average && BT_Average < DT_Average)
            {
                isEnd = true;
                isAT = false;
                isBT = false;
            ...
            if (AT_Average == BT_Average && AT_Average == DT_Average && BT_Average != DT_Average)
            {
                isEnd = true;
                isAT = true;
                isBT = false;
            ...
            if (BT_Average == DT_Average && AT_Average != BT_Average && AT_Average != DT_Average)
            {
                isEnd = true;
                isAT = false;
                isBT = true;
            ...
            if (AT_Average == BT_Average && AT_Average == DT_Average)
            {
                isEnd = true;
                isAT = true;
                isBT = false;
            ...
            TeamScore[1] != TeamScore[2] && TeamScore[3] != TeamScore[2])
        {
            ...
            if (AT_Average < DT_Average && CT_Average < DT_Average)
            {
                isEnd = true;
                isAT = false;
                isBT = false;
            ...
            if (BT_Average == DT_Average && BT_Average != AT_Average && DT_Average != AT_Average)
            {
                isEnd = true;
                isAT = false;
                isBT = true;
            ...
            if (AT_Average == DT_Average && BT_Average != AT_Average && BT_Average != DT_Average)
            {
                isEnd = true;
                isAT = true;
                isBT = false;
        ...
        {
            if (CT_Average < BT_Average && DT_Average < BT_Average)
            {
                isEnd = true;
                isAT = false;
                isBT = true;
            ...
            if (BT_Average < CT_Average && DT_Average < CT_Average)
            {
                isEnd = true;
                isAT = false;
                isBT = false;
            ...
            if (BT_Average < DT_Average && CT_Average < DT_Average)
            {
                isEnd = true;
                isAT = false;
                isBT = false;
            ...
            if (BT_Average == CT_Average && BT_Average == DT_Average && CT_Average != DT_Average)
            {
                isEnd = true;
                isAT = false;
                isBT = true;
            ...
            if (CT_Average == DT_Average && BT_Average != CT_Average && BT_Average != DT_Average)
            {
                isEnd = true;
                isAT = false;
                isBT = false;
            ...
            if (BT_Average == DT_Average && CT_Average != BT_Average && CT_Average != DT_Average)
            {
                isEnd = true;
                isAT = false;
                isBT = true;
    ...
    void PPDScore(int n)
    {
        ...
        {
            D1_DartTotal += n;
            D1_Average = D1_DartTotal / D1_AverageCounting;
            t_PPDText_D1.text = string.Format("{0:N2}", D1_Average);
        }
        else if (Teams == 3 && Players == 1)
        {
            D2_DartTotal += n;
            D2_Average = D2_DartTotal / D2_AverageCounting;
            t_PPDText_D2.text = string.Format("{0:N2}", D2_Average);
        }
        ...
        if (Teams == 0)
            ...
            DT_Average = D1_Average + D2_Average / 2;
    }
    public int GetMovie()
    {
