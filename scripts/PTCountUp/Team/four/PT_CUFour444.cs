...
public class PT_CUFour444 : MonoBehaviour
{
    ...
    public Text[] t_RScoreText_C4 = new Text[5];
    ...
    public Image[] i_Rscore_C4 = new Image[5];
    ...
    void MyTure()
    {
        ...
        else if (isAT && !isBT && !isCT && Players == 3)
        {
            g_AT.transform.position = new Vector3(g_AT.transform.position.x, g_AT.transform.position.y, -10f);
            g_BT.transform.position = new Vector3(g_BT.transform.position.x, g_BT.transform.position.y, 0f);
            g_CT.transform.position = new Vector3(g_CT.transform.position.x, g_CT.transform.position.y, 0f);
            ...
            g_Playerbar[2].GetComponent<Image>().sprite = s_OffPlayer[3];
        ...
        else if (isBT && !isCT && !isAT && Players == 3)
        {
            g_AT.transform.position = new Vector3(g_AT.transform.position.x, g_AT.transform.position.y, 0f);
            g_BT.transform.position = new Vector3(g_BT.transform.position.x, g_BT.transform.position.y, -10f);
            g_CT.transform.position = new Vector3(g_CT.transform.position.x, g_CT.transform.position.y, 0f);
        ...
        else if (isCT && !isAT && !isBT && Players == 3)
        {
            g_AT.transform.position = new Vector3(g_AT.transform.position.x, g_AT.transform.position.y, 0f);
            g_BT.transform.position = new Vector3(g_BT.transform.position.x, g_BT.transform.position.y, 0f);
            g_CT.transform.position = new Vector3(g_CT.transform.position.x, g_CT.transform.position.y, -10f);
            ...
            g_Playerbar[0].GetComponent<Image>().sprite = s_OffPlayer[3];
            g_Playerbar[1].GetComponent<Image>().sprite = s_OffPlayer[3];
            g_Playerbar[2].GetComponent<Image>().sprite = s_OnPlayer[3];
    ...
    public void RoundScore(int n)
    {
        ...
        else if (isCT && !isAT && !isBT && Players == 3)
        {
            ...
            {
                if (RScore == 0)
                    t_RScoreText_C4[0].text = C4_ScoreSave[0].ToString();
                else if (RScore == 1)
                    t_RScoreText_C4[1].text = C4_ScoreSave[1].ToString();
                else if (RScore == 2)
                    t_RScoreText_C4[2].text = C4_ScoreSave[2].ToString();
                else if (RScore == 3)
                    t_RScoreText_C4[3].text = C4_ScoreSave[3].ToString();
                else if (RScore == 4)
                    t_RScoreText_C4[4].text = C4_ScoreSave[4].ToString();
                else if (RScore == 5)
                {
                    t_RScoreText_C4[0].text = C4_ScoreSave[1].ToString();
                    t_RScoreText_C4[1].text = C4_ScoreSave[2].ToString();
                    t_RScoreText_C4[2].text = C4_ScoreSave[3].ToString();
                    t_RScoreText_C4[3].text = C4_ScoreSave[4].ToString();
                    t_RScoreText_C4[4].text = C4_ScoreSave[5].ToString();
                }
                else if (RScore == 6)
                {
                    t_RScoreText_C4[0].text = C4_ScoreSave[2].ToString();
                    t_RScoreText_C4[1].text = C4_ScoreSave[3].ToString();
                    t_RScoreText_C4[2].text = C4_ScoreSave[4].ToString();
                    t_RScoreText_C4[3].text = C4_ScoreSave[5].ToString();
                    t_RScoreText_C4[4].text = C4_ScoreSave[6].ToString();
                }
                else if (RScore == 7)
                {
                    t_RScoreText_C4[0].text = C4_ScoreSave[3].ToString();
                    t_RScoreText_C4[1].text = C4_ScoreSave[4].ToString();
                    t_RScoreText_C4[2].text = C4_ScoreSave[5].ToString();
                    t_RScoreText_C4[3].text = C4_ScoreSave[6].ToString();
                    t_RScoreText_C4[4].text = C4_ScoreSave[7].ToString();
                }
                else if (RScore == 8)
                {
                    t_RScoreText_C4[0].text = C4_ScoreSave[4].ToString();
                    t_RScoreText_C4[1].text = C4_ScoreSave[5].ToString();
                    t_RScoreText_C4[2].text = C4_ScoreSave[6].ToString();
                    t_RScoreText_C4[3].text = C4_ScoreSave[7].ToString();
                    t_RScoreText_C4[4].text = C4_ScoreSave[8].ToString();
                }
            }
        }
    }
    public void RScoreImageUp()
    {
        ...
        if (isCT && !isAT && !isBT && Players == 3)
        {
            if (Round <= RoundStop)
            {
                if (RScore == 5)
                {
                    i_Rscore_C4[0].GetComponent<Image>().sprite = s_RScore[1];
                    i_Rscore_C4[1].GetComponent<Image>().sprite = s_RScore[2];
                    i_Rscore_C4[2].GetComponent<Image>().sprite = s_RScore[3];
                    i_Rscore_C4[3].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_C4[4].GetComponent<Image>().sprite = s_RScore[5];
                }
                if (RScore == 6)
                {
                    i_Rscore_C4[0].GetComponent<Image>().sprite = s_RScore[2];
                    i_Rscore_C4[1].GetComponent<Image>().sprite = s_RScore[3];
                    i_Rscore_C4[2].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_C4[3].GetComponent<Image>().sprite = s_RScore[5];
                    i_Rscore_C4[4].GetComponent<Image>().sprite = s_RScore[6];
                }
                if (RScore == 7)
                {
                    i_Rscore_C4[0].GetComponent<Image>().sprite = s_RScore[3];
                    i_Rscore_C4[1].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_C4[2].GetComponent<Image>().sprite = s_RScore[5];
                    i_Rscore_C4[3].GetComponent<Image>().sprite = s_RScore[6];
                    i_Rscore_C4[4].GetComponent<Image>().sprite = s_RScore[7];
                }
                if (RScore == 8)
                {
                    i_Rscore_C4[0].GetComponent<Image>().sprite = s_RScore[4];
                    i_Rscore_C4[1].GetComponent<Image>().sprite = s_RScore[5];
                    i_Rscore_C4[2].GetComponent<Image>().sprite = s_RScore[6];
                    i_Rscore_C4[3].GetComponent<Image>().sprite = s_RScore[7];
                    i_Rscore_C4[4].GetComponent<Image>().sprite = s_RScore[8];
                }
            }
        }
    }
    ...
    void PPDScore(int n)
    {
        ...
        else if (Teams == 2 && Players == 3)
        {
            ...
            t_PPDText_C4.text = string.Format("{0:N2}", C4_Average);
        }
