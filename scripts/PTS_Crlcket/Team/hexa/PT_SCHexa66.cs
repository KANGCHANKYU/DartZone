...
public class PT_SCHexa66 : MonoBehaviour
{
    ...
    public Sprite[] s_TeamOn = new Sprite[6];
    public Sprite[] s_TeamOff = new Sprite[6];
    ...
    public int[] MarkSaveA5 = new int[45];
    public int[] MarkSaveA6 = new int[45];
    ...
    public int[] MarkSaveB5 = new int[45];
    public int[] MarkSaveB6 = new int[45];
    ...
    public int RoundCountingAT5 = 0;
    public int RoundCountingAT6 = 0;
    public int RoundCountingBT1 = 0;
    public int RoundCountingBT2 = 0;
    public int RoundCountingBT3 = 0;
    public int RoundCountingBT4 = 0;
    public int RoundCountingBT5 = 0;
    public int RoundCountingBT6 = 0;
    ...
    void MyTurn()
    {
        ...
        if (isAT && Players == 4)
        {
            ...
            g_i_Team[0].GetComponent<Image>().sprite = s_TeamOn[4];
            g_i_Team[1].GetComponent<Image>().sprite = s_TeamOff[4];
        ...
        if (isAT && Players == 5)
        {
            ...
            g_i_Team[0].GetComponent<Image>().sprite = s_TeamOn[5];
            g_i_Team[1].GetComponent<Image>().sprite = s_TeamOff[5];
        ...
        if (isBT && Players == 4)
        {
            ...
            g_i_Team[1].GetComponent<Image>().sprite = s_TeamOn[4];
            g_i_Team[0].GetComponent<Image>().sprite = s_TeamOff[4];
        ...
        if (isBT && Players == 5)
        {
            ...
            g_i_Team[1].GetComponent<Image>().sprite = s_TeamOn[5];
            g_i_Team[0].GetComponent<Image>().sprite = s_TeamOff[5];
    ...
    void ImageUp()
    {
        ...
        else if (isAT && !isBT && Players == 4)
        {
            if (RScore == 5)
            {
                ...
                g_AT5RMark1[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[4]];
                g_AT5RMark1[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[5]];
                g_AT5RMark1[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[6]];

                g_AT5RMark2[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[7]];
                g_AT5RMark2[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[8]];
                g_AT5RMark2[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[9]];

                g_AT5RMark3[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[10]];
                g_AT5RMark3[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[11]];
                g_AT5RMark3[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[12]];

                g_AT5RMark4[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[13]];
                g_AT5RMark4[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[14]];
                g_AT5RMark4[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[15]];

                g_AT5RMark5[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[16]];
                g_AT5RMark5[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[17]];
                g_AT5RMark5[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[18]];
            }
            ...
            if (RScore == 6)
            {
                ...
                g_AT5RMark1[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[7]];
                g_AT5RMark1[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[8]];
                g_AT5RMark1[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[9]];

                g_AT5RMark2[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[10]];
                g_AT5RMark2[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[11]];
                g_AT5RMark2[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[12]];

                g_AT5RMark3[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[13]];
                g_AT5RMark3[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[14]];
                g_AT5RMark3[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[15]];

                g_AT5RMark4[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[16]];
                g_AT5RMark4[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[17]];
                g_AT5RMark4[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[18]];

                g_AT5RMark5[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[19]];
                g_AT5RMark5[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[20]];
                g_AT5RMark5[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[21]];
            }
            ...
            if (RScore == 7)
            {
                ...
                g_AT5RMark1[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[10]];
                g_AT5RMark1[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[11]];
                g_AT5RMark1[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[12]];

                g_AT5RMark2[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[13]];
                g_AT5RMark2[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[14]];
                g_AT5RMark2[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[15]];

                g_AT5RMark3[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[16]];
                g_AT5RMark3[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[17]];
                g_AT5RMark3[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[18]];

                g_AT5RMark4[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[19]];
                g_AT5RMark4[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[20]];
                g_AT5RMark4[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[21]];

                g_AT5RMark5[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[22]];
                g_AT5RMark5[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[23]];
                g_AT5RMark5[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[24]];
            }
            ...
            if (RScore == 8)
            {
                ...
                g_AT5RMark1[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[13]];
                g_AT5RMark1[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[14]];
                g_AT5RMark1[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[15]];

                g_AT5RMark2[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[16]];
                g_AT5RMark2[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[17]];
                g_AT5RMark2[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[18]];

                g_AT5RMark3[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[19]];
                g_AT5RMark3[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[20]];
                g_AT5RMark3[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[21]];

                g_AT5RMark4[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[22]];
                g_AT5RMark4[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[23]];
                g_AT5RMark4[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[24]];

                g_AT5RMark5[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[25]];
                g_AT5RMark5[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[26]];
                g_AT5RMark5[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[27]];
            }
            ...
            if (RScore == 9)
            {
                ...
                g_AT5RMark1[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[16]];
                g_AT5RMark1[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[17]];
                g_AT5RMark1[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[18]];

                g_AT5RMark2[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[19]];
                g_AT5RMark2[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[20]];
                g_AT5RMark2[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[21]];

                g_AT5RMark3[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[22]];
                g_AT5RMark3[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[23]];
                g_AT5RMark3[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[24]];

                g_AT5RMark4[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[25]];
                g_AT5RMark4[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[26]];
                g_AT5RMark4[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[27]];

                g_AT5RMark5[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[28]];
                g_AT5RMark5[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[29]];
                g_AT5RMark5[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[30]];
            }
            ...
            if (RScore == 10)
            {
                ...
                g_AT5RMark1[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[19]];
                g_AT5RMark1[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[20]];
                g_AT5RMark1[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[21]];

                g_AT5RMark2[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[22]];
                g_AT5RMark2[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[23]];
                g_AT5RMark2[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[24]];

                g_AT5RMark3[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[25]];
                g_AT5RMark3[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[26]];
                g_AT5RMark3[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[27]];

                g_AT5RMark4[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[28]];
                g_AT5RMark4[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[29]];
                g_AT5RMark4[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[30]];

                g_AT5RMark5[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[31]];
                g_AT5RMark5[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[32]];
                g_AT5RMark5[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[33]];
            }
            ...
            if (RScore == 11)
            {
                ...
                g_AT5RMark1[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[22]];
                g_AT5RMark1[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[23]];
                g_AT5RMark1[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[24]];

                g_AT5RMark2[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[25]];
                g_AT5RMark2[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[26]];
                g_AT5RMark2[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[27]];

                g_AT5RMark3[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[28]];
                g_AT5RMark3[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[29]];
                g_AT5RMark3[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[30]];

                g_AT5RMark4[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[31]];
                g_AT5RMark4[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[32]];
                g_AT5RMark4[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[33]];

                g_AT5RMark5[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[34]];
                g_AT5RMark5[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[35]];
                g_AT5RMark5[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[36]];
            }
            ...
            if (RScore == 12)
            {
                ...
                g_AT5RMark1[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[25]];
                g_AT5RMark1[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[26]];
                g_AT5RMark1[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[27]];

                g_AT5RMark2[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[28]];
                g_AT5RMark2[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[29]];
                g_AT5RMark2[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[30]];

                g_AT5RMark3[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[31]];
                g_AT5RMark3[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[32]];
                g_AT5RMark3[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[33]];

                g_AT5RMark4[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[34]];
                g_AT5RMark4[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[35]];
                g_AT5RMark4[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[36]];

                g_AT5RMark5[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[37]];
                g_AT5RMark5[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[38]];
                g_AT5RMark5[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[39]];
            }
            ...
            if (RScore == 13)
            {
                ...
                g_AT5RMark1[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[28]];
                g_AT5RMark1[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[29]];
                g_AT5RMark1[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[30]];

                g_AT5RMark2[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[31]];
                g_AT5RMark2[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[32]];
                g_AT5RMark2[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[33]];

                g_AT5RMark3[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[34]];
                g_AT5RMark3[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[35]];
                g_AT5RMark3[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[36]];

                g_AT5RMark4[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[37]];
                g_AT5RMark4[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[38]];
                g_AT5RMark4[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[39]];

                g_AT5RMark5[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[40]];
                g_AT5RMark5[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[41]];
                g_AT5RMark5[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[42]];
            }
            ...
            if (RScore == 14)
            {
                ...
                g_AT5RMark1[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[31]];
                g_AT5RMark1[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[32]];
                g_AT5RMark1[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[33]];

                g_AT5RMark2[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[34]];
                g_AT5RMark2[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[35]];
                g_AT5RMark2[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[36]];

                g_AT5RMark3[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[37]];
                g_AT5RMark3[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[38]];
                g_AT5RMark3[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[39]];

                g_AT5RMark4[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[40]];
                g_AT5RMark4[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[41]];
                g_AT5RMark4[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[42]];

                g_AT5RMark5[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[43]];
                g_AT5RMark5[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[44]];
                g_AT5RMark5[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[45]];
            }
        }
        ...
        else if (isAT && !isBT && Players == 5)
        {
            if (RScore == 5)
            {
                ...
                g_AT6RMark1[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[4]];
                g_AT6RMark1[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[5]];
                g_AT6RMark1[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[6]];

                g_AT6RMark2[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[7]];
                g_AT6RMark2[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[8]];
                g_AT6RMark2[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[9]];

                g_AT6RMark3[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[10]];
                g_AT6RMark3[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[11]];
                g_AT6RMark3[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[12]];

                g_AT6RMark4[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[13]];
                g_AT6RMark4[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[14]];
                g_AT6RMark4[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[15]];

                g_AT6RMark5[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[16]];
                g_AT6RMark5[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[17]];
                g_AT6RMark5[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[18]];
            }
            ...
            if (RScore == 6)
            {
                ...
                g_AT6RMark1[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[7]];
                g_AT6RMark1[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[8]];
                g_AT6RMark1[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[9]];

                g_AT6RMark2[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[10]];
                g_AT6RMark2[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[11]];
                g_AT6RMark2[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[12]];

                g_AT6RMark3[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[13]];
                g_AT6RMark3[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[14]];
                g_AT6RMark3[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[15]];

                g_AT6RMark4[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[16]];
                g_AT6RMark4[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[17]];
                g_AT6RMark4[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[18]];

                g_AT6RMark5[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[19]];
                g_AT6RMark5[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[20]];
                g_AT6RMark5[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[21]];
            }
            ...
            if (RScore == 7)
            {
                ...
                g_AT6RMark1[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[10]];
                g_AT6RMark1[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[11]];
                g_AT6RMark1[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[12]];

                g_AT6RMark2[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[13]];
                g_AT6RMark2[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[14]];
                g_AT6RMark2[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[15]];

                g_AT6RMark3[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[16]];
                g_AT6RMark3[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[17]];
                g_AT6RMark3[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[18]];

                g_AT6RMark4[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[19]];
                g_AT6RMark4[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[20]];
                g_AT6RMark4[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[21]];

                g_AT6RMark5[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[22]];
                g_AT6RMark5[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[23]];
                g_AT6RMark5[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[24]];
            }
            ...
            if (RScore == 8)
            {
                ...
                g_AT6RMark1[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[13]];
                g_AT6RMark1[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[14]];
                g_AT6RMark1[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[15]];

                g_AT6RMark2[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[16]];
                g_AT6RMark2[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[17]];
                g_AT6RMark2[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[18]];

                g_AT6RMark3[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[19]];
                g_AT6RMark3[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[20]];
                g_AT6RMark3[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[21]];

                g_AT6RMark4[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[22]];
                g_AT6RMark4[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[23]];
                g_AT6RMark4[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[24]];

                g_AT6RMark5[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[25]];
                g_AT6RMark5[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[26]];
                g_AT6RMark5[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[27]];
            }
            ...
            if (RScore == 9)
            {
                ...
                g_AT6RMark1[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[16]];
                g_AT6RMark1[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[17]];
                g_AT6RMark1[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[18]];

                g_AT6RMark2[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[19]];
                g_AT6RMark2[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[20]];
                g_AT6RMark2[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[21]];

                g_AT6RMark3[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[22]];
                g_AT6RMark3[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[23]];
                g_AT6RMark3[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[24]];

                g_AT6RMark4[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[25]];
                g_AT6RMark4[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[26]];
                g_AT6RMark4[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[27]];

                g_AT6RMark5[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[28]];
                g_AT6RMark5[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[29]];
                g_AT6RMark5[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[30]];
            }
            ...
            if (RScore == 10)
            {
                ...
                g_AT6RMark1[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[19]];
                g_AT6RMark1[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[20]];
                g_AT6RMark1[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[21]];

                g_AT6RMark2[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[22]];
                g_AT6RMark2[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[23]];
                g_AT6RMark2[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[24]];

                g_AT6RMark3[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[25]];
                g_AT6RMark3[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[26]];
                g_AT6RMark3[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[27]];

                g_AT6RMark4[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[28]];
                g_AT6RMark4[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[29]];
                g_AT6RMark4[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[30]];

                g_AT6RMark5[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[31]];
                g_AT6RMark5[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[32]];
                g_AT6RMark5[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[33]];
            }
            ...
            if (RScore == 11)
            {
                ...
                g_AT6RMark1[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[22]];
                g_AT6RMark1[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[23]];
                g_AT6RMark1[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[24]];

                g_AT6RMark2[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[25]];
                g_AT6RMark2[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[26]];
                g_AT6RMark2[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[27]];

                g_AT6RMark3[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[28]];
                g_AT6RMark3[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[29]];
                g_AT6RMark3[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[30]];

                g_AT6RMark4[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[31]];
                g_AT6RMark4[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[32]];
                g_AT6RMark4[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[33]];

                g_AT6RMark5[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[34]];
                g_AT6RMark5[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[35]];
                g_AT6RMark5[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[36]];
            }
            ...
            if (RScore == 12)
            {
                ...
                g_AT6RMark1[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[25]];
                g_AT6RMark1[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[26]];
                g_AT6RMark1[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[27]];

                g_AT6RMark2[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[28]];
                g_AT6RMark2[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[29]];
                g_AT6RMark2[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[30]];

                g_AT6RMark3[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[31]];
                g_AT6RMark3[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[32]];
                g_AT6RMark3[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[33]];

                g_AT6RMark4[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[34]];
                g_AT6RMark4[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[35]];
                g_AT6RMark4[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[36]];

                g_AT6RMark5[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[37]];
                g_AT6RMark5[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[38]];
                g_AT6RMark5[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[39]];
            }
            ...
            if (RScore == 13)
            {
                ...
                g_AT6RMark1[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[28]];
                g_AT6RMark1[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[29]];
                g_AT6RMark1[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[30]];

                g_AT6RMark2[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[31]];
                g_AT6RMark2[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[32]];
                g_AT6RMark2[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[33]];

                g_AT6RMark3[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[34]];
                g_AT6RMark3[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[35]];
                g_AT6RMark3[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[36]];

                g_AT6RMark4[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[37]];
                g_AT6RMark4[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[38]];
                g_AT6RMark4[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[39]];

                g_AT6RMark5[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[40]];
                g_AT6RMark5[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[41]];
                g_AT6RMark5[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[42]];
            }
            ...
            if (RScore == 14)
            {
                ...
                g_AT6RMark1[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[31]];
                g_AT6RMark1[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[32]];
                g_AT6RMark1[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[33]];

                g_AT6RMark2[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[34]];
                g_AT6RMark2[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[35]];
                g_AT6RMark2[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[36]];

                g_AT6RMark3[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[37]];
                g_AT6RMark3[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[38]];
                g_AT6RMark3[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[39]];

                g_AT6RMark4[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[40]];
                g_AT6RMark4[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[41]];
                g_AT6RMark4[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[42]];

                g_AT6RMark5[0].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[43]];
                g_AT6RMark5[1].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[44]];
                g_AT6RMark5[2].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[45]];
            }
        }
        ...
        else if (isBT && !isAT && Players == 4)
        {
            if (RScore == 5)
            {
                ...
                g_BT5RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[4]];
                g_BT5RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[5]];
                g_BT5RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[6]];

                g_BT5RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[7]];
                g_BT5RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[8]];
                g_BT5RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[9]];

                g_BT5RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[10]];
                g_BT5RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[11]];
                g_BT5RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[12]];

                g_BT5RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[13]];
                g_BT5RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[14]];
                g_BT5RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[15]];

                g_BT5RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[16]];
                g_BT5RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[17]];
                g_BT5RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[18]];
            }
            ...
            if (RScore == 6)
            {
                ...
                g_BT5RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[7]];
                g_BT5RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[8]];
                g_BT5RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[9]];

                g_BT5RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[10]];
                g_BT5RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[11]];
                g_BT5RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[12]];

                g_BT5RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[13]];
                g_BT5RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[14]];
                g_BT5RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[15]];

                g_BT5RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[16]];
                g_BT5RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[17]];
                g_BT5RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[18]];

                g_BT5RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[19]];
                g_BT5RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[20]];
                g_BT5RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[21]];
            }
            ...
            if (RScore == 7)
            {
                ...
                g_BT5RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[10]];
                g_BT5RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[11]];
                g_BT5RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[12]];

                g_BT5RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[13]];
                g_BT5RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[14]];
                g_BT5RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[15]];

                g_BT5RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[16]];
                g_BT5RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[17]];
                g_BT5RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[18]];

                g_BT5RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[19]];
                g_BT5RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[20]];
                g_BT5RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[21]];

                g_BT5RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[22]];
                g_BT5RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[23]];
                g_BT5RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[24]];
            }
            ...
            if (RScore == 8)
            {
                ...
                g_BT5RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[13]];
                g_BT5RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[14]];
                g_BT5RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[15]];

                g_BT5RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[16]];
                g_BT5RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[17]];
                g_BT5RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[18]];

                g_BT5RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[19]];
                g_BT5RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[20]];
                g_BT5RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[21]];

                g_BT5RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[22]];
                g_BT5RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[23]];
                g_BT5RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[24]];

                g_BT5RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[25]];
                g_BT5RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[26]];
                g_BT5RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[27]];
            }
            ...
            if (RScore == 9)
            {
                ...
                g_BT5RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[16]];
                g_BT5RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[17]];
                g_BT5RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[18]];

                g_BT5RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[19]];
                g_BT5RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[20]];
                g_BT5RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[21]];

                g_BT5RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[22]];
                g_BT5RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[23]];
                g_BT5RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[24]];

                g_BT5RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[25]];
                g_BT5RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[26]];
                g_BT5RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[27]];

                g_BT5RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[28]];
                g_BT5RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[29]];
                g_BT5RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[30]];
            }
            ...
            if (RScore == 10)
            {
                ...
                g_BT5RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[19]];
                g_BT5RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[20]];
                g_BT5RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[21]];

                g_BT5RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[22]];
                g_BT5RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[23]];
                g_BT5RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[24]];

                g_BT5RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[25]];
                g_BT5RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[26]];
                g_BT5RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[27]];

                g_BT5RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[28]];
                g_BT5RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[29]];
                g_BT5RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[30]];

                g_BT5RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[31]];
                g_BT5RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[32]];
                g_BT5RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[33]];
            }
            ...
            if (RScore == 11)
            {
                ...
                g_BT5RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[22]];
                g_BT5RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[23]];
                g_BT5RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[24]];

                g_BT5RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[25]];
                g_BT5RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[26]];
                g_BT5RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[27]];

                g_BT5RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[28]];
                g_BT5RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[29]];
                g_BT5RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[30]];

                g_BT5RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[31]];
                g_BT5RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[32]];
                g_BT5RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[33]];

                g_BT5RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[34]];
                g_BT5RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[35]];
                g_BT5RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[36]];
            }
            ...
            if (RScore == 12)
            {
                ...
                g_BT5RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[25]];
                g_BT5RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[26]];
                g_BT5RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[27]];

                g_BT5RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[28]];
                g_BT5RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[29]];
                g_BT5RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[30]];

                g_BT5RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[31]];
                g_BT5RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[32]];
                g_BT5RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[33]];

                g_BT5RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[34]];
                g_BT5RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[35]];
                g_BT5RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[36]];

                g_BT5RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[37]];
                g_BT5RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[38]];
                g_BT5RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[39]];
            }
            ...
            if (RScore == 13)
            {
                ...
                g_BT5RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[28]];
                g_BT5RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[29]];
                g_BT5RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[30]];

                g_BT5RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[31]];
                g_BT5RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[32]];
                g_BT5RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[33]];

                g_BT5RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[34]];
                g_BT5RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[35]];
                g_BT5RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[36]];

                g_BT5RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[37]];
                g_BT5RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[38]];
                g_BT5RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[39]];

                g_BT5RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[40]];
                g_BT5RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[41]];
                g_BT5RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[42]];
            }
            ...
            if (RScore == 14)
            {
                ...
                g_BT5RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[31]];
                g_BT5RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[32]];
                g_BT5RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[33]];

                g_BT5RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[34]];
                g_BT5RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[35]];
                g_BT5RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[36]];

                g_BT5RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[37]];
                g_BT5RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[38]];
                g_BT5RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[39]];

                g_BT5RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[40]];
                g_BT5RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[41]];
                g_BT5RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[42]];

                g_BT5RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[43]];
                g_BT5RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[44]];
                g_BT5RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[45]];
            }
        }
        ...
        else if (isBT && !isAT && Players == 5)
        {
            if (RScore == 5)
            {
                ...
                g_BT6RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[4]];
                g_BT6RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[5]];
                g_BT6RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[6]];

                g_BT6RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[7]];
                g_BT6RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[8]];
                g_BT6RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[9]];

                g_BT6RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[10]];
                g_BT6RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[11]];
                g_BT6RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[12]];

                g_BT6RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[13]];
                g_BT6RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[14]];
                g_BT6RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[15]];

                g_BT6RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[16]];
                g_BT6RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[17]];
                g_BT6RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[18]];
            }
            ...
            if (RScore == 6)
            {
                ...
                g_BT6RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[7]];
                g_BT6RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[8]];
                g_BT6RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[9]];

                g_BT6RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[10]];
                g_BT6RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[11]];
                g_BT6RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[12]];

                g_BT6RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[13]];
                g_BT6RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[14]];
                g_BT6RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[15]];

                g_BT6RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[16]];
                g_BT6RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[17]];
                g_BT6RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[18]];

                g_BT6RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[19]];
                g_BT6RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[20]];
                g_BT6RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[21]];
            }
            ...
            if (RScore == 7)
            {
                ...
                g_BT6RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[10]];
                g_BT6RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[11]];
                g_BT6RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[12]];

                g_BT6RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[13]];
                g_BT6RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[14]];
                g_BT6RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[15]];

                g_BT6RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[16]];
                g_BT6RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[17]];
                g_BT6RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[18]];

                g_BT6RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[19]];
                g_BT6RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[20]];
                g_BT6RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[21]];

                g_BT6RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[22]];
                g_BT6RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[23]];
                g_BT6RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[24]];
            }
            ...
            if (RScore == 8)
            {
                ...
                g_BT6RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[13]];
                g_BT6RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[14]];
                g_BT6RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[15]];

                g_BT6RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[16]];
                g_BT6RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[17]];
                g_BT6RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[18]];

                g_BT6RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[19]];
                g_BT6RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[20]];
                g_BT6RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[21]];

                g_BT6RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[22]];
                g_BT6RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[23]];
                g_BT6RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[24]];

                g_BT6RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[25]];
                g_BT6RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[26]];
                g_BT6RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[27]];
            }
            ...
            if (RScore == 9)
            {
                ...
                g_BT6RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[16]];
                g_BT6RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[17]];
                g_BT6RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[18]];

                g_BT6RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[19]];
                g_BT6RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[20]];
                g_BT6RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[21]];

                g_BT6RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[22]];
                g_BT6RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[23]];
                g_BT6RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[24]];

                g_BT6RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[25]];
                g_BT6RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[26]];
                g_BT6RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[27]];

                g_BT6RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[28]];
                g_BT6RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[29]];
                g_BT6RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[30]];
            }
            ...
            if (RScore == 10)
            {
                ...
                g_BT6RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[19]];
                g_BT6RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[20]];
                g_BT6RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[21]];

                g_BT6RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[22]];
                g_BT6RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[23]];
                g_BT6RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[24]];

                g_BT6RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[25]];
                g_BT6RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[26]];
                g_BT6RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[27]];

                g_BT6RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[28]];
                g_BT6RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[29]];
                g_BT6RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[30]];

                g_BT6RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[31]];
                g_BT6RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[32]];
                g_BT6RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[33]];
            }
            ...
            if (RScore == 11)
            {
                ...
                g_BT6RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[22]];
                g_BT6RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[23]];
                g_BT6RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[24]];

                g_BT6RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[25]];
                g_BT6RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[26]];
                g_BT6RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[27]];

                g_BT6RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[28]];
                g_BT6RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[29]];
                g_BT6RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[30]];

                g_BT6RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[31]];
                g_BT6RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[32]];
                g_BT6RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[33]];

                g_BT6RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[34]];
                g_BT6RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[35]];
                g_BT6RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[36]];
            }
            ...
            if (RScore == 12)
            {
                ...
                g_BT6RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[25]];
                g_BT6RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[26]];
                g_BT6RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[27]];

                g_BT6RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[28]];
                g_BT6RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[29]];
                g_BT6RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[30]];

                g_BT6RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[31]];
                g_BT6RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[32]];
                g_BT6RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[33]];

                g_BT6RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[34]];
                g_BT6RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[35]];
                g_BT6RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[36]];

                g_BT6RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[37]];
                g_BT6RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[38]];
                g_BT6RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[39]];
            }
            ...
            if (RScore == 13)
            {
                ...
                g_BT6RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[28]];
                g_BT6RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[29]];
                g_BT6RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[30]];

                g_BT6RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[31]];
                g_BT6RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[32]];
                g_BT6RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[33]];

                g_BT6RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[34]];
                g_BT6RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[35]];
                g_BT6RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[36]];

                g_BT6RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[37]];
                g_BT6RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[38]];
                g_BT6RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[39]];

                g_BT6RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[40]];
                g_BT6RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[41]];
                g_BT6RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[42]];
            }
            ...
            if (RScore == 14)
            {
                ...
                g_BT6RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[31]];
                g_BT6RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[32]];
                g_BT6RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[33]];

                g_BT6RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[34]];
                g_BT6RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[35]];
                g_BT6RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[36]];

                g_BT6RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[37]];
                g_BT6RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[38]];
                g_BT6RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[39]];

                g_BT6RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[40]];
                g_BT6RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[41]];
                g_BT6RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[42]];

                g_BT6RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[43]];
                g_BT6RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[44]];
                g_BT6RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[45]];
            }
        }
    }
    void RoundScore(int MarkScore)
    {
        ...
        {
            MarkSaveA5[AT5MarkCounting] = MarkScore;  //0이면 1마크 1이면 2마크 2이면 3마크
            if (Round <= RoundStop)
            {
                if (RScore == 0)
                    g_AT5RMark1[Counting].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[AT5MarkCounting]];

                if (RScore == 1)
                    g_AT5RMark2[Counting].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[AT5MarkCounting]];

                if (RScore == 2)
                    g_AT5RMark3[Counting].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[AT5MarkCounting]];

                if (RScore == 3)
                    g_AT5RMark4[Counting].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[AT5MarkCounting]];

                if (RScore == 4)
                    g_AT5RMark5[Counting].GetComponent<Image>().sprite = s_ATMark[MarkSaveA5[AT5MarkCounting]];
        ...
        {
            MarkSaveA6[AT6MarkCounting] = MarkScore;  //0이면 1마크 1이면 2마크 2이면 3마크
            if (Round <= RoundStop)
            {
                if (RScore == 0)
                    g_AT6RMark1[Counting].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[AT6MarkCounting]];

                if (RScore == 1)
                    g_AT6RMark2[Counting].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[AT6MarkCounting]];

                if (RScore == 2)
                    g_AT6RMark3[Counting].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[AT6MarkCounting]];

                if (RScore == 3)
                    g_AT6RMark4[Counting].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[AT6MarkCounting]];

                if (RScore == 4)
                    g_AT6RMark5[Counting].GetComponent<Image>().sprite = s_ATMark[MarkSaveA6[AT6MarkCounting]];
        ...
        else if (isBT && !isAT && Players == 3)
        {
            ...
            if (Round <= RoundStop)
            {
                ...
                if (RScore == 14)
                {
                    ...
                    g_BT4RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveB4[43]];
                    g_BT4RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveB4[44]];
                    g_BT4RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveB3[45]];
                }
            }
        }
        ...
        {
            MarkSaveB5[BT5MarkCounting] = MarkScore;  //0이면 1마크 1이면 2마크 2이면 3마크
            if (Round <= RoundStop)
            {
                if (RScore == 0)
                    g_BT5RMark1[Counting].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[BT5MarkCounting]];

                if (RScore == 1)
                    g_BT5RMark2[Counting].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[BT5MarkCounting]];

                if (RScore == 2)
                    g_BT5RMark3[Counting].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[BT5MarkCounting]];

                if (RScore == 3)
                    g_BT5RMark4[Counting].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[BT5MarkCounting]];

                if (RScore == 4)
                    g_BT5RMark5[Counting].GetComponent<Image>().sprite = s_BTMark[MarkSaveB5[BT5MarkCounting]];
        ...
        {
            MarkSaveB6[BT6MarkCounting] = MarkScore;  //0이면 1마크 1이면 2마크 2이면 3마크
            if (Round <= RoundStop)
            {
                if (RScore == 0)
                    g_BT6RMark1[Counting].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[BT6MarkCounting]];

                if (RScore == 1)
                    g_BT6RMark2[Counting].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[BT6MarkCounting]];

                if (RScore == 2)
                    g_BT6RMark3[Counting].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[BT6MarkCounting]];

                if (RScore == 3)
                    g_BT6RMark4[Counting].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[BT6MarkCounting]];

                if (RScore == 4)
                    g_BT6RMark5[Counting].GetComponent<Image>().sprite = s_BTMark[MarkSaveB6[BT6MarkCounting]];
    ...
    void MPRScore(int Dart)
    {
        ...
        {
            TotalA5 += Dart;
            AverageA5 = TotalA5 / RoundCountingAT5;
            t_MPRText5.text = string.Format("{0:N2}", AverageA5);
        }
        if (Teams == 0 && Players == 5)
        {
            TotalA6 += Dart;
            AverageA6 = TotalA6 / RoundCountingAT6;
        ...
        {
            TotalB5 += Dart;
            AverageB5 = TotalB5 / RoundCountingBT5;
            t_MPRText11.text = string.Format("{0:N2}", AverageB5);
        }
        if (Teams == 1 && Players == 5)
        {
            TotalB6 += Dart;
            AverageB6 = TotalB6 / RoundCountingBT6;
