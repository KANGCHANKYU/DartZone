...
public class PT_SCFive55 : MonoBehaviour
{
    ...
    public GameObject[] g_RoundScore = new GameObject[10];
    public GameObject[] g_MRPScore = new GameObject[10];
    ...
    public Sprite[] s_TeamOn = new Sprite[5];
    public Sprite[] s_TeamOff = new Sprite[5];
    ...
    void MPRScore(int Dart)
    {
        ...
        if (Teams == 1 && Players == 0)
        {
            ...
            t_MPRText6.text = string.Format("{0:N2}", AverageB1);
        }
        if (Teams == 1 && Players == 1)
        {
            TotalB2 += Dart;
            AverageB2 = TotalB2 / RoundCountingBT2;
            t_MPRText7.text = string.Format("{0:N2}", AverageB2);
        }
        if (Teams == 1 && Players == 2)
        {
            TotalB3 += Dart;
            AverageB3 = TotalB3 / RoundCountingBT3;
            t_MPRText8.text = string.Format("{0:N2}", AverageB3);
        }
        if (Teams == 1 && Players == 3)
        {
            TotalB4 += Dart;
            AverageB4 = TotalB4 / RoundCountingBT4;
            t_MPRText9.text = string.Format("{0:N2}", AverageB4);
        }
        if (Teams == 1 && Players == 4)
        {
            TotalB5 += Dart;
            AverageB5 = TotalB5 / RoundCountingBT5;
            t_MPRText10.text = string.Format("{0:N2}", AverageB5);
        }
        if (Teams == 0)
            AverageATotla = AverageA1 + AverageA2 + AverageA3 + AverageA4 + AverageA5 / 5;
        if (Teams == 1)
            AverageBTotla = AverageB1 + AverageB2 + AverageB3 + AverageB4 + AverageB5 / 5;
    }
