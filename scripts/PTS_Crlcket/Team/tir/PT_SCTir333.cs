...
public class PT_SCTir333 : MonoBehaviour
{
    ...
    public GameObject[] g_RoundScore = new GameObject[9];
    public GameObject[] g_MRPScore = new GameObject[9];
    ...
    public Sprite[] s_TeamOn = new Sprite[3];
    public Sprite[] s_TeamOff = new Sprite[3];
