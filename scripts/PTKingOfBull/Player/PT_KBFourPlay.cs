...
public class PT_KBFourPlay : MonoBehaviour
{
                ...
                if (Round < RoundStop)
                {
                    ...
                    else if (Players == 3 && !isRead && !isSpace && !isEnd)
                    {
                        if (Counting == 0 && !isRead && !isSpace)
                        {
                            ...
                            RoundScore(DartScore[0]);
                            gmg.DartScoreActor(csSingleton.getInstance.g_nTargetLine, DartBasicScore[0], Counting);
                            g_MScore[2].GetComponent<csNumber>().SetNumber(PlayerScore[3]);
                            g_PScore[2].GetComponent<csNumber>().SetNumber(PlayerScore[3]);
                            Counting = 1;
                        }
                        else if (Counting == 1 && !isRead && !isSpace)
                        {
                    ...
                    if (Players == 3 && Counting == 3 && Round == RoundStop)
                    {
                        GameEndRead();
                    }
    ...
    public void RoundScore(int n)
    {
        ...
        else if (Players == 3)
        {
            ...
            {
                if (RScore == 0)
                    t_RScoreP4[0].text = P4_ScoreSave[0].ToString();
                else if (RScore == 1)
                    t_RScoreP4[1].text = P4_ScoreSave[1].ToString();
                else if (RScore == 2)
                    t_RScoreP4[2].text = P4_ScoreSave[2].ToString();
                else if (RScore == 3)
                    t_RScoreP4[3].text = P4_ScoreSave[3].ToString();
                else if (RScore == 4)
                    t_RScoreP4[4].text = P4_ScoreSave[4].ToString();
                else if (RScore == 5)
                {
                    t_RScoreP4[0].text = P4_ScoreSave[1].ToString();
                    t_RScoreP4[1].text = P4_ScoreSave[2].ToString();
                    t_RScoreP4[2].text = P4_ScoreSave[3].ToString();
                    t_RScoreP4[3].text = P4_ScoreSave[4].ToString();
                    t_RScoreP4[4].text = P4_ScoreSave[5].ToString();
                }
                else if (RScore == 6)
                {
                    t_RScoreP4[0].text = P4_ScoreSave[2].ToString();
                    t_RScoreP4[1].text = P4_ScoreSave[3].ToString();
                    t_RScoreP4[2].text = P4_ScoreSave[4].ToString();
                    t_RScoreP4[3].text = P4_ScoreSave[5].ToString();
                    t_RScoreP4[4].text = P4_ScoreSave[6].ToString();
                }
                else if (RScore == 7)
                {
                    t_RScoreP4[0].text = P4_ScoreSave[3].ToString();
                    t_RScoreP4[1].text = P4_ScoreSave[4].ToString();
                    t_RScoreP4[2].text = P4_ScoreSave[5].ToString();
                    t_RScoreP4[3].text = P4_ScoreSave[6].ToString();
                    t_RScoreP4[4].text = P4_ScoreSave[7].ToString();
                }
                else if (RScore == 8)
                {
                    t_RScoreP4[0].text = P4_ScoreSave[4].ToString();
                    t_RScoreP4[1].text = P4_ScoreSave[5].ToString();
                    t_RScoreP4[2].text = P4_ScoreSave[6].ToString();
                    t_RScoreP4[3].text = P4_ScoreSave[7].ToString();
                    t_RScoreP4[4].text = P4_ScoreSave[8].ToString();
                }
            }
        }
    ...
    public void RScoreImageUp()
    {
        ...
        else if (Players == 3)
        {
            if (RScore == 5)
            {
                i_RScoreP4[0].GetComponent<Image>().sprite = s_RScore[1];
                i_RScoreP4[1].GetComponent<Image>().sprite = s_RScore[2];
                i_RScoreP4[2].GetComponent<Image>().sprite = s_RScore[3];
                i_RScoreP4[3].GetComponent<Image>().sprite = s_RScore[4];
                i_RScoreP4[4].GetComponent<Image>().sprite = s_RScore[5];
            }
            if (RScore == 6)
            {
                i_RScoreP4[0].GetComponent<Image>().sprite = s_RScore[2];
                i_RScoreP4[1].GetComponent<Image>().sprite = s_RScore[3];
                i_RScoreP4[2].GetComponent<Image>().sprite = s_RScore[4];
                i_RScoreP4[3].GetComponent<Image>().sprite = s_RScore[5];
                i_RScoreP4[4].GetComponent<Image>().sprite = s_RScore[6];
            }
            if (RScore == 7)
            {
                i_RScoreP4[0].GetComponent<Image>().sprite = s_RScore[3];
                i_RScoreP4[1].GetComponent<Image>().sprite = s_RScore[4];
                i_RScoreP4[2].GetComponent<Image>().sprite = s_RScore[5];
                i_RScoreP4[3].GetComponent<Image>().sprite = s_RScore[6];
                i_RScoreP4[4].GetComponent<Image>().sprite = s_RScore[7];
            }
            if (RScore == 8)
            {
                i_RScoreP4[0].GetComponent<Image>().sprite = s_RScore[4];
                i_RScoreP4[1].GetComponent<Image>().sprite = s_RScore[5];
                i_RScoreP4[2].GetComponent<Image>().sprite = s_RScore[6];
                i_RScoreP4[3].GetComponent<Image>().sprite = s_RScore[7];
                i_RScoreP4[4].GetComponent<Image>().sprite = s_RScore[8];
            }
        }
    }
    ...
    void MyTure()
    {
        if (Players == 0)
        {
            ...
            g_P4.GetComponent<Transform>().position = new Vector3(g_P4.transform.position.x, g_P4.transform.position.y, 0f);
        ...
        else if (Players == 3)
        {
            ...
            g_P2.GetComponent<Transform>().position = new Vector3(g_P2.transform.position.x, g_P2.transform.position.y, 0f);
            g_P3.GetComponent<Transform>().position = new Vector3(g_P3.transform.position.x, g_P3.transform.position.y, 0f);
            g_P4.GetComponent<Transform>().position = new Vector3(g_P4.transform.position.x, g_P4.transform.position.y, -10f);
    ...
    void PPDScore(int n)
    {
        ...
        else if (Players == 3)
        {
            ...
            t_PPDScoreP4.text = string.Format("{0:N2}", P4_Average);
        }
    }
