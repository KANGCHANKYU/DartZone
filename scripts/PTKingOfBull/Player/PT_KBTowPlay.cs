...
public class PT_KBTowPlay : MonoBehaviour
{
    public Text t_Round;
                ...
                if (Round < RoundStop)
                {
                    ...
                    else if (Players == 1 && !isRead && !isSpace && !isEnd)
                    {
                        if (Counting == 0 && !isRead && !isSpace)
                        {
                            ...
                            RoundScore(DartScore[0]);
                            gmg.DartScoreActor(csSingleton.getInstance.g_nTargetLine, DartBasicScore[0], Counting);
                            g_MScore[0].GetComponent<csNumber>().SetNumber(PlayerScore[1]);
                            g_PScore[0].GetComponent<csNumber>().SetNumber(PlayerScore[1]);
                            Counting = 1;
                        }
                        else if (Counting == 1 && !isRead && !isSpace)
                        {
                    ...
                    if (Players == 1 && Counting == 3 && Round == RoundStop)
                    {
                        GameEndRead();
                    }
