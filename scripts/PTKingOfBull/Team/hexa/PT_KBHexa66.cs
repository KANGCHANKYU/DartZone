...
public class PT_KBHexa66 : MonoBehaviour
{
    public Text t_Round;
    ...
    public Text[] t_RScoreA6 = new Text[5];
    ...
    public Text[] t_RScoreB6 = new Text[5];
    ...
    public void RoundScore(int n)
    {
        ...
        else if (Teams == 0 && Players == 5)
        {
            ...
            {
                if (RScore == 0)
                    t_RScoreA6[0].text = A6_ScoreSave[0].ToString();
                else if (RScore == 1)
                    t_RScoreA6[1].text = A6_ScoreSave[1].ToString();
                else if (RScore == 2)
                    t_RScoreA6[2].text = A6_ScoreSave[2].ToString();
                else if (RScore == 3)
                    t_RScoreA6[3].text = A6_ScoreSave[3].ToString();
                else if (RScore == 4)
                    t_RScoreA6[4].text = A6_ScoreSave[4].ToString();
                else if (RScore == 5)
                {
                    t_RScoreA6[0].text = A6_ScoreSave[1].ToString();
                    t_RScoreA6[1].text = A6_ScoreSave[2].ToString();
                    t_RScoreA6[2].text = A6_ScoreSave[3].ToString();
                    t_RScoreA6[3].text = A6_ScoreSave[4].ToString();
                    t_RScoreA6[4].text = A6_ScoreSave[5].ToString();
                }
                else if (RScore == 6)
                {
                    t_RScoreA6[0].text = A6_ScoreSave[2].ToString();
                    t_RScoreA6[1].text = A6_ScoreSave[3].ToString();
                    t_RScoreA6[2].text = A6_ScoreSave[4].ToString();
                    t_RScoreA6[3].text = A6_ScoreSave[5].ToString();
                    t_RScoreA6[4].text = A6_ScoreSave[6].ToString();
                }
                else if (RScore == 7)
                {
                    t_RScoreA6[0].text = A6_ScoreSave[3].ToString();
                    t_RScoreA6[1].text = A6_ScoreSave[4].ToString();
                    t_RScoreA6[2].text = A6_ScoreSave[5].ToString();
                    t_RScoreA6[3].text = A6_ScoreSave[6].ToString();
                    t_RScoreA6[4].text = A6_ScoreSave[7].ToString();
                }
                else if (RScore == 8)
                {
                    t_RScoreA6[0].text = A6_ScoreSave[4].ToString();
                    t_RScoreA6[1].text = A6_ScoreSave[5].ToString();
                    t_RScoreA6[2].text = A6_ScoreSave[6].ToString();
                    t_RScoreA6[3].text = A6_ScoreSave[7].ToString();
                    t_RScoreA6[4].text = A6_ScoreSave[8].ToString();
                }
            }
        }
        else if (Teams == 1 && Players == 0)
        ...
        else if (Teams == 1 && Players == 5)
        {
            ...
            {
                if (RScore == 0)
                    t_RScoreB6[0].text = B6_ScoreSave[0].ToString();
                else if (RScore == 1)
                    t_RScoreB6[1].text = B6_ScoreSave[1].ToString();
                else if (RScore == 2)
                    t_RScoreB6[2].text = B6_ScoreSave[2].ToString();
                else if (RScore == 3)
                    t_RScoreB6[3].text = B6_ScoreSave[3].ToString();
                else if (RScore == 4)
                    t_RScoreB6[4].text = B6_ScoreSave[4].ToString();
                else if (RScore == 5)
                {
                    t_RScoreB6[0].text = B6_ScoreSave[1].ToString();
                    t_RScoreB6[1].text = B6_ScoreSave[2].ToString();
                    t_RScoreB6[2].text = B6_ScoreSave[3].ToString();
                    t_RScoreB6[3].text = B6_ScoreSave[4].ToString();
                    t_RScoreB6[4].text = B6_ScoreSave[5].ToString();
                }
                else if (RScore == 6)
                {
                    t_RScoreB6[0].text = B6_ScoreSave[2].ToString();
                    t_RScoreB6[1].text = B6_ScoreSave[3].ToString();
                    t_RScoreB6[2].text = B6_ScoreSave[4].ToString();
                    t_RScoreB6[3].text = B6_ScoreSave[5].ToString();
                    t_RScoreB6[4].text = B6_ScoreSave[6].ToString();
                }
                else if (RScore == 7)
                {
                    t_RScoreB6[0].text = B6_ScoreSave[3].ToString();
                    t_RScoreB6[1].text = B6_ScoreSave[4].ToString();
                    t_RScoreB6[2].text = B6_ScoreSave[5].ToString();
                    t_RScoreB6[3].text = B6_ScoreSave[6].ToString();
                    t_RScoreB6[4].text = B6_ScoreSave[7].ToString();
                }
                else if (RScore == 8)
                {
                    t_RScoreB6[0].text = B6_ScoreSave[4].ToString();
                    t_RScoreB6[1].text = B6_ScoreSave[5].ToString();
                    t_RScoreB6[2].text = B6_ScoreSave[6].ToString();
                    t_RScoreB6[3].text = B6_ScoreSave[7].ToString();
                    t_RScoreB6[4].text = B6_ScoreSave[8].ToString();
                }
            }
        }
    ...
    void MyTure()
    {
        ...
        else if (Teams == 0 && Players == 5)
        {
            ...
            i_TeamName[0].GetComponent<Image>().sprite = s_OnPlayer[5];
            i_TeamName[1].GetComponent<Image>().sprite = s_OffPlayer[5];
        ...
        else if (Teams == 1 && Players == 5)
        {
            ...
            i_TeamName[0].GetComponent<Image>().sprite = s_OffPlayer[5];
            i_TeamName[1].GetComponent<Image>().sprite = s_OnPlayer[5];
    ...
    void PPDScore(int n)
    {
        ...
        else if (Teams == 0 && Players == 5)
        {
            ...
            t_PPDScoreA6.text = string.Format("{0:N2}", A6_Average);
        }
        ...
        else if (Teams == 1 && Players == 5)
        {
            ...
            t_PPDScoreB6.text = string.Format("{0:N2}", B6_Average);
        }
