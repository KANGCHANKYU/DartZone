...
public class PT_KBFour444 : MonoBehaviour
{
    public Text t_Round;
    ...
    public Text[] t_RScoreC4 = new Text[5];
    ...
    public Sprite[] s_OnPlayer = new Sprite[4];
    public Sprite[] s_OffPlayer = new Sprite[4];
    ...
    public int C4_AverageCounting = 0;
    ...
    public int[] C4_ScoreSave = new int[8];
    ...
    void Update()
    {
        ...
        if (csSingleton.getInstance.g_bTarget)
        {
            ...
            if (csSingleton.getInstance.g_nTargetBasicScore == 25 || csSingleton.getInstance.g_nTargetBasicScore == 50)
            {
                if (Round <= RoundStop && !isEnd)
                {
                    ...
                    else if (Teams == 2 && Players == 3 && !isRead && !isSpace && !isEnd)
                    {
                        if (Counting == 0 && !isRead && !isSpace)
                        {
                            C4_AverageCounting++;
                    ...
                    if (Teams == 2 && Counting == 3 && Round == RoundStop)
                    {
                        GameEndRead();
                    }
                }
        ...
        if (Input.GetKeyDown(KeyCode.Space) && gmg.isAni == false && isSpace && Counting == 4)
        {
            ...
            else if (Teams == 2 && Players == 3 && !isRead && !isEnd)
            {
                a_source.PlayOneShot(ac_shoot2, 1.0f);
                for (int i = 0; i < g_Dart.Length; i++)
                    g_Dart[i].GetComponent<Image>().sprite = s_OffDart;
    ...
    public void RoundScore(int n)
    {
        ...
        {
            C4_ScoreSave[RScore] += n;
            if (Round <= RoundStop)
            {
                if (RScore == 0)
                    t_RScoreC4[0].text = C4_ScoreSave[0].ToString();
                else if (RScore == 1)
                    t_RScoreC4[1].text = C4_ScoreSave[1].ToString();
                else if (RScore == 2)
                    t_RScoreC4[2].text = C4_ScoreSave[2].ToString();
                else if (RScore == 3)
                    t_RScoreC4[3].text = C4_ScoreSave[3].ToString();
                else if (RScore == 4)
                    t_RScoreC4[4].text = C4_ScoreSave[4].ToString();
                else if (RScore == 5)
                {
                    t_RScoreC4[0].text = C4_ScoreSave[1].ToString();
                    t_RScoreC4[1].text = C4_ScoreSave[2].ToString();
                    t_RScoreC4[2].text = C4_ScoreSave[3].ToString();
                    t_RScoreC4[3].text = C4_ScoreSave[4].ToString();
                    t_RScoreC4[4].text = C4_ScoreSave[5].ToString();
                }
                else if (RScore == 6)
                {
                    t_RScoreC4[0].text = C4_ScoreSave[2].ToString();
                    t_RScoreC4[1].text = C4_ScoreSave[3].ToString();
                    t_RScoreC4[2].text = C4_ScoreSave[4].ToString();
                    t_RScoreC4[3].text = C4_ScoreSave[5].ToString();
                    t_RScoreC4[4].text = C4_ScoreSave[6].ToString();
                }
                else if (RScore == 7)
                {
                    t_RScoreC4[0].text = C4_ScoreSave[3].ToString();
                    t_RScoreC4[1].text = C4_ScoreSave[4].ToString();
                    t_RScoreC4[2].text = C4_ScoreSave[5].ToString();
                    t_RScoreC4[3].text = C4_ScoreSave[6].ToString();
                    t_RScoreC4[4].text = C4_ScoreSave[7].ToString();
                }
                else if (RScore == 8)
                {
                    t_RScoreC4[0].text = C4_ScoreSave[4].ToString();
                    t_RScoreC4[1].text = C4_ScoreSave[5].ToString();
                    t_RScoreC4[2].text = C4_ScoreSave[6].ToString();
                    t_RScoreC4[3].text = C4_ScoreSave[7].ToString();
                    t_RScoreC4[4].text = C4_ScoreSave[8].ToString();
                }
            }
        }
    ...
    void MyTure()
    {
        ...
        else if (Teams == 0 && Players == 3)
        {
            ...
            i_TeamName[2].GetComponent<Image>().sprite = s_OffPlayer[3];
        ...
        else if (Teams == 2 && Players == 2)
        {
            ...
            i_TeamName[0].GetComponent<Image>().sprite = s_OffPlayer[2];
            i_TeamName[1].GetComponent<Image>().sprite = s_OffPlayer[2];
            i_TeamName[2].GetComponent<Image>().sprite = s_OnPlayer[2];
        ...
        else if (Teams == 2 && Players == 3)
        {
            ...
            i_TeamName[0].GetComponent<Image>().sprite = s_OffPlayer[3];
            i_TeamName[1].GetComponent<Image>().sprite = s_OffPlayer[3];
            i_TeamName[2].GetComponent<Image>().sprite = s_OnPlayer[3];
    ...
    void PPDScore(int n)
    {
        ...
        {
            C4_DartTotal += n;
            C4_Average = C4_DartTotal / C4_AverageCounting;
            t_PPDScoreC4.text = string.Format("{0:N2}", C4_Average);
        }

        if (Teams == 0)
            AT_Average = A1_Average + A2_Average + A3_Average + A4_Average / 4;
        else if (Teams == 1)
            BT_Average = B1_Average + B2_Average + B3_Average + B4_Average / 4;
        else if (Teams == 2)
            CT_Average = C1_Average + C2_Average + C3_Average + C4_Average / 4;
    }
