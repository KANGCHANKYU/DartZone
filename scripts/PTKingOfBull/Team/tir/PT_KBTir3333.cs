...
public class PT_KBTir3333 : MonoBehaviour
{
    public Text t_Round;
    ...
    public Text t_PPDScoreC3;
    public Text t_PPDScoreD1;
    public Text t_PPDScoreD2;
    public Text t_PPDScoreD3;
    ...
    public Text[] t_RScoreC3 = new Text[5];
    public Text[] t_RScoreD1 = new Text[5];
    public Text[] t_RScoreD2 = new Text[5];
    public Text[] t_RScoreD3 = new Text[5];
    ...
    public Image[] i_TeamName = new Image[4];
    public Image[] i_Teambar = new Image[4];
    ...
    public GameObject[] g_TScore = new GameObject[4];
    ...
    public string[] player = new string[12];
                ...
                if (Round <= RoundStop && !isEnd)
                {
                    ...
                    else if (Teams == 3 && Players == 0 && !isRead && !isSpace && !isEnd)
                    {
                        if (Counting == 0 && !isRead && !isSpace)
                        {
                            ...
                            g_TScore[3].GetComponent<csNumber>().SetNumber(TeamScore[3]);
                            Counting = 1;
                        }
                        else if (Counting == 1 && !isRead && !isSpace)
                        {
                    ...
                    if (Teams == 3 && Counting == 3 && Round == RoundStop)
                    {
                        isEnd = true;
                        GameEndRead();
                    }
    ...
    public void RoundScore(int n)
    {
        ...
        else if (Teams == 2 && Players == 2)
        {
            ...
            {
                if (RScore == 0)
                    t_RScoreC3[0].text = C3_ScoreSave[0].ToString();
                else if (RScore == 1)
                    t_RScoreC3[1].text = C3_ScoreSave[1].ToString();
                else if (RScore == 2)
                    t_RScoreC3[2].text = C3_ScoreSave[2].ToString();
                else if (RScore == 3)
                    t_RScoreC3[3].text = C3_ScoreSave[3].ToString();
                else if (RScore == 4)
                    t_RScoreC3[4].text = C3_ScoreSave[4].ToString();
                else if (RScore == 5)
                {
                    t_RScoreC3[0].text = C3_ScoreSave[1].ToString();
                    t_RScoreC3[1].text = C3_ScoreSave[2].ToString();
                    t_RScoreC3[2].text = C3_ScoreSave[3].ToString();
                    t_RScoreC3[3].text = C3_ScoreSave[4].ToString();
                    t_RScoreC3[4].text = C3_ScoreSave[5].ToString();
                }
                else if (RScore == 6)
                {
                    t_RScoreC3[0].text = C3_ScoreSave[2].ToString();
                    t_RScoreC3[1].text = C3_ScoreSave[3].ToString();
                    t_RScoreC3[2].text = C3_ScoreSave[4].ToString();
                    t_RScoreC3[3].text = C3_ScoreSave[5].ToString();
                    t_RScoreC3[4].text = C3_ScoreSave[6].ToString();
                }
                else if (RScore == 7)
                {
                    t_RScoreC3[0].text = C3_ScoreSave[3].ToString();
                    t_RScoreC3[1].text = C3_ScoreSave[4].ToString();
                    t_RScoreC3[2].text = C3_ScoreSave[5].ToString();
                    t_RScoreC3[3].text = C3_ScoreSave[6].ToString();
                    t_RScoreC3[4].text = C3_ScoreSave[7].ToString();
                }
                else if (RScore == 8)
                {
                    t_RScoreC3[0].text = C3_ScoreSave[4].ToString();
                    t_RScoreC3[1].text = C3_ScoreSave[5].ToString();
                    t_RScoreC3[2].text = C3_ScoreSave[6].ToString();
                    t_RScoreC3[3].text = C3_ScoreSave[7].ToString();
                    t_RScoreC3[4].text = C3_ScoreSave[8].ToString();
                }
            }
        }
        else if (Teams == 3 && Players == 0)
        {
            ...
            {
                if (RScore == 0)
                    t_RScoreD1[0].text = D1_ScoreSave[0].ToString();
                else if (RScore == 1)
                    t_RScoreD1[1].text = D1_ScoreSave[1].ToString();
                else if (RScore == 2)
                    t_RScoreD1[2].text = D1_ScoreSave[2].ToString();
                else if (RScore == 3)
                    t_RScoreD1[3].text = D1_ScoreSave[3].ToString();
                else if (RScore == 4)
                    t_RScoreD1[4].text = D1_ScoreSave[4].ToString();
                else if (RScore == 5)
                {
                    t_RScoreD1[0].text = D1_ScoreSave[1].ToString();
                    t_RScoreD1[1].text = D1_ScoreSave[2].ToString();
                    t_RScoreD1[2].text = D1_ScoreSave[3].ToString();
                    t_RScoreD1[3].text = D1_ScoreSave[4].ToString();
                    t_RScoreD1[4].text = D1_ScoreSave[5].ToString();
                }
                else if (RScore == 6)
                {
                    t_RScoreD1[0].text = D1_ScoreSave[2].ToString();
                    t_RScoreD1[1].text = D1_ScoreSave[3].ToString();
                    t_RScoreD1[2].text = D1_ScoreSave[4].ToString();
                    t_RScoreD1[3].text = D1_ScoreSave[5].ToString();
                    t_RScoreD1[4].text = D1_ScoreSave[6].ToString();
                }
                else if (RScore == 7)
                {
                    t_RScoreD1[0].text = D1_ScoreSave[3].ToString();
                    t_RScoreD1[1].text = D1_ScoreSave[4].ToString();
                    t_RScoreD1[2].text = D1_ScoreSave[5].ToString();
                    t_RScoreD1[3].text = D1_ScoreSave[6].ToString();
                    t_RScoreD1[4].text = D1_ScoreSave[7].ToString();
                }
                else if (RScore == 8)
                {
                    t_RScoreD1[0].text = D1_ScoreSave[4].ToString();
                    t_RScoreD1[1].text = D1_ScoreSave[5].ToString();
                    t_RScoreD1[2].text = D1_ScoreSave[6].ToString();
                    t_RScoreD1[3].text = D1_ScoreSave[7].ToString();
                    t_RScoreD1[4].text = D1_ScoreSave[8].ToString();
                }
            }
        }
        else if (Teams == 3 && Players == 1)
        {
            ...
            {
                if (RScore == 0)
                    t_RScoreD2[0].text = D2_ScoreSave[0].ToString();
                else if (RScore == 1)
                    t_RScoreD2[1].text = D2_ScoreSave[1].ToString();
                else if (RScore == 2)
                    t_RScoreD2[2].text = D2_ScoreSave[2].ToString();
                else if (RScore == 3)
                    t_RScoreD2[3].text = D2_ScoreSave[3].ToString();
                else if (RScore == 4)
                    t_RScoreD2[4].text = D2_ScoreSave[4].ToString();
                else if (RScore == 5)
                {
                    t_RScoreD2[0].text = D2_ScoreSave[1].ToString();
                    t_RScoreD2[1].text = D2_ScoreSave[2].ToString();
                    t_RScoreD2[2].text = D2_ScoreSave[3].ToString();
                    t_RScoreD2[3].text = D2_ScoreSave[4].ToString();
                    t_RScoreD2[4].text = D2_ScoreSave[5].ToString();
                }
                else if (RScore == 6)
                {
                    t_RScoreD2[0].text = D2_ScoreSave[2].ToString();
                    t_RScoreD2[1].text = D2_ScoreSave[3].ToString();
                    t_RScoreD2[2].text = D2_ScoreSave[4].ToString();
                    t_RScoreD2[3].text = D2_ScoreSave[5].ToString();
                    t_RScoreD2[4].text = D2_ScoreSave[6].ToString();
                }
                else if (RScore == 7)
                {
                    t_RScoreD2[0].text = D2_ScoreSave[3].ToString();
                    t_RScoreD2[1].text = D2_ScoreSave[4].ToString();
                    t_RScoreD2[2].text = D2_ScoreSave[5].ToString();
                    t_RScoreD2[3].text = D2_ScoreSave[6].ToString();
                    t_RScoreD2[4].text = D2_ScoreSave[7].ToString();
                }
                else if (RScore == 8)
                {
                    t_RScoreD2[0].text = D2_ScoreSave[4].ToString();
                    t_RScoreD2[1].text = D2_ScoreSave[5].ToString();
                    t_RScoreD2[2].text = D2_ScoreSave[6].ToString();
                    t_RScoreD2[3].text = D2_ScoreSave[7].ToString();
                    t_RScoreD2[4].text = D2_ScoreSave[8].ToString();
                }
            }
        }
        else if (Teams == 3 && Players == 2)
        {
            ...
            {
                if (RScore == 0)
                    t_RScoreD3[0].text = D3_ScoreSave[0].ToString();
                else if (RScore == 1)
                    t_RScoreD3[1].text = D3_ScoreSave[1].ToString();
                else if (RScore == 2)
                    t_RScoreD3[2].text = D3_ScoreSave[2].ToString();
                else if (RScore == 3)
                    t_RScoreD3[3].text = D3_ScoreSave[3].ToString();
                else if (RScore == 4)
                    t_RScoreD3[4].text = D3_ScoreSave[4].ToString();
                else if (RScore == 5)
                {
                    t_RScoreD3[0].text = D3_ScoreSave[1].ToString();
                    t_RScoreD3[1].text = D3_ScoreSave[2].ToString();
                    t_RScoreD3[2].text = D3_ScoreSave[3].ToString();
                    t_RScoreD3[3].text = D3_ScoreSave[4].ToString();
                    t_RScoreD3[4].text = D3_ScoreSave[5].ToString();
                }
                else if (RScore == 6)
                {
                    t_RScoreD3[0].text = D3_ScoreSave[2].ToString();
                    t_RScoreD3[1].text = D3_ScoreSave[3].ToString();
                    t_RScoreD3[2].text = D3_ScoreSave[4].ToString();
                    t_RScoreD3[3].text = D3_ScoreSave[5].ToString();
                    t_RScoreD3[4].text = D3_ScoreSave[6].ToString();
                }
                else if (RScore == 7)
                {
                    t_RScoreD3[0].text = D3_ScoreSave[3].ToString();
                    t_RScoreD3[1].text = D3_ScoreSave[4].ToString();
                    t_RScoreD3[2].text = D3_ScoreSave[5].ToString();
                    t_RScoreD3[3].text = D3_ScoreSave[6].ToString();
                    t_RScoreD3[4].text = D3_ScoreSave[7].ToString();
                }
                else if (RScore == 8)
                {
                    t_RScoreD3[0].text = D3_ScoreSave[4].ToString();
                    t_RScoreD3[1].text = D3_ScoreSave[5].ToString();
                    t_RScoreD3[2].text = D3_ScoreSave[6].ToString();
                    t_RScoreD3[3].text = D3_ScoreSave[7].ToString();
                    t_RScoreD3[4].text = D3_ScoreSave[8].ToString();
                }
            }
        }
    }
    ...
    void MyTure()
    {
        if (Teams == 0 && Players == 0)
        {
            ...
            g_DT.GetComponent<Transform>().position = new Vector3(g_DT.transform.position.x, g_DT.transform.position.y, 0f);
            ...
            i_TeamName[3].GetComponent<Image>().sprite = s_OffPlayer[0];
            ...
            i_Teambar[3].GetComponent<Image>().sprite = s_OffTeambar[3];
            ...
            t_PPDScoreC3.enabled = false;
            t_PPDScoreD1.enabled = false;
            t_PPDScoreD2.enabled = false;
            t_PPDScoreD3.enabled = false;
        ...
        else if (Teams == 0 && Players == 1)
        {
            ...
            i_TeamName[3].GetComponent<Image>().sprite = s_OffPlayer[1];
        ...
        else if (Teams == 0 && Players == 2)
        {
            ...
            i_TeamName[2].GetComponent<Image>().sprite = s_OffPlayer[2];
            i_TeamName[3].GetComponent<Image>().sprite = s_OffPlayer[2];
        ...
        else if (Teams == 3 && Players == 0)
        {
            ...
            g_BT.GetComponent<Transform>().position = new Vector3(g_BT.transform.position.x, g_BT.transform.position.y, 0f);
            g_CT.GetComponent<Transform>().position = new Vector3(g_CT.transform.position.x, g_CT.transform.position.y, 0f);
            g_DT.GetComponent<Transform>().position = new Vector3(g_DT.transform.position.x, g_DT.transform.position.y, -10f);
            ...
            i_TeamName[1].GetComponent<Image>().sprite = s_OffPlayer[0];
            i_TeamName[2].GetComponent<Image>().sprite = s_OffPlayer[0];
            i_TeamName[3].GetComponent<Image>().sprite = s_OnPlayer[0];

            i_Teambar[0].GetComponent<Image>().sprite = s_OffTeambar[0];
            i_Teambar[1].GetComponent<Image>().sprite = s_OffTeambar[1];
            i_Teambar[2].GetComponent<Image>().sprite = s_OffTeambar[2];
            i_Teambar[3].GetComponent<Image>().sprite = s_OnTeambar[3];
        ...
        else if (Teams == 3 && Players == 1)
        {
            ...
            i_TeamName[1].GetComponent<Image>().sprite = s_OffPlayer[1];
            i_TeamName[2].GetComponent<Image>().sprite = s_OffPlayer[1];
            i_TeamName[3].GetComponent<Image>().sprite = s_OnPlayer[1];
        ...
        else if (Teams == 3 && Players == 2)
        {
            ...
            i_TeamName[1].GetComponent<Image>().sprite = s_OffPlayer[2];
            i_TeamName[2].GetComponent<Image>().sprite = s_OffPlayer[2];
            i_TeamName[3].GetComponent<Image>().sprite = s_OnPlayer[2];
    ...
    void PPDScore(int n)
    {
        ...
        else if (Teams == 2 && Players == 2)
        {
            ...
            t_PPDScoreC3.text = string.Format("{0:N2}", C3_Average);
        }
        ...
        else if (Teams == 3 && Players == 0)
        {
            ...
            t_PPDScoreD1.text = string.Format("{0:N2}", D1_Average);
        }
        else if (Teams == 3 && Players == 1)
        {
            D2_DartTotal += n;
            D2_Average = D2_DartTotal / D2_AverageCounting;
            t_PPDScoreD2.text = string.Format("{0:N2}", D2_Average);
        }
        else if (Teams == 3 && Players == 2)
        {
            D3_DartTotal += n;
            D3_Average = D3_DartTotal / D3_AverageCounting;
            t_PPDScoreD3.text = string.Format("{0:N2}", D3_Average);
        }
        ...
        if (Teams == 0)
            ...
            DT_Average = D1_Average + D2_Average + D3_Average / 3;
    }
