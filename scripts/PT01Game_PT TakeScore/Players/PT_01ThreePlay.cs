...
public class PT_01ThreePlay : MonoBehaviour
{
    ...
    public GameObject[] g_i_Player = new GameObject[3];   //플레이어 숫자이미지
    ...
    public GameObject[] g_PPDScore = new GameObject[3];
    public GameObject[] g_RoundNum = new GameObject[21];
    public GameObject[] g_M_Score = new GameObject[3];
    ...
    void Update()
    {
        ...
        if (csSingleton.getInstance.g_bTarget && !isRead && !isSpace && !isWin && !isBust)
        {
            ...
            if (Round <= RoundStop && !isRead && !isBust)
            {
                ...
                {
                    if (Counting == 0 && isP3 && !isBust && !isRead)
                    {
                        DartCount3++;
                        a_source.PlayOneShot(ac_shoot1, 1.0f);
                        g_Dart[1].GetComponent<Image>().sprite = s_OnDart;
                    ...
                    else if (Counting == 1 && isP3 && !isBust && !isRead)
                    {
                        DartCount3++;
                        a_source.PlayOneShot(ac_shoot1, 1.0f);
                        g_Dart[2].GetComponent<Image>().sprite = s_OnDart;
                    ...
                    else if (Counting == 2 && isP3 && !isBust && !isRead)
                    {
                        DartCount3++;
                        a_source.PlayOneShot(ac_shoot1, 1.0f);
                        DartScore[2] = csSingleton.getInstance.g_nTargetScore;
        ...
        if (Input.GetKeyDown(KeyCode.Space) && isBust || (csSingleton.getInstance.g_bSwitch && csSingleton.getInstance.g_nSwitch == 1005) && isBust)
        {
            if (Players == 0 && isP1)
            {
                ...
                for (int i = 0; i < g_Dart.Length; i++)
                    g_Dart[i].GetComponent<Image>().sprite = s_OffDart;
                g_Dart[0].GetComponent<Image>().sprite = s_OffDart;
                csgmg.DartScoreReSet();
                g_C_Ani.SetActive(true);
                g_P_Ani.SetActive(false);
                for (int i = 0; i < DartScore.Length; i++)
        ...
        if (Round == RoundStop && Counting == 3 && isP3)
            GameEndRead();
    }
    ...
    void BustAndRoundRead()
    {
        ...
        else if (PlayerScore[Players] >= PlayerBasicScore && !isRead && !isBust)
            NextShotRead();

        else if (PlayerScore[Players] == 0 && !isBust && !isRead)
        {
            g_P_Score[Players].GetComponent<csNumber>().SetNumber(PlayerScore[Players]);
            WinRead();
        }
        else if (Round == RoundStop && Counting == 4 && isP3)
        {
            g_C_Ani.SetActive(false);
            isP1 = false;
            isP2 = false;
    ...
    void NextShotRead()
    {
        ...
        if (Counting == 4 && isP3 && !isBust && !isRead)
            RoundRead();
    }
    ...
    void WinRead() // 이기면 바로 여기로
    {
        ...
        if (PlayerScore[1] < PlayerScore[0] && PlayerScore[1] < PlayerScore[2])
        {
            win = 1;
            isWin = true;
            isP1 = false;
        ...
        if (PlayerScore[2] < PlayerScore[0] && PlayerScore[2] < PlayerScore[1])
        {
            win = 2;
            isWin = true;
            isP1 = true;
    ...
    {
        if (PlayerScore[0] < PlayerScore[1] && PlayerScore[0] < PlayerScore[2] && !isP1 && !isP2)
        {
            win = 0;
            isWin = true;
            isP1 = true;
        ...
        if (PlayerScore[1] < PlayerScore[0] && PlayerScore[1] < PlayerScore[2] && !isP1 && !isP2 && !isP3)
        {
            win = 1;
            isWin = true;
            isP1 = false;
        ...
        if (PlayerScore[2] < PlayerScore[0] && PlayerScore[2] < PlayerScore[1] && !isP1 && !isP2 && !isP3)
        {
            win = 2;
            isWin = true;
            isP1 = false;
        ...
        if (PlayerScore[1] == PlayerScore[2] && !isP1 && !isP2 && !isP3)
        {
            win = 1;
            isWin = true;
            isP1 = false;
    ...
    void ImageUp()
    {
        ...
        if (isP3 && !isP2 && !isP1)
        {
            if (RScore == 5)
            {
                i_RScore3[0].GetComponent<Image>().sprite = s_RScore[1];
                i_RScore3[1].GetComponent<Image>().sprite = s_RScore[2];
                i_RScore3[2].GetComponent<Image>().sprite = s_RScore[3];
                i_RScore3[3].GetComponent<Image>().sprite = s_RScore[4];
                i_RScore3[4].GetComponent<Image>().sprite = s_RScore[5];

                t_P3RScoreText[0].text = ScoreSave3[1].ToString();
                t_P3RScoreText[1].text = ScoreSave3[2].ToString();
                t_P3RScoreText[2].text = ScoreSave3[3].ToString();
                t_P3RScoreText[3].text = ScoreSave3[4].ToString();
                t_P3RScoreText[4].text = ScoreSave3[5].ToString();
            }
            ...
            if (RScore == 6)
            {
                ...
                t_P3RScoreText[0].text = ScoreSave3[2].ToString();
                t_P3RScoreText[1].text = ScoreSave3[3].ToString();
                t_P3RScoreText[2].text = ScoreSave3[4].ToString();
                t_P3RScoreText[3].text = ScoreSave3[5].ToString();
                t_P3RScoreText[4].text = ScoreSave3[6].ToString();
            }
            ...
            if (RScore == 7)
            {
                ...
                t_P3RScoreText[0].text = ScoreSave3[3].ToString();
                t_P3RScoreText[1].text = ScoreSave3[4].ToString();
                t_P3RScoreText[2].text = ScoreSave3[5].ToString();
                t_P3RScoreText[3].text = ScoreSave3[6].ToString();
                t_P3RScoreText[4].text = ScoreSave3[7].ToString();
            }
            ...
            if (RScore == 8)
            {
                ...
                t_P3RScoreText[0].text = ScoreSave3[4].ToString();
                t_P3RScoreText[1].text = ScoreSave3[5].ToString();
                t_P3RScoreText[2].text = ScoreSave3[6].ToString();
                t_P3RScoreText[3].text = ScoreSave3[7].ToString();
                t_P3RScoreText[4].text = ScoreSave3[8].ToString();
            }
            ...
            if (RScore == 9)
            {
                ...
                t_P3RScoreText[0].text = ScoreSave3[5].ToString();
                t_P3RScoreText[1].text = ScoreSave3[6].ToString();
                t_P3RScoreText[2].text = ScoreSave3[7].ToString();
                t_P3RScoreText[3].text = ScoreSave3[8].ToString();
                t_P3RScoreText[4].text = ScoreSave3[9].ToString();
            }
            ...
            if (RScore == 10)
            {
                ...
                t_P3RScoreText[0].text = ScoreSave3[6].ToString();
                t_P3RScoreText[1].text = ScoreSave3[7].ToString();
                t_P3RScoreText[2].text = ScoreSave3[8].ToString();
                t_P3RScoreText[3].text = ScoreSave3[9].ToString();
                t_P3RScoreText[4].text = ScoreSave3[10].ToString();
            }
            ...
            if (RScore == 11)
            {
                ...
                t_P3RScoreText[0].text = ScoreSave3[7].ToString();
                t_P3RScoreText[1].text = ScoreSave3[8].ToString();
                t_P3RScoreText[2].text = ScoreSave3[9].ToString();
                t_P3RScoreText[3].text = ScoreSave3[10].ToString();
                t_P3RScoreText[4].text = ScoreSave3[11].ToString();
            }
            ...
            if (RScore == 12)
            {
                ...
                t_P3RScoreText[0].text = ScoreSave3[8].ToString();
                t_P3RScoreText[1].text = ScoreSave3[9].ToString();
                t_P3RScoreText[2].text = ScoreSave3[10].ToString();
                t_P3RScoreText[3].text = ScoreSave3[11].ToString();
                t_P3RScoreText[4].text = ScoreSave3[12].ToString();
            }
            ...
            if (RScore == 13)
            {
                ...
                t_P3RScoreText[0].text = ScoreSave3[9].ToString();
                t_P3RScoreText[1].text = ScoreSave3[10].ToString();
                t_P3RScoreText[2].text = ScoreSave3[11].ToString();
                t_P3RScoreText[3].text = ScoreSave3[12].ToString();
                t_P3RScoreText[4].text = ScoreSave3[13].ToString();
            }
            ...
            if (RScore == 14)
            {
                ...
                t_P3RScoreText[0].text = ScoreSave3[10].ToString();
                t_P3RScoreText[1].text = ScoreSave3[11].ToString();
                t_P3RScoreText[2].text = ScoreSave3[12].ToString();
                t_P3RScoreText[3].text = ScoreSave3[13].ToString();
                t_P3RScoreText[4].text = ScoreSave3[14].ToString();
            }
            ...
            if (RScore == 15)
            {
                ...
                t_P3RScoreText[0].text = ScoreSave3[11].ToString();
                t_P3RScoreText[1].text = ScoreSave3[12].ToString();
                t_P3RScoreText[2].text = ScoreSave3[13].ToString();
                t_P3RScoreText[3].text = ScoreSave3[14].ToString();
                t_P3RScoreText[4].text = ScoreSave3[15].ToString();
            }
            ...
            if (RScore == 16)
            {
                ...
                t_P3RScoreText[0].text = ScoreSave3[12].ToString();
                t_P3RScoreText[1].text = ScoreSave3[13].ToString();
                t_P3RScoreText[2].text = ScoreSave3[14].ToString();
                t_P3RScoreText[3].text = ScoreSave3[15].ToString();
                t_P3RScoreText[4].text = ScoreSave3[16].ToString();
            }
            ...
            if (RScore == 17)
            {
                ...
                t_P3RScoreText[0].text = ScoreSave3[13].ToString();
                t_P3RScoreText[1].text = ScoreSave3[14].ToString();
                t_P3RScoreText[2].text = ScoreSave3[15].ToString();
                t_P3RScoreText[3].text = ScoreSave3[16].ToString();
                t_P3RScoreText[4].text = ScoreSave3[17].ToString();
            }
            ...
            if (RScore == 18)
            {
                ...
                t_P3RScoreText[0].text = ScoreSave3[14].ToString();
                t_P3RScoreText[1].text = ScoreSave3[15].ToString();
                t_P3RScoreText[2].text = ScoreSave3[16].ToString();
                t_P3RScoreText[3].text = ScoreSave3[17].ToString();
                t_P3RScoreText[4].text = ScoreSave3[18].ToString();
            }
            ...
            if (RScore == 19)
            {
                ...
                t_P3RScoreText[0].text = ScoreSave3[15].ToString();
                t_P3RScoreText[1].text = ScoreSave3[16].ToString();
                t_P3RScoreText[2].text = ScoreSave3[17].ToString();
                t_P3RScoreText[3].text = ScoreSave3[18].ToString();
                t_P3RScoreText[4].text = ScoreSave3[19].ToString();
            }
            ...
            if (RScore == 20)
            {
                ...
                t_P3RScoreText[0].text = ScoreSave3[16].ToString();
                t_P3RScoreText[1].text = ScoreSave3[17].ToString();
                t_P3RScoreText[2].text = ScoreSave3[18].ToString();
                t_P3RScoreText[3].text = ScoreSave3[19].ToString();
                t_P3RScoreText[4].text = ScoreSave3[20].ToString();
            }
    ...
    void RoundScore(int DartScore)
    {
        ...
        if (isP3 && !isP1 && !isP2)
        {
            ScoreSave3[RScore] += DartScore;
            if (Round <= RoundStop)
            {
                if (RScore == 0)
                    t_P3RScoreText[0].text = ScoreSave3[0].ToString();

                if (RScore == 1)
                    t_P3RScoreText[1].text = ScoreSave3[1].ToString();

                if (RScore == 2)
                    t_P3RScoreText[2].text = ScoreSave3[2].ToString();

                if (RScore == 3)
                    t_P3RScoreText[3].text = ScoreSave3[3].ToString();

                if (RScore == 4)
                    t_P3RScoreText[4].text = ScoreSave3[4].ToString();
    ...
    void PPDScore(int Dart)
    {
        ...
        {
            Total2 += Dart;
            Average2 = Total2 / DartCount2;
            t_PPDText2.text = string.Format("{0:N2}", Average2);
        }
        if (Players == 2)
        {
            Total3 += Dart;
            Average3 = Total3 / DartCount3;
            t_PPDText3.text = string.Format("{0:N2}", Average3);
        }
    }
