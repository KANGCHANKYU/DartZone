...
public class PT_01hexa66 : MonoBehaviour
{
    ...
    public Text[] t_TA5RScoreText = new Text[5]; //A팀의 5플레이어의 라운드 스코어
    public Text[] t_TA6RScoreText = new Text[5]; //A팀의 6플레이어의 라운드 스코어
    ...
    public Text[] t_TB5RScoreText = new Text[5]; //B팀의 5플레이어의 라운드 스코어
    public Text[] t_TB6RScoreText = new Text[5]; //B팀의 6플레이어의 라운드 스코어

    public Sprite s_OnDart; //다트 On이미지
    public Sprite s_OffDart; //다트 Off 이미지
    public Sprite[] s_RScore = new Sprite[20]; //라운드 스코어의 이미지 1~20
    public Sprite[] s_TeamOn = new Sprite[6]; //자기팀의 자기차레의일떄 차레 숫자on
    public Sprite[] s_TeamOff = new Sprite[6]; //자기팀의 차레가아닐떄 off 할 숫자 이미지
    ...
    public Image[] i_RScoreA5 = new Image[5]; //A팀의 5플레이어의 라운드 스코어의 이미지
    public Image[] i_RScoreA6 = new Image[5]; //A팀의 6플레이어의 라운드 스코어의 이미지
    ...
    public Image[] i_RScoreB5 = new Image[5]; //B팀의 5플레이어의 라운드 스코어의 이미지
    public Image[] i_RScoreB6 = new Image[5]; //B팀의 6플레이어의 라운드 스코어의 이미지
    ...
    public int DartS = 0;// 임시 다트 점수가 1~20중 랜덤값을 저장할 변수
    public int DartM = 0;//임시 다트 점수가 1~3까지 곱해줄 랜덤값을 저장할 변수
    ...
    public int DartCountA5 = 0; //A팀의 5플레이어가 게임이 끝날떄까지 다트를 던진 횟수를 저장할 변수
    public int DartCountA6 = 0; //A팀의 6플레이어가 게임이 끝날떄까지 다트를 던진 횟수를 저장할 변수
    ...
    public int DartCountB5 = 0; //B팀의 5플레이어가 게임이 끝날떄까지 다트를 던진 횟수를 저장할 변수
    public int DartCountB6 = 0; //B팀의 6플레이어가 게임이 끝날떄까지 다트를 던진 횟수를 저장할 변수
    ...
    public int TotalA5 = 0; //A팀의 5플레이어의 총합점수
    public int TotalA6 = 0; //A팀의 6플레이어의 총합점수
    public int TotalB1 = 0; //B팀의 1플레이어의 총합점수
    public int TotalB2 = 0; //B팀의 2플레이어의 총합점수
    public int TotalB3 = 0; //B팀의 2플레이어의 총합점수
    public int TotalB4 = 0; //A팀의 4플레이어의 총합점수
    public int TotalB5 = 0; //B팀의 5플레이어의 총합점수
    public int TotalB6 = 0; //B팀의 6플레이어의 총합점수
    ...
    public int[] ScoreSaveA5 = new int[20]; //A팀의 5플레이어의 각라운드 스코어를 저장해줄 변수
    public int[] ScoreSaveA6 = new int[20]; //A팀의 6플레이어의 각라운드 스코어를 저장해줄 변수
    ...
    public int[] ScoreSaveB4 = new int[20]; //A팀의 4플레이어의 각라운드 스코어를 저장해줄 변수
    public int[] ScoreSaveB5 = new int[20]; //B팀의 5플레이어의 각라운드 스코어를 저장해줄 변수
    public int[] ScoreSaveB6 = new int[20]; //B팀의 6플레이어의 각라운드 스코어를 저장해줄 변수
    ...
    public float AverageA5 = 0; //A팀의 5플레이어의 평균값
    public float AverageA6 = 0; //A팀의 6플레이어의 평균값
    public float AverageB1 = 0; //B팀의 1플레이어의 평균값
    public float AverageB2 = 0; //B팀의 2플레이어의 평균값
    public float AverageB3 = 0; //B팀의 3플레이어의 평균값
    public float AverageB4 = 0; //A팀의 4플레이어의 평균값
    public float AverageB5 = 0; //B팀의 5플레이어의 평균값
    public float AverageB6 = 0; //B팀의 6플레이어의 평균값
    ...
    void Update()
    {
        ...
        if (csSingleton.getInstance.g_bTarget && !isRead && !isSpace && !isWin && !isBust && csgmg.isAni == false)
        {
            ...
            {
                if (Players == 0 && isAT && !isBT && !isBust && !isRead)
                {
                ...
                else if (Players == 3 && isAT && !isBT && !isBust && !isRead)
                {
                    if (Counting == 0 && isAT && !isBT && !isRead && !isBust)
                    {
                        DartCountA4++;
                ...
                else if (Players == 4 && isAT && !isBT && !isBust && !isRead)
                {
                    if (Counting == 0 && isAT && !isBT && !isRead && !isBust)
                    {
                        DartCountA5++;
                ...
                else if (Players == 5 && isAT && !isBT && !isBust && !isRead)
                {
                    if (Counting == 0 && isAT && !isBT && !isRead && !isBust)
                    {
                        DartCountA6++;
                ...
                else if (Players == 3 && isBT && !isAT && !isBust && !isRead)
                {
                    if (Counting == 0 && isBT && !isAT && !isBust && !isRead)
                    {
                        DartCountB4++;
                ...
                else if (Players == 4 && isBT && !isAT && !isBust && !isRead)
                {
                    if (Counting == 0 && isBT && !isAT && !isBust && !isRead)
                    {
                        DartCountB5++;
                ...
                else if (Players == 5 && isBT && !isAT && !isBust && !isRead)
                {
                    if (Counting == 0 && isBT && !isAT && !isBust && !isRead)
                    {
                        DartCountB6++;
        ...
        if (Input.GetKeyDown(KeyCode.Space) && Counting == 4 && !isWin && isSpace && csgmg.isAni == false)
        {
            ...
            if (isBT && Players == 4) //팀숫자 뺴고 플레이어 숫자 뺴기
            {
                a_source.PlayOneShot(ac_shoot2, 1.0f);
                for (int i = 0; i < g_Dart.Length; i++)
                    g_Dart[i].GetComponent<Image>().sprite = s_OffDart;
            ...
            if (isBT && Players == 5) //팀숫자 뺴고 플레이어 숫자 뺴기
            {
                a_source.PlayOneShot(ac_shoot2, 1.0f);
                for (int i = 0; i < g_Dart.Length; i++)
                    g_Dart[i].GetComponent<Image>().sprite = s_OffDart;
        ...
        if (Round == RoundStop && isBT && Counting == 3)
            GameEndRead();
    }
    ...
    void BustAndRoundRead()
    {
        ...
        if (TeamScore[Teams] == 0 && !isBust && !isRead)
        {
    ...
    void ImageUP()
    {
        ...
        if (isAT && !isBT && Players == 4)
        {
            if (RScore == 5)
            {
                ...
                t_TA5RScoreText[0].text = ScoreSaveA5[1].ToString();
                t_TA5RScoreText[1].text = ScoreSaveA5[2].ToString();
                t_TA5RScoreText[2].text = ScoreSaveA5[3].ToString();
                t_TA5RScoreText[3].text = ScoreSaveA5[4].ToString();
                t_TA5RScoreText[4].text = ScoreSaveA5[5].ToString();
            }
            ...
            if (RScore == 6)
            {
                ...
                t_TA5RScoreText[0].text = ScoreSaveA5[2].ToString();
                t_TA5RScoreText[1].text = ScoreSaveA5[3].ToString();
                t_TA5RScoreText[2].text = ScoreSaveA5[4].ToString();
                t_TA5RScoreText[3].text = ScoreSaveA5[5].ToString();
                t_TA5RScoreText[4].text = ScoreSaveA5[6].ToString();
            }
            ...
            if (RScore == 7)
            {
                ...
                t_TA5RScoreText[0].text = ScoreSaveA5[3].ToString();
                t_TA5RScoreText[1].text = ScoreSaveA5[4].ToString();
                t_TA5RScoreText[2].text = ScoreSaveA5[5].ToString();
                t_TA5RScoreText[3].text = ScoreSaveA5[6].ToString();
                t_TA5RScoreText[4].text = ScoreSaveA5[7].ToString();
            }
            ...
            if (RScore == 8)
            {
                ...
                t_TA5RScoreText[0].text = ScoreSaveA5[4].ToString();
                t_TA5RScoreText[1].text = ScoreSaveA5[5].ToString();
                t_TA5RScoreText[2].text = ScoreSaveA5[6].ToString();
                t_TA5RScoreText[3].text = ScoreSaveA5[7].ToString();
                t_TA5RScoreText[4].text = ScoreSaveA5[8].ToString();
            }
            ...
            if (RScore == 9)
            {
                ...
                t_TA5RScoreText[0].text = ScoreSaveA5[5].ToString();
                t_TA5RScoreText[1].text = ScoreSaveA5[6].ToString();
                t_TA5RScoreText[2].text = ScoreSaveA5[7].ToString();
                t_TA5RScoreText[3].text = ScoreSaveA5[8].ToString();
                t_TA5RScoreText[4].text = ScoreSaveA5[9].ToString();
            }
            ...
            if (RScore == 10)
            {
                ...
                t_TA5RScoreText[0].text = ScoreSaveA5[6].ToString();
                t_TA5RScoreText[1].text = ScoreSaveA5[7].ToString();
                t_TA5RScoreText[2].text = ScoreSaveA5[8].ToString();
                t_TA5RScoreText[3].text = ScoreSaveA5[9].ToString();
                t_TA5RScoreText[4].text = ScoreSaveA5[10].ToString();
            }
            ...
            if (RScore == 11)
            {
                ...
                t_TA5RScoreText[0].text = ScoreSaveA5[7].ToString();
                t_TA5RScoreText[1].text = ScoreSaveA5[8].ToString();
                t_TA5RScoreText[2].text = ScoreSaveA5[9].ToString();
                t_TA5RScoreText[3].text = ScoreSaveA5[10].ToString();
                t_TA5RScoreText[4].text = ScoreSaveA5[11].ToString();
            }
            ...
            if (RScore == 12)
            {
                ...
                t_TA5RScoreText[0].text = ScoreSaveA5[8].ToString();
                t_TA5RScoreText[1].text = ScoreSaveA5[9].ToString();
                t_TA5RScoreText[2].text = ScoreSaveA5[10].ToString();
                t_TA5RScoreText[3].text = ScoreSaveA5[11].ToString();
                t_TA5RScoreText[4].text = ScoreSaveA5[12].ToString();
            }
            ...
            if (RScore == 13)
            {
                ...
                t_TA5RScoreText[0].text = ScoreSaveA5[9].ToString();
                t_TA5RScoreText[1].text = ScoreSaveA5[10].ToString();
                t_TA5RScoreText[2].text = ScoreSaveA5[11].ToString();
                t_TA5RScoreText[3].text = ScoreSaveA5[12].ToString();
                t_TA5RScoreText[4].text = ScoreSaveA5[13].ToString();
            }
            ...
            if (RScore == 14)
            {
                ...
                t_TA5RScoreText[0].text = ScoreSaveA5[10].ToString();
                t_TA5RScoreText[1].text = ScoreSaveA5[11].ToString();
                t_TA5RScoreText[2].text = ScoreSaveA5[12].ToString();
                t_TA5RScoreText[3].text = ScoreSaveA5[13].ToString();
                t_TA5RScoreText[4].text = ScoreSaveA5[14].ToString();
            }

            if (RScore == 15)
            {
                i_RScoreA5[0].GetComponent<Image>().sprite = s_RScore[11];
                i_RScoreA5[1].GetComponent<Image>().sprite = s_RScore[12];
                i_RScoreA5[2].GetComponent<Image>().sprite = s_RScore[13];
                i_RScoreA5[3].GetComponent<Image>().sprite = s_RScore[14];
                i_RScoreA5[4].GetComponent<Image>().sprite = s_RScore[15];

                t_TA5RScoreText[0].text = ScoreSaveA5[11].ToString();
                t_TA5RScoreText[1].text = ScoreSaveA5[12].ToString();
                t_TA5RScoreText[2].text = ScoreSaveA5[13].ToString();
                t_TA5RScoreText[3].text = ScoreSaveA5[14].ToString();
                t_TA5RScoreText[4].text = ScoreSaveA5[15].ToString();
            }

            if (RScore == 16)
            {
                i_RScoreA5[0].GetComponent<Image>().sprite = s_RScore[12];
                i_RScoreA5[1].GetComponent<Image>().sprite = s_RScore[13];
                i_RScoreA5[2].GetComponent<Image>().sprite = s_RScore[14];
                i_RScoreA5[3].GetComponent<Image>().sprite = s_RScore[15];
                i_RScoreA5[4].GetComponent<Image>().sprite = s_RScore[16];

                t_TA5RScoreText[0].text = ScoreSaveA5[12].ToString();
                t_TA5RScoreText[1].text = ScoreSaveA5[13].ToString();
                t_TA5RScoreText[2].text = ScoreSaveA5[14].ToString();
                t_TA5RScoreText[3].text = ScoreSaveA5[15].ToString();
                t_TA5RScoreText[4].text = ScoreSaveA5[16].ToString();
            }

            if (RScore == 17)
            {
                i_RScoreA5[0].GetComponent<Image>().sprite = s_RScore[13];
                i_RScoreA5[1].GetComponent<Image>().sprite = s_RScore[14];
                i_RScoreA5[2].GetComponent<Image>().sprite = s_RScore[15];
                i_RScoreA5[3].GetComponent<Image>().sprite = s_RScore[16];
                i_RScoreA5[4].GetComponent<Image>().sprite = s_RScore[17];

                t_TA5RScoreText[0].text = ScoreSaveA5[13].ToString();
                t_TA5RScoreText[1].text = ScoreSaveA5[14].ToString();
                t_TA5RScoreText[2].text = ScoreSaveA5[15].ToString();
                t_TA5RScoreText[3].text = ScoreSaveA5[16].ToString();
                t_TA5RScoreText[4].text = ScoreSaveA5[17].ToString();
            }

            if (RScore == 18)
            {
                i_RScoreA5[0].GetComponent<Image>().sprite = s_RScore[14];
                i_RScoreA5[1].GetComponent<Image>().sprite = s_RScore[15];
                i_RScoreA5[2].GetComponent<Image>().sprite = s_RScore[16];
                i_RScoreA5[3].GetComponent<Image>().sprite = s_RScore[17];
                i_RScoreA5[4].GetComponent<Image>().sprite = s_RScore[18];

                t_TA5RScoreText[0].text = ScoreSaveA5[14].ToString();
                t_TA5RScoreText[1].text = ScoreSaveA5[15].ToString();
                t_TA5RScoreText[2].text = ScoreSaveA5[16].ToString();
                t_TA5RScoreText[3].text = ScoreSaveA5[17].ToString();
                t_TA5RScoreText[4].text = ScoreSaveA5[18].ToString();
            }

            if (RScore == 19)
            {
                i_RScoreA5[0].GetComponent<Image>().sprite = s_RScore[15];
                i_RScoreA5[1].GetComponent<Image>().sprite = s_RScore[16];
                i_RScoreA5[2].GetComponent<Image>().sprite = s_RScore[17];
                i_RScoreA5[3].GetComponent<Image>().sprite = s_RScore[18];
                i_RScoreA5[4].GetComponent<Image>().sprite = s_RScore[19];

                t_TA5RScoreText[0].text = ScoreSaveA5[15].ToString();
                t_TA5RScoreText[1].text = ScoreSaveA5[16].ToString();
                t_TA5RScoreText[2].text = ScoreSaveA5[17].ToString();
                t_TA5RScoreText[3].text = ScoreSaveA5[18].ToString();
                t_TA5RScoreText[4].text = ScoreSaveA5[19].ToString();
            }

            if (RScore == 20)
            {
                i_RScoreA5[0].GetComponent<Image>().sprite = s_RScore[16];
                i_RScoreA5[1].GetComponent<Image>().sprite = s_RScore[17];
                i_RScoreA5[2].GetComponent<Image>().sprite = s_RScore[18];
                i_RScoreA5[3].GetComponent<Image>().sprite = s_RScore[19];
                i_RScoreA5[4].GetComponent<Image>().sprite = s_RScore[20];

                t_TA5RScoreText[0].text = ScoreSaveA5[16].ToString();
                t_TA5RScoreText[1].text = ScoreSaveA5[17].ToString();
                t_TA5RScoreText[2].text = ScoreSaveA5[18].ToString();
                t_TA5RScoreText[3].text = ScoreSaveA5[19].ToString();
                t_TA5RScoreText[4].text = ScoreSaveA5[20].ToString();
            }
        }

        if (isAT && !isBT && Players == 5)
        {
            if (RScore == 5)
            {
                ...
                t_TA6RScoreText[0].text = ScoreSaveA6[1].ToString();
                t_TA6RScoreText[1].text = ScoreSaveA6[2].ToString();
                t_TA6RScoreText[2].text = ScoreSaveA6[3].ToString();
                t_TA6RScoreText[3].text = ScoreSaveA6[4].ToString();
                t_TA6RScoreText[4].text = ScoreSaveA6[5].ToString();
            }
            ...
            if (RScore == 6)
            {
                ...
                t_TA6RScoreText[0].text = ScoreSaveA6[2].ToString();
                t_TA6RScoreText[1].text = ScoreSaveA6[3].ToString();
                t_TA6RScoreText[2].text = ScoreSaveA6[4].ToString();
                t_TA6RScoreText[3].text = ScoreSaveA6[5].ToString();
                t_TA6RScoreText[4].text = ScoreSaveA6[6].ToString();
            }
            ...
            if (RScore == 7)
            {
                ...
                t_TA6RScoreText[0].text = ScoreSaveA6[3].ToString();
                t_TA6RScoreText[1].text = ScoreSaveA6[4].ToString();
                t_TA6RScoreText[2].text = ScoreSaveA6[5].ToString();
                t_TA6RScoreText[3].text = ScoreSaveA6[6].ToString();
                t_TA6RScoreText[4].text = ScoreSaveA6[7].ToString();
            }
            ...
            if (RScore == 8)
            {
                ...
                t_TA6RScoreText[0].text = ScoreSaveA6[4].ToString();
                t_TA6RScoreText[1].text = ScoreSaveA6[5].ToString();
                t_TA6RScoreText[2].text = ScoreSaveA6[6].ToString();
                t_TA6RScoreText[3].text = ScoreSaveA6[7].ToString();
                t_TA6RScoreText[4].text = ScoreSaveA6[8].ToString();
            }
            ...
            if (RScore == 9)
            {
                ...
                t_TA6RScoreText[0].text = ScoreSaveA6[5].ToString();
                t_TA6RScoreText[1].text = ScoreSaveA6[6].ToString();
                t_TA6RScoreText[2].text = ScoreSaveA6[7].ToString();
                t_TA6RScoreText[3].text = ScoreSaveA6[8].ToString();
                t_TA6RScoreText[4].text = ScoreSaveA6[9].ToString();
            }
            ...
            if (RScore == 10)
            {
                ...
                t_TA6RScoreText[0].text = ScoreSaveA6[6].ToString();
                t_TA6RScoreText[1].text = ScoreSaveA6[7].ToString();
                t_TA6RScoreText[2].text = ScoreSaveA6[8].ToString();
                t_TA6RScoreText[3].text = ScoreSaveA6[9].ToString();
                t_TA6RScoreText[4].text = ScoreSaveA6[10].ToString();
            }
            ...
            if (RScore == 11)
            {
                ...
                t_TA6RScoreText[0].text = ScoreSaveA6[7].ToString();
                t_TA6RScoreText[1].text = ScoreSaveA6[8].ToString();
                t_TA6RScoreText[2].text = ScoreSaveA6[9].ToString();
                t_TA6RScoreText[3].text = ScoreSaveA6[10].ToString();
                t_TA6RScoreText[4].text = ScoreSaveA6[11].ToString();
            }
            ...
            if (RScore == 12)
            {
                ...
                t_TA6RScoreText[0].text = ScoreSaveA6[8].ToString();
                t_TA6RScoreText[1].text = ScoreSaveA6[9].ToString();
                t_TA6RScoreText[2].text = ScoreSaveA6[10].ToString();
                t_TA6RScoreText[3].text = ScoreSaveA6[11].ToString();
                t_TA6RScoreText[4].text = ScoreSaveA6[12].ToString();
            }
            ...
            if (RScore == 13)
            {
                ...
                t_TA6RScoreText[0].text = ScoreSaveA6[9].ToString();
                t_TA6RScoreText[1].text = ScoreSaveA6[10].ToString();
                t_TA6RScoreText[2].text = ScoreSaveA6[11].ToString();
                t_TA6RScoreText[3].text = ScoreSaveA6[12].ToString();
                t_TA6RScoreText[4].text = ScoreSaveA6[13].ToString();
            }
            ...
            if (RScore == 14)
            {
                ...
                t_TA6RScoreText[0].text = ScoreSaveA6[10].ToString();
                t_TA6RScoreText[1].text = ScoreSaveA6[11].ToString();
                t_TA6RScoreText[2].text = ScoreSaveA6[12].ToString();
                t_TA6RScoreText[3].text = ScoreSaveA6[13].ToString();
                t_TA6RScoreText[4].text = ScoreSaveA6[14].ToString();
            }

            if (RScore == 15)
            {
                i_RScoreA6[0].GetComponent<Image>().sprite = s_RScore[11];
                i_RScoreA6[1].GetComponent<Image>().sprite = s_RScore[12];
                i_RScoreA6[2].GetComponent<Image>().sprite = s_RScore[13];
                i_RScoreA6[3].GetComponent<Image>().sprite = s_RScore[14];
                i_RScoreA6[4].GetComponent<Image>().sprite = s_RScore[15];

                t_TA6RScoreText[0].text = ScoreSaveA6[11].ToString();
                t_TA6RScoreText[1].text = ScoreSaveA6[12].ToString();
                t_TA6RScoreText[2].text = ScoreSaveA6[13].ToString();
                t_TA6RScoreText[3].text = ScoreSaveA6[14].ToString();
                t_TA6RScoreText[4].text = ScoreSaveA6[15].ToString();
            }

            if (RScore == 16)
            {
                i_RScoreA6[0].GetComponent<Image>().sprite = s_RScore[12];
                i_RScoreA6[1].GetComponent<Image>().sprite = s_RScore[13];
                i_RScoreA6[2].GetComponent<Image>().sprite = s_RScore[14];
                i_RScoreA6[3].GetComponent<Image>().sprite = s_RScore[15];
                i_RScoreA6[4].GetComponent<Image>().sprite = s_RScore[16];

                t_TA6RScoreText[0].text = ScoreSaveA6[12].ToString();
                t_TA6RScoreText[1].text = ScoreSaveA6[13].ToString();
                t_TA6RScoreText[2].text = ScoreSaveA6[14].ToString();
                t_TA6RScoreText[3].text = ScoreSaveA6[15].ToString();
                t_TA6RScoreText[4].text = ScoreSaveA6[16].ToString();
            }

            if (RScore == 17)
            {
                i_RScoreA6[0].GetComponent<Image>().sprite = s_RScore[13];
                i_RScoreA6[1].GetComponent<Image>().sprite = s_RScore[14];
                i_RScoreA6[2].GetComponent<Image>().sprite = s_RScore[15];
                i_RScoreA6[3].GetComponent<Image>().sprite = s_RScore[16];
                i_RScoreA6[4].GetComponent<Image>().sprite = s_RScore[17];

                t_TA6RScoreText[0].text = ScoreSaveA6[13].ToString();
                t_TA6RScoreText[1].text = ScoreSaveA6[14].ToString();
                t_TA6RScoreText[2].text = ScoreSaveA6[15].ToString();
                t_TA6RScoreText[3].text = ScoreSaveA6[16].ToString();
                t_TA6RScoreText[4].text = ScoreSaveA6[17].ToString();
            }

            if (RScore == 18)
            {
                i_RScoreA6[0].GetComponent<Image>().sprite = s_RScore[14];
                i_RScoreA6[1].GetComponent<Image>().sprite = s_RScore[15];
                i_RScoreA6[2].GetComponent<Image>().sprite = s_RScore[16];
                i_RScoreA6[3].GetComponent<Image>().sprite = s_RScore[17];
                i_RScoreA6[4].GetComponent<Image>().sprite = s_RScore[18];

                t_TA6RScoreText[0].text = ScoreSaveA6[14].ToString();
                t_TA6RScoreText[1].text = ScoreSaveA6[15].ToString();
                t_TA6RScoreText[2].text = ScoreSaveA6[16].ToString();
                t_TA6RScoreText[3].text = ScoreSaveA6[17].ToString();
                t_TA6RScoreText[4].text = ScoreSaveA6[18].ToString();
            }

            if (RScore == 19)
            {
                i_RScoreA6[0].GetComponent<Image>().sprite = s_RScore[15];
                i_RScoreA6[1].GetComponent<Image>().sprite = s_RScore[16];
                i_RScoreA6[2].GetComponent<Image>().sprite = s_RScore[17];
                i_RScoreA6[3].GetComponent<Image>().sprite = s_RScore[18];
                i_RScoreA6[4].GetComponent<Image>().sprite = s_RScore[19];

                t_TA6RScoreText[0].text = ScoreSaveA6[15].ToString();
                t_TA6RScoreText[1].text = ScoreSaveA6[16].ToString();
                t_TA6RScoreText[2].text = ScoreSaveA6[17].ToString();
                t_TA6RScoreText[3].text = ScoreSaveA6[18].ToString();
                t_TA6RScoreText[4].text = ScoreSaveA6[19].ToString();
            }

            if (RScore == 20)
            {
                i_RScoreA6[0].GetComponent<Image>().sprite = s_RScore[16];
                i_RScoreA6[1].GetComponent<Image>().sprite = s_RScore[17];
                i_RScoreA6[2].GetComponent<Image>().sprite = s_RScore[18];
                i_RScoreA6[3].GetComponent<Image>().sprite = s_RScore[19];
                i_RScoreA6[4].GetComponent<Image>().sprite = s_RScore[20];

                t_TA6RScoreText[0].text = ScoreSaveA6[16].ToString();
                t_TA6RScoreText[1].text = ScoreSaveA6[17].ToString();
                t_TA6RScoreText[2].text = ScoreSaveA6[18].ToString();
                t_TA6RScoreText[3].text = ScoreSaveA6[19].ToString();
                t_TA6RScoreText[4].text = ScoreSaveA6[20].ToString();
            }
        }
        ...
        if (isBT && !isAT && Players == 4)
        {
            if (RScore == 5)
            {
                ...
                t_TB5RScoreText[0].text = ScoreSaveB5[1].ToString();
                t_TB5RScoreText[1].text = ScoreSaveB5[2].ToString();
                t_TB5RScoreText[2].text = ScoreSaveB5[3].ToString();
                t_TB5RScoreText[3].text = ScoreSaveB5[4].ToString();
                t_TB5RScoreText[4].text = ScoreSaveB5[5].ToString();
            }
            ...
            if (RScore == 6)
            {
                ...
                t_TB5RScoreText[0].text = ScoreSaveB5[2].ToString();
                t_TB5RScoreText[1].text = ScoreSaveB5[3].ToString();
                t_TB5RScoreText[2].text = ScoreSaveB5[4].ToString();
                t_TB5RScoreText[3].text = ScoreSaveB5[5].ToString();
                t_TB5RScoreText[4].text = ScoreSaveB5[6].ToString();
            }
            ...
            if (RScore == 7)
            {
                ...
                t_TB5RScoreText[0].text = ScoreSaveB5[3].ToString();
                t_TB5RScoreText[1].text = ScoreSaveB5[4].ToString();
                t_TB5RScoreText[2].text = ScoreSaveB5[5].ToString();
                t_TB5RScoreText[3].text = ScoreSaveB5[6].ToString();
                t_TB5RScoreText[4].text = ScoreSaveB5[7].ToString();
            }
            ...
            if (RScore == 8)
            {
                ...
                t_TB5RScoreText[0].text = ScoreSaveB5[4].ToString();
                t_TB5RScoreText[1].text = ScoreSaveB5[5].ToString();
                t_TB5RScoreText[2].text = ScoreSaveB5[6].ToString();
                t_TB5RScoreText[3].text = ScoreSaveB5[7].ToString();
                t_TB5RScoreText[4].text = ScoreSaveB5[8].ToString();
            }
            ...
            if (RScore == 9)
            {
                ...
                t_TB5RScoreText[0].text = ScoreSaveB5[5].ToString();
                t_TB5RScoreText[1].text = ScoreSaveB5[6].ToString();
                t_TB5RScoreText[2].text = ScoreSaveB5[7].ToString();
                t_TB5RScoreText[3].text = ScoreSaveB5[8].ToString();
                t_TB5RScoreText[4].text = ScoreSaveB5[9].ToString();
            }
            ...
            if (RScore == 10)
            {
                ...
                t_TB5RScoreText[0].text = ScoreSaveB5[6].ToString();
                t_TB5RScoreText[1].text = ScoreSaveB5[7].ToString();
                t_TB5RScoreText[2].text = ScoreSaveB5[8].ToString();
                t_TB5RScoreText[3].text = ScoreSaveB5[9].ToString();
                t_TB5RScoreText[4].text = ScoreSaveB5[10].ToString();
            }
            ...
            if (RScore == 11)
            {
                ...
                t_TB5RScoreText[0].text = ScoreSaveB5[7].ToString();
                t_TB5RScoreText[1].text = ScoreSaveB5[8].ToString();
                t_TB5RScoreText[2].text = ScoreSaveB5[9].ToString();
                t_TB5RScoreText[3].text = ScoreSaveB5[10].ToString();
                t_TB5RScoreText[4].text = ScoreSaveB5[11].ToString();
            }
            ...
            if (RScore == 12)
            {
                ...
                t_TB5RScoreText[0].text = ScoreSaveB5[8].ToString();
                t_TB5RScoreText[1].text = ScoreSaveB5[9].ToString();
                t_TB5RScoreText[2].text = ScoreSaveB5[10].ToString();
                t_TB5RScoreText[3].text = ScoreSaveB5[11].ToString();
                t_TB5RScoreText[4].text = ScoreSaveB5[12].ToString();
            }
            ...
            if (RScore == 13)
            {
                ...
                t_TB5RScoreText[0].text = ScoreSaveB5[9].ToString();
                t_TB5RScoreText[1].text = ScoreSaveB5[10].ToString();
                t_TB5RScoreText[2].text = ScoreSaveB5[11].ToString();
                t_TB5RScoreText[3].text = ScoreSaveB5[12].ToString();
                t_TB5RScoreText[4].text = ScoreSaveB5[13].ToString();
            }
            ...
            if (RScore == 14)
            {
                ...
                t_TB5RScoreText[0].text = ScoreSaveB5[10].ToString();
                t_TB5RScoreText[1].text = ScoreSaveB5[11].ToString();
                t_TB5RScoreText[2].text = ScoreSaveB5[12].ToString();
                t_TB5RScoreText[3].text = ScoreSaveB5[13].ToString();
                t_TB5RScoreText[4].text = ScoreSaveB5[14].ToString();

            }
            if (RScore == 15)
            {
                i_RScoreB5[0].GetComponent<Image>().sprite = s_RScore[11];
                i_RScoreB5[1].GetComponent<Image>().sprite = s_RScore[12];
                i_RScoreB5[2].GetComponent<Image>().sprite = s_RScore[13];
                i_RScoreB5[3].GetComponent<Image>().sprite = s_RScore[14];
                i_RScoreB5[4].GetComponent<Image>().sprite = s_RScore[15];

                t_TB5RScoreText[0].text = ScoreSaveB5[11].ToString();
                t_TB5RScoreText[1].text = ScoreSaveB5[12].ToString();
                t_TB5RScoreText[2].text = ScoreSaveB5[13].ToString();
                t_TB5RScoreText[3].text = ScoreSaveB5[14].ToString();
                t_TB5RScoreText[4].text = ScoreSaveB5[15].ToString();
            }

            if (RScore == 16)
            {
                i_RScoreB5[0].GetComponent<Image>().sprite = s_RScore[12];
                i_RScoreB5[1].GetComponent<Image>().sprite = s_RScore[13];
                i_RScoreB5[2].GetComponent<Image>().sprite = s_RScore[14];
                i_RScoreB5[3].GetComponent<Image>().sprite = s_RScore[15];
                i_RScoreB5[4].GetComponent<Image>().sprite = s_RScore[16];

                t_TB5RScoreText[0].text = ScoreSaveB5[12].ToString();
                t_TB5RScoreText[1].text = ScoreSaveB5[13].ToString();
                t_TB5RScoreText[2].text = ScoreSaveB5[14].ToString();
                t_TB5RScoreText[3].text = ScoreSaveB5[15].ToString();
                t_TB5RScoreText[4].text = ScoreSaveB5[16].ToString();
            }

            if (RScore == 17)
            {
                i_RScoreB5[0].GetComponent<Image>().sprite = s_RScore[13];
                i_RScoreB5[1].GetComponent<Image>().sprite = s_RScore[14];
                i_RScoreB5[2].GetComponent<Image>().sprite = s_RScore[15];
                i_RScoreB5[3].GetComponent<Image>().sprite = s_RScore[16];
                i_RScoreB5[4].GetComponent<Image>().sprite = s_RScore[17];

                t_TB5RScoreText[0].text = ScoreSaveB5[13].ToString();
                t_TB5RScoreText[1].text = ScoreSaveB5[14].ToString();
                t_TB5RScoreText[2].text = ScoreSaveB5[15].ToString();
                t_TB5RScoreText[3].text = ScoreSaveB5[16].ToString();
                t_TB5RScoreText[4].text = ScoreSaveB5[17].ToString();
            }

            if (RScore == 18)
            {
                i_RScoreB5[0].GetComponent<Image>().sprite = s_RScore[14];
                i_RScoreB5[1].GetComponent<Image>().sprite = s_RScore[15];
                i_RScoreB5[2].GetComponent<Image>().sprite = s_RScore[16];
                i_RScoreB5[3].GetComponent<Image>().sprite = s_RScore[17];
                i_RScoreB5[4].GetComponent<Image>().sprite = s_RScore[18];

                t_TB5RScoreText[0].text = ScoreSaveB5[14].ToString();
                t_TB5RScoreText[1].text = ScoreSaveB5[15].ToString();
                t_TB5RScoreText[2].text = ScoreSaveB5[16].ToString();
                t_TB5RScoreText[3].text = ScoreSaveB5[17].ToString();
                t_TB5RScoreText[4].text = ScoreSaveB5[18].ToString();
            }

            if (RScore == 19)
            {
                i_RScoreB5[0].GetComponent<Image>().sprite = s_RScore[15];
                i_RScoreB5[1].GetComponent<Image>().sprite = s_RScore[16];
                i_RScoreB5[2].GetComponent<Image>().sprite = s_RScore[17];
                i_RScoreB5[3].GetComponent<Image>().sprite = s_RScore[18];
                i_RScoreB5[4].GetComponent<Image>().sprite = s_RScore[19];

                t_TB5RScoreText[0].text = ScoreSaveB5[15].ToString();
                t_TB5RScoreText[1].text = ScoreSaveB5[16].ToString();
                t_TB5RScoreText[2].text = ScoreSaveB5[17].ToString();
                t_TB5RScoreText[3].text = ScoreSaveB5[18].ToString();
                t_TB5RScoreText[4].text = ScoreSaveB5[19].ToString();
            }

            if (RScore == 20)
            {
                i_RScoreB5[0].GetComponent<Image>().sprite = s_RScore[16];
                i_RScoreB5[1].GetComponent<Image>().sprite = s_RScore[17];
                i_RScoreB5[2].GetComponent<Image>().sprite = s_RScore[18];
                i_RScoreB5[3].GetComponent<Image>().sprite = s_RScore[19];
                i_RScoreB5[4].GetComponent<Image>().sprite = s_RScore[20];

                t_TB5RScoreText[0].text = ScoreSaveB5[16].ToString();
                t_TB5RScoreText[1].text = ScoreSaveB5[17].ToString();
                t_TB5RScoreText[2].text = ScoreSaveB5[18].ToString();
                t_TB5RScoreText[3].text = ScoreSaveB5[19].ToString();
                t_TB5RScoreText[4].text = ScoreSaveB5[20].ToString();
            }

        }

        if (isBT && !isAT && Players == 5)
        {
            if (RScore == 5)
            {
                ...
                t_TB6RScoreText[0].text = ScoreSaveB6[1].ToString();
                t_TB6RScoreText[1].text = ScoreSaveB6[2].ToString();
                t_TB6RScoreText[2].text = ScoreSaveB6[3].ToString();
                t_TB6RScoreText[3].text = ScoreSaveB6[4].ToString();
                t_TB6RScoreText[4].text = ScoreSaveB6[5].ToString();
            }
            ...
            if (RScore == 6)
            {
                ...
                t_TB6RScoreText[0].text = ScoreSaveB6[2].ToString();
                t_TB6RScoreText[1].text = ScoreSaveB6[3].ToString();
                t_TB6RScoreText[2].text = ScoreSaveB6[4].ToString();
                t_TB6RScoreText[3].text = ScoreSaveB6[5].ToString();
                t_TB6RScoreText[4].text = ScoreSaveB6[6].ToString();
            }
            ...
            if (RScore == 7)
            {
                ...
                t_TB6RScoreText[0].text = ScoreSaveB6[3].ToString();
                t_TB6RScoreText[1].text = ScoreSaveB6[4].ToString();
                t_TB6RScoreText[2].text = ScoreSaveB6[5].ToString();
                t_TB6RScoreText[3].text = ScoreSaveB6[6].ToString();
                t_TB6RScoreText[4].text = ScoreSaveB6[7].ToString();
            }
            ...
            if (RScore == 8)
            {
                ...
                t_TB6RScoreText[0].text = ScoreSaveB6[4].ToString();
                t_TB6RScoreText[1].text = ScoreSaveB6[5].ToString();
                t_TB6RScoreText[2].text = ScoreSaveB6[6].ToString();
                t_TB6RScoreText[3].text = ScoreSaveB6[7].ToString();
                t_TB6RScoreText[4].text = ScoreSaveB6[8].ToString();
            }
            ...
            if (RScore == 9)
            {
                ...
                t_TB6RScoreText[0].text = ScoreSaveB6[5].ToString();
                t_TB6RScoreText[1].text = ScoreSaveB6[6].ToString();
                t_TB6RScoreText[2].text = ScoreSaveB6[7].ToString();
                t_TB6RScoreText[3].text = ScoreSaveB6[8].ToString();
                t_TB6RScoreText[4].text = ScoreSaveB6[9].ToString();
            }
            ...
            if (RScore == 10)
            {
                ...
                t_TB6RScoreText[0].text = ScoreSaveB6[6].ToString();
                t_TB6RScoreText[1].text = ScoreSaveB6[7].ToString();
                t_TB6RScoreText[2].text = ScoreSaveB6[8].ToString();
                t_TB6RScoreText[3].text = ScoreSaveB6[9].ToString();
                t_TB6RScoreText[4].text = ScoreSaveB6[10].ToString();
            }
            ...
            if (RScore == 11)
            {
                ...
                t_TB6RScoreText[0].text = ScoreSaveB6[7].ToString();
                t_TB6RScoreText[1].text = ScoreSaveB6[8].ToString();
                t_TB6RScoreText[2].text = ScoreSaveB6[9].ToString();
                t_TB6RScoreText[3].text = ScoreSaveB6[10].ToString();
                t_TB6RScoreText[4].text = ScoreSaveB6[11].ToString();
            }
            ...
            if (RScore == 12)
            {
                ...
                t_TB6RScoreText[0].text = ScoreSaveB6[8].ToString();
                t_TB6RScoreText[1].text = ScoreSaveB6[9].ToString();
                t_TB6RScoreText[2].text = ScoreSaveB6[10].ToString();
                t_TB6RScoreText[3].text = ScoreSaveB6[11].ToString();
                t_TB6RScoreText[4].text = ScoreSaveB6[12].ToString();
            }
            ...
            if (RScore == 13)
            {
                ...
                t_TB6RScoreText[0].text = ScoreSaveB6[9].ToString();
                t_TB6RScoreText[1].text = ScoreSaveB6[10].ToString();
                t_TB6RScoreText[2].text = ScoreSaveB6[11].ToString();
                t_TB6RScoreText[3].text = ScoreSaveB6[12].ToString();
                t_TB6RScoreText[4].text = ScoreSaveB6[13].ToString();
            }
            ...
            if (RScore == 14)
            {
                ...
                t_TB6RScoreText[0].text = ScoreSaveB6[10].ToString();
                t_TB6RScoreText[1].text = ScoreSaveB6[11].ToString();
                t_TB6RScoreText[2].text = ScoreSaveB6[12].ToString();
                t_TB6RScoreText[3].text = ScoreSaveB6[13].ToString();
                t_TB6RScoreText[4].text = ScoreSaveB6[14].ToString();

            }
            if (RScore == 15)
            {
                i_RScoreB6[0].GetComponent<Image>().sprite = s_RScore[11];
                i_RScoreB6[1].GetComponent<Image>().sprite = s_RScore[12];
                i_RScoreB6[2].GetComponent<Image>().sprite = s_RScore[13];
                i_RScoreB6[3].GetComponent<Image>().sprite = s_RScore[14];
                i_RScoreB6[4].GetComponent<Image>().sprite = s_RScore[15];

                t_TB6RScoreText[0].text = ScoreSaveB6[11].ToString();
                t_TB6RScoreText[1].text = ScoreSaveB6[12].ToString();
                t_TB6RScoreText[2].text = ScoreSaveB6[13].ToString();
                t_TB6RScoreText[3].text = ScoreSaveB6[14].ToString();
                t_TB6RScoreText[4].text = ScoreSaveB6[15].ToString();
            }

            if (RScore == 16)
            {
                i_RScoreB6[0].GetComponent<Image>().sprite = s_RScore[12];
                i_RScoreB6[1].GetComponent<Image>().sprite = s_RScore[13];
                i_RScoreB6[2].GetComponent<Image>().sprite = s_RScore[14];
                i_RScoreB6[3].GetComponent<Image>().sprite = s_RScore[15];
                i_RScoreB6[4].GetComponent<Image>().sprite = s_RScore[16];

                t_TB6RScoreText[0].text = ScoreSaveB6[12].ToString();
                t_TB6RScoreText[1].text = ScoreSaveB6[13].ToString();
                t_TB6RScoreText[2].text = ScoreSaveB6[14].ToString();
                t_TB6RScoreText[3].text = ScoreSaveB6[15].ToString();
                t_TB6RScoreText[4].text = ScoreSaveB6[16].ToString();
            }

            if (RScore == 17)
            {
                i_RScoreB6[0].GetComponent<Image>().sprite = s_RScore[13];
                i_RScoreB6[1].GetComponent<Image>().sprite = s_RScore[14];
                i_RScoreB6[2].GetComponent<Image>().sprite = s_RScore[15];
                i_RScoreB6[3].GetComponent<Image>().sprite = s_RScore[16];
                i_RScoreB6[4].GetComponent<Image>().sprite = s_RScore[17];

                t_TB6RScoreText[0].text = ScoreSaveB6[13].ToString();
                t_TB6RScoreText[1].text = ScoreSaveB6[14].ToString();
                t_TB6RScoreText[2].text = ScoreSaveB6[15].ToString();
                t_TB6RScoreText[3].text = ScoreSaveB6[16].ToString();
                t_TB6RScoreText[4].text = ScoreSaveB6[17].ToString();
            }

            if (RScore == 18)
            {
                i_RScoreB6[0].GetComponent<Image>().sprite = s_RScore[14];
                i_RScoreB6[1].GetComponent<Image>().sprite = s_RScore[15];
                i_RScoreB6[2].GetComponent<Image>().sprite = s_RScore[16];
                i_RScoreB6[3].GetComponent<Image>().sprite = s_RScore[17];
                i_RScoreB6[4].GetComponent<Image>().sprite = s_RScore[18];

                t_TB6RScoreText[0].text = ScoreSaveB6[14].ToString();
                t_TB6RScoreText[1].text = ScoreSaveB6[15].ToString();
                t_TB6RScoreText[2].text = ScoreSaveB6[16].ToString();
                t_TB6RScoreText[3].text = ScoreSaveB6[17].ToString();
                t_TB6RScoreText[4].text = ScoreSaveB6[18].ToString();
            }

            if (RScore == 19)
            {
                i_RScoreB6[0].GetComponent<Image>().sprite = s_RScore[15];
                i_RScoreB6[1].GetComponent<Image>().sprite = s_RScore[16];
                i_RScoreB6[2].GetComponent<Image>().sprite = s_RScore[17];
                i_RScoreB6[3].GetComponent<Image>().sprite = s_RScore[18];
                i_RScoreB6[4].GetComponent<Image>().sprite = s_RScore[19];

                t_TB6RScoreText[0].text = ScoreSaveB6[15].ToString();
                t_TB6RScoreText[1].text = ScoreSaveB6[16].ToString();
                t_TB6RScoreText[2].text = ScoreSaveB6[17].ToString();
                t_TB6RScoreText[3].text = ScoreSaveB6[18].ToString();
                t_TB6RScoreText[4].text = ScoreSaveB6[19].ToString();
            }

            if (RScore == 20)
            {
                i_RScoreB6[0].GetComponent<Image>().sprite = s_RScore[16];
                i_RScoreB6[1].GetComponent<Image>().sprite = s_RScore[17];
                i_RScoreB6[2].GetComponent<Image>().sprite = s_RScore[18];
                i_RScoreB6[3].GetComponent<Image>().sprite = s_RScore[19];
                i_RScoreB6[4].GetComponent<Image>().sprite = s_RScore[20];

                t_TB6RScoreText[0].text = ScoreSaveB6[16].ToString();
                t_TB6RScoreText[1].text = ScoreSaveB6[17].ToString();
                t_TB6RScoreText[2].text = ScoreSaveB6[18].ToString();
                t_TB6RScoreText[3].text = ScoreSaveB6[19].ToString();
                t_TB6RScoreText[4].text = ScoreSaveB6[20].ToString();
            }
    ...
    void RoundScore(int DartScore)
    {
        ...
        if (isAT && !isBT && Players == 4)
        {
            ScoreSaveA5[RScore] += DartScore;
            if (Round <= RoundStop)
            {
                if (RScore == 0)
                    t_TA5RScoreText[0].text = ScoreSaveA5[0].ToString();

                if (RScore == 1)
                    t_TA5RScoreText[1].text = ScoreSaveA5[1].ToString();

                if (RScore == 2)
                    t_TA5RScoreText[2].text = ScoreSaveA5[2].ToString();

                if (RScore == 3)
                    t_TA5RScoreText[3].text = ScoreSaveA5[3].ToString();

                if (RScore == 4)
                    t_TA5RScoreText[4].text = ScoreSaveA5[4].ToString();
        ...
        if (isAT && !isBT && Players == 5)
        {
            ScoreSaveA6[RScore] += DartScore;
            if (Round <= RoundStop)
            {
                if (RScore == 0)
                    t_TA6RScoreText[0].text = ScoreSaveA6[0].ToString();

                if (RScore == 1)
                    t_TA6RScoreText[1].text = ScoreSaveA6[1].ToString();

                if (RScore == 2)
                    t_TA6RScoreText[2].text = ScoreSaveA6[2].ToString();

                if (RScore == 3)
                    t_TA6RScoreText[3].text = ScoreSaveA6[3].ToString();

                if (RScore == 4)
                    t_TA6RScoreText[4].text = ScoreSaveA6[4].ToString();
        ...
        if (isBT && !isAT && Players == 4)
        {
            ScoreSaveB5[RScore] += DartScore;
            if (Round <= RoundStop)
            {
                if (RScore == 0)
                    t_TB5RScoreText[0].text = ScoreSaveB5[0].ToString();

                if (RScore == 1)
                    t_TB5RScoreText[1].text = ScoreSaveB5[1].ToString();

                if (RScore == 2)
                    t_TB5RScoreText[2].text = ScoreSaveB5[2].ToString();

                if (RScore == 3)
                    t_TB5RScoreText[3].text = ScoreSaveB5[3].ToString();

                if (RScore == 4)
                    t_TB5RScoreText[4].text = ScoreSaveB5[4].ToString();
        ...
        if (isBT && !isAT && Players == 5)
        {
            ScoreSaveB6[RScore] += DartScore;
            if (Round <= RoundStop)
            {
                if (RScore == 0)
                    t_TB6RScoreText[0].text = ScoreSaveB6[0].ToString();

                if (RScore == 1)
                    t_TB6RScoreText[1].text = ScoreSaveB6[1].ToString();

                if (RScore == 2)
                    t_TB6RScoreText[2].text = ScoreSaveB6[2].ToString();

                if (RScore == 3)
                    t_TB6RScoreText[3].text = ScoreSaveB6[3].ToString();

                if (RScore == 4)
                    t_TB6RScoreText[4].text = ScoreSaveB6[4].ToString();
    ...
    void Myturn() //각 플레이어의 차레일떄 이미지변화를 주는 함수
    {
        ...
        if (isAT && !isBT && Players == 4)
        {
            ...
            g_i_Player[0].GetComponent<Image>().sprite = s_TeamOn[4];
            g_i_Player[1].GetComponent<Image>().sprite = s_TeamOff[4];
        ...
        if (isBT && !isAT && Players == 4)
        {
            ...
            g_i_Player[1].GetComponent<Image>().sprite = s_TeamOn[4];
            g_i_Player[0].GetComponent<Image>().sprite = s_TeamOff[4];
    ...
    void PPDScore(int Dart) //각 플레이어의 총합점수와 평균점수값을 나눔
    {
        ...
        {
            TotalA5 += Dart;
            AverageA5 = TotalA5 / DartCountA5;
            t_PPDText[4].text = string.Format("{0:N2}", AverageA5);
        }
        else if (Teams == 0 && Players == 5)
        {
            TotalA6 += Dart;
            AverageA6 = TotalA6 / DartCountA6;
            t_PPDText[5].text = string.Format("{0:N2}", AverageA6);
        }
        else if (Teams == 1 && Players == 0)
        {
            TotalB1 += Dart;
            AverageB1 = TotalB1 / DartCountB1;
            t_PPDText[6].text = string.Format("{0:N2}", AverageB1);
        }
        else if (Teams == 1 && Players == 1)
        {
            TotalB2 += Dart;
            AverageB2 = TotalB2 / DartCountB2;
            t_PPDText[7].text = string.Format("{0:N2}", AverageB2);
        }
        else if (Teams == 1 && Players == 2)
        {
            TotalB3 += Dart;
            AverageB3 = TotalB3 / DartCountB3;
            t_PPDText[8].text = string.Format("{0:N2}", AverageB3);
        }
        else if (Teams == 1 && Players == 3)
        {
            TotalB4 += Dart;
            AverageB4 = TotalB4 / DartCountB4;
            t_PPDText[9].text = string.Format("{0:N2}", AverageB4);
        }
        else if (Teams == 1 && Players == 4)
        {
            TotalB5 += Dart;
            AverageB5 = TotalB5 / DartCountB5;
            t_PPDText[10].text = string.Format("{0:N2}", AverageB5);
        }
        else if (Teams == 1 && Players == 5)
        {
            TotalB6 += Dart;
            AverageB6 = TotalB6 / DartCountB6;
            t_PPDText[11].text = string.Format("{0:N2}", AverageB6);
        }

        if (Teams == 0)
            AverageAT = AverageA1 + AverageA2 + AverageA3 + AverageA4 + AverageA5 + AverageA6 / 6;
        else if (Teams == 1)
            AverageBT = AverageB1 + AverageB2 + AverageB3 + AverageB4 + AverageB5 + AverageB6 / 6;
    }
