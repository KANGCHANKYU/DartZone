...
public class PT_01Dou22 : MonoBehaviour
{
    public Text t_RoundText; //라운드 텍스트
    public Text[] t_PPDText = new Text[4]; //각각 ppd 
    ...
    public Sprite[] s_TeamOn = new Sprite[2]; //자기팀의 차레일떄 on
    public Sprite[] s_TeamOff = new Sprite[2]; //자기팀의 차레가아닐떄 off 할 이미지
    ...
    public GameObject[] g_RoundScore = new GameObject[4]; //각 플레이어의 라운드 스코어를 가지고있는 부모
    public GameObject[] g_PPDScore = new GameObject[4]; //각 플레이어의 PPD 스코어를 가지고있는 부모
    ...
    public string[] PlayerName = new string[4]; //각 플레이어의 이름을 저장해줄변수
