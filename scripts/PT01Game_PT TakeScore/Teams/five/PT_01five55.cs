...
public class PT_01five55 : MonoBehaviour
{
    public Text t_RoundText; //라운드 텍스트
    public Text[] t_PPDText = new Text[10]; //각각 ppd 
    ...
    public Sprite[] s_TeamOn = new Sprite[5]; //자기팀의 자기차레의일떄 차레 숫자on
    public Sprite[] s_TeamOff = new Sprite[5]; //자기팀의 차레가아닐떄 off 할 숫자 이미지
    ...
    public GameObject[] g_RoundScore = new GameObject[10]; //각 플레이어의 라운드 스코어를 가지고있는 부모
    public GameObject[] g_PPDScore = new GameObject[10]; //각 플레이어의 PPD 스코어를 가지고있는 부모
    ...
    public int TotalA5 = 0; //A팀의 4플레이어의 총합점수
    ...
    public string[] PlayerName = new string[10]; //각 플레이어의 이름을 저장해줄변수
    ...
    void Update()
    {
        ...
        else if (Input.GetKeyDown(KeyCode.Space) && isBust && csgmg.isAni == false)
        {
    ...
    void PPDScore(int Dart) //각 플레이어의 총합점수와 평균점수값을 나눔
    {
        ...
        else if (Teams == 1 && Players == 0)
        {
            ...
            t_PPDText[5].text = string.Format("{0:N2}", AverageB1);
        }
        else if (Teams == 1 && Players == 1)
        {
            TotalB2 += Dart;
            AverageB2 = TotalB2 / DartCountB2;
            t_PPDText[6].text = string.Format("{0:N2}", AverageB2);
        }
        else if (Teams == 1 && Players == 2)
        {
            TotalB3 += Dart;
            AverageB3 = TotalB3 / DartCountB3;
            t_PPDText[7].text = string.Format("{0:N2}", AverageB3);
        }
        else if (Teams == 1 && Players == 3)
        {
            TotalB4 += Dart;
            AverageB4 = TotalB4 / DartCountB4;
            t_PPDText[8].text = string.Format("{0:N2}", AverageB4);
        }
        else if (Teams == 1 && Players == 4)
        {
            TotalB5 += Dart;
            AverageB5 = TotalB5 / DartCountB5;
            t_PPDText[9].text = string.Format("{0:N2}", AverageB5);
        }

        if (Teams == 0)
            AverageAT = AverageA1 + AverageA2 + AverageA3 + AverageA4 + AverageA5 / 5;
        else if (Teams == 1)
            AverageBT = AverageB1 + AverageB2 + AverageB3 + AverageB4 + AverageB5 / 5;
    }
