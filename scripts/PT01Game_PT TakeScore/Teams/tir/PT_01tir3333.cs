...
public class PT_01tir3333 : MonoBehaviour
{
    ...
    public Text[] t_TD3RScoreText = new Text[5]; //D팀의 3플레이어의 라운드 스코어
    ...
    public Image[] i_RScoreD3 = new Image[5]; //D팀의 3플레이어의 라운드 스코어의 이미지
    ...
    public GameObject g_TeamD; //D의 부모
    ...
    public int DartCountD3 = 0; //D팀의 3플레이어가 게임이 끝날떄까지 다트를 던진 횟수를 저장할 변수
    ...
    public int TotalD3 = 0; //D팀의 2플레이어의 총합점수
    ...
    public int[] ScoreSaveD1 = new int[20]; //D팀의 1플레이어의 각라운드 스코어를 저장해줄 변수
    public int[] ScoreSaveD2 = new int[20]; //D팀의 2플레이어의 각라운드 스코어를 저장해줄 변수
    public int[] ScoreSaveD3 = new int[20]; //D팀의 3플레이어의 각라운드 스코어를 저장해줄 변수
    ...
    public float AverageD1 = 0; //C팀의 1플레이어의 평균값
    public float AverageD2 = 0; //C팀의 2플레이어의 평균값
    public float AverageD3 = 0; //C팀의 3플레이어의 평균값
    public float AvarageAT = 0;
    ...
    public bool isDT = false; //D팀 차레라고 말해줄 변수
    ...
    void Update()
    {
        ...
        if (csSingleton.getInstance.g_bTarget && !isRead && !isSpace && !isWin && !isBust)
        {
            ...
            {
                if (Players == 0 && isAT && !isBT && !isCT && !isDT && !isBust && !isRead)
                {
                ...
                else if (Players == 2 && isAT && !isBT && !isCT && !isDT && !isBust && !isRead)
                {
                    if (Counting == 0 && isAT && !isBT && !isCT && !isDT && !isRead && !isBust)
                    {
                        DartCountA3++;
                ...
                else if (Players == 2 && isBT && !isCT && !isDT && !isAT && !isBust && !isRead)
                {
                    if (Counting == 0 && isBT && !isCT && !isDT && !isAT && !isBust && !isRead)
                    {
                        DartCountB3++;
                ...
                /*=================================BBB=======================================*/
                else if (Players == 0 && isCT && !isDT && !isAT && !isBT && !isRead && !isBust)
                {
                ...
                else if (Players == 1 && isCT && !isDT && !isAT && !isBT && !isRead && !isBust)
                {
                    if (Counting == 0 && isCT && !isDT && !isAT && !isBT && !isBust && !isRead)
                    {
                        DartCountC2++;
                ...
                else if (Players == 2 && isCT && !isDT && !isAT && !isBT && !isRead && !isBust)
                {
                    if (Counting == 0 && isCT && !isDT && !isAT && !isBT && !isBust && !isRead)
                    {
                        DartCountC3++;
                ...
                /*=================================CCC======================================*/
                else if (Players == 0 && isDT && !isAT && !isBT && !isCT && !isRead && !isBust)
                {
                    ...
                    else if (Counting == 2 && isDT && !isCT && !isBT && !isCT && !isBust && !isRead)
                    {
                        DartCountD1++;
                        a_source.PlayOneShot(ac_shoot1, 1.0f);
                        DartScore[2] = csSingleton.getInstance.g_nTargetScore;
                ...
                else if (Players == 1 && isDT && !isAT && !isBT && !isCT && !isRead && !isBust)
                {
                    if (Counting == 0 && isDT && !isAT && !isBT && !isCT && !isBust && !isRead)
                    {
                        DartCountD2++;
                ...
                else if (Players == 2 && isDT && !isAT && !isBT && !isCT && !isRead && !isBust)
                {
                    if (Counting == 0 && isDT && !isAT && !isBT && !isCT && !isBust && !isRead)
                    {
                        DartCountD3++;
        ...
        if (Round == RoundStop && Counting == 3 && isDT && !isWin)
            GameEndRead();
    }
    ...
    void GameEndRead()
    {
        ...
        {
            if (AverageBT < AvarageAT && AverageCT < AvarageAT && AverageDT < AvarageAT)
            {
                win = 0;
                isWin = true;
                isAT = true;
            ...
            if (AvarageAT < AverageBT && AverageCT < AverageBT && AverageDT < AverageBT)
            {
                win = 1;
                isWin = true;
                isAT = false;
            ...
            if (AvarageAT < AverageCT && AverageBT < AverageCT && AverageDT < AverageCT)
            {
                win = 2;
                isWin = true;
                isAT = false;
            ...
            if (AvarageAT < AverageDT && AverageBT < AverageDT && AverageCT < AverageDT)
            {
                win = 3;
                isWin = true;
                isAT = false;
            ...
            if (AvarageAT == AverageBT && AvarageAT == AverageCT && AvarageAT == AverageDT)
            {
                win = 0;
                isWin = true;
                isAT = true;
            ...
            if (AverageBT == AverageCT && AverageBT == AverageDT &&
                 AvarageAT != AverageBT && AvarageAT != AverageCT &&
                 AvarageAT != AverageDT)
            {
                win = 1;
                isWin = true;
        ...
        {
            if (AverageBT < AvarageAT && AverageCT < AvarageAT)
            {
                win = 0;
                isWin = true;
                isAT = true;
            ...
            if (AvarageAT < AverageBT && AverageCT < AverageBT)
            {
                win = 1;
                isWin = true;
                isAT = false;
            ...
            if (AvarageAT < AverageCT && AverageBT < AverageCT)
            {
                win = 2;
                isWin = true;
                isAT = false;
            ...
            if (AvarageAT == AverageBT && AvarageAT == AverageCT && AverageBT != AverageCT)
            {
                win = 0;
                isWin = true;
                isAT = true;
            ...
            if (AverageBT == AverageDT && AvarageAT != AverageBT && AvarageAT != AverageCT)
            {
                win = 1;
                isWin = true;
                isAT = false;
            ...
            if (AvarageAT == AverageDT && AvarageAT != AverageBT && AverageDT != AverageBT)
            {
                win = 0;
                isWin = true;
                isAT = true;
            ...
            if (AvarageAT == AverageBT && AvarageAT == AverageCT)
            {
                win = 0;
                isWin = true;
                isAT = true;
        ...
        {
            if (AverageBT < AvarageAT && AverageDT < AvarageAT)
            {
                win = 0;
                isWin = false;
                isAT = true;
            ...
            if (AvarageAT < AverageBT && AverageDT < AverageBT)
            {
                win = 1;
                isWin = false;
                isAT = false;
            ...
            if (AvarageAT < AverageDT && AverageBT < AverageDT)
            {
                win = 3;
                isWin = true;
                isAT = false;
            ...
            if (AvarageAT == AverageBT && AvarageAT == AverageDT && AverageBT != AverageDT)
            {
                win = 0;
                isWin = true;
                isAT = true;
            ...
            if (AverageBT == AverageDT && AvarageAT != AverageBT && AvarageAT != AverageDT)
            {
                win = 1;
                isWin = true;
                isAT = false;
            ...
            if (AvarageAT == AverageBT && AvarageAT == AverageDT)
            {
                win = 0;
                isWin = true;
                isAT = true;
            ...
            TeamScore[1] != TeamScore[2] && TeamScore[3] != TeamScore[2])
        {
            ...
            if (AvarageAT < AverageDT && AverageCT < AverageDT)
            {
                win = 3;
                isWin = true;
                isAT = false;
            ...
            if (AverageBT == AverageDT && AverageBT != AvarageAT && AverageDT != AvarageAT)
            {
                win = 1;
                isWin = true;
                isAT = false;
            ...
            if (AvarageAT == AverageDT && AverageBT != AvarageAT && AverageBT != AverageDT)
            {
                win = 0;
                isWin = true;
                isAT = true;
    ...
    void ImageUP()
    {
        ...
        if (isCT && !isDT && !isCT && !isBT && Players == 0)
        {
            if (RScore == 5)
            {
        ...
        if (isCT && !isDT && !isCT && !isBT && Players == 1)
        {
            if (RScore == 5)
            {
        ...
        if (isCT && !isDT && !isCT && !isBT && Players == 2)
        {
            if (RScore == 5)
            {
        ...
        if (isDT && !isAT && !isBT && !isCT && Players == 2)
        {
            if (RScore == 5)
            {
                ...
                t_TD3RScoreText[0].text = ScoreSaveD3[1].ToString();
                t_TD3RScoreText[1].text = ScoreSaveD3[2].ToString();
                t_TD3RScoreText[2].text = ScoreSaveD3[3].ToString();
                t_TD3RScoreText[3].text = ScoreSaveD3[4].ToString();
                t_TD3RScoreText[4].text = ScoreSaveD3[5].ToString();
            }
            ...
            if (RScore == 6)
            {
                ...
                t_TD3RScoreText[0].text = ScoreSaveD3[2].ToString();
                t_TD3RScoreText[1].text = ScoreSaveD3[3].ToString();
                t_TD3RScoreText[2].text = ScoreSaveD3[4].ToString();
                t_TD3RScoreText[3].text = ScoreSaveD3[5].ToString();
                t_TD3RScoreText[4].text = ScoreSaveD3[6].ToString();
            }
            ...
            if (RScore == 7)
            {
                ...
                t_TD3RScoreText[0].text = ScoreSaveD3[3].ToString();
                t_TD3RScoreText[1].text = ScoreSaveD3[4].ToString();
                t_TD3RScoreText[2].text = ScoreSaveD3[5].ToString();
                t_TD3RScoreText[3].text = ScoreSaveD3[6].ToString();
                t_TD3RScoreText[4].text = ScoreSaveD3[7].ToString();
            }
            ...
            if (RScore == 8)
            {
                ...
                t_TD3RScoreText[0].text = ScoreSaveD3[4].ToString();
                t_TD3RScoreText[1].text = ScoreSaveD3[5].ToString();
                t_TD3RScoreText[2].text = ScoreSaveD3[6].ToString();
                t_TD3RScoreText[3].text = ScoreSaveD3[7].ToString();
                t_TD3RScoreText[4].text = ScoreSaveD3[8].ToString();
            }
            ...
            if (RScore == 9)
            {
                ...
                t_TD3RScoreText[0].text = ScoreSaveD3[5].ToString();
                t_TD3RScoreText[1].text = ScoreSaveD3[6].ToString();
                t_TD3RScoreText[2].text = ScoreSaveD3[7].ToString();
                t_TD3RScoreText[3].text = ScoreSaveD3[8].ToString();
                t_TD3RScoreText[4].text = ScoreSaveD3[9].ToString();
            }
            ...
            if (RScore == 10)
            {
                ...
                t_TD3RScoreText[0].text = ScoreSaveD3[6].ToString();
                t_TD3RScoreText[1].text = ScoreSaveD3[7].ToString();
                t_TD3RScoreText[2].text = ScoreSaveD3[8].ToString();
                t_TD3RScoreText[3].text = ScoreSaveD3[9].ToString();
                t_TD3RScoreText[4].text = ScoreSaveD3[10].ToString();
            }
            ...
            if (RScore == 11)
            {
                ...
                t_TD3RScoreText[0].text = ScoreSaveD3[7].ToString();
                t_TD3RScoreText[1].text = ScoreSaveD3[8].ToString();
                t_TD3RScoreText[2].text = ScoreSaveD3[9].ToString();
                t_TD3RScoreText[3].text = ScoreSaveD3[10].ToString();
                t_TD3RScoreText[4].text = ScoreSaveD3[11].ToString();
            }
            ...
            if (RScore == 12)
            {
                ...
                t_TD3RScoreText[0].text = ScoreSaveD3[8].ToString();
                t_TD3RScoreText[1].text = ScoreSaveD3[9].ToString();
                t_TD3RScoreText[2].text = ScoreSaveD3[10].ToString();
                t_TD3RScoreText[3].text = ScoreSaveD3[11].ToString();
                t_TD3RScoreText[4].text = ScoreSaveD3[12].ToString();
            }
            ...
            if (RScore == 13)
            {
                ...
                t_TD3RScoreText[0].text = ScoreSaveD3[9].ToString();
                t_TD3RScoreText[1].text = ScoreSaveD3[10].ToString();
                t_TD3RScoreText[2].text = ScoreSaveD3[11].ToString();
                t_TD3RScoreText[3].text = ScoreSaveD3[12].ToString();
                t_TD3RScoreText[4].text = ScoreSaveD3[13].ToString();
            }
            ...
            if (RScore == 14)
            {
                ...
                t_TD3RScoreText[0].text = ScoreSaveD3[10].ToString();
                t_TD3RScoreText[1].text = ScoreSaveD3[11].ToString();
                t_TD3RScoreText[2].text = ScoreSaveD3[12].ToString();
                t_TD3RScoreText[3].text = ScoreSaveD3[13].ToString();
                t_TD3RScoreText[4].text = ScoreSaveD3[14].ToString();
            }

            if (RScore == 15)
            {
                i_RScoreD3[0].GetComponent<Image>().sprite = s_RScore[11];
                i_RScoreD3[1].GetComponent<Image>().sprite = s_RScore[12];
                i_RScoreD3[2].GetComponent<Image>().sprite = s_RScore[13];
                i_RScoreD3[3].GetComponent<Image>().sprite = s_RScore[14];
                i_RScoreD3[4].GetComponent<Image>().sprite = s_RScore[15];

                t_TD3RScoreText[0].text = ScoreSaveD3[11].ToString();
                t_TD3RScoreText[1].text = ScoreSaveD3[12].ToString();
                t_TD3RScoreText[2].text = ScoreSaveD3[13].ToString();
                t_TD3RScoreText[3].text = ScoreSaveD3[14].ToString();
                t_TD3RScoreText[4].text = ScoreSaveD3[15].ToString();
            }

            if (RScore == 16)
            {
                i_RScoreD3[0].GetComponent<Image>().sprite = s_RScore[12];
                i_RScoreD3[1].GetComponent<Image>().sprite = s_RScore[13];
                i_RScoreD3[2].GetComponent<Image>().sprite = s_RScore[14];
                i_RScoreD3[3].GetComponent<Image>().sprite = s_RScore[15];
                i_RScoreD3[4].GetComponent<Image>().sprite = s_RScore[16];

                t_TD3RScoreText[0].text = ScoreSaveD3[12].ToString();
                t_TD3RScoreText[1].text = ScoreSaveD3[13].ToString();
                t_TD3RScoreText[2].text = ScoreSaveD3[14].ToString();
                t_TD3RScoreText[3].text = ScoreSaveD3[15].ToString();
                t_TD3RScoreText[4].text = ScoreSaveD3[16].ToString();
            }

            if (RScore == 17)
            {
                i_RScoreD3[0].GetComponent<Image>().sprite = s_RScore[13];
                i_RScoreD3[1].GetComponent<Image>().sprite = s_RScore[14];
                i_RScoreD3[2].GetComponent<Image>().sprite = s_RScore[15];
                i_RScoreD3[3].GetComponent<Image>().sprite = s_RScore[16];
                i_RScoreD3[4].GetComponent<Image>().sprite = s_RScore[17];

                t_TD3RScoreText[0].text = ScoreSaveD3[13].ToString();
                t_TD3RScoreText[1].text = ScoreSaveD3[14].ToString();
                t_TD3RScoreText[2].text = ScoreSaveD3[15].ToString();
                t_TD3RScoreText[3].text = ScoreSaveD3[16].ToString();
                t_TD3RScoreText[4].text = ScoreSaveD3[17].ToString();
            }

            if (RScore == 18)
            {
                i_RScoreD3[0].GetComponent<Image>().sprite = s_RScore[14];
                i_RScoreD3[1].GetComponent<Image>().sprite = s_RScore[15];
                i_RScoreD3[2].GetComponent<Image>().sprite = s_RScore[16];
                i_RScoreD3[3].GetComponent<Image>().sprite = s_RScore[17];
                i_RScoreD3[4].GetComponent<Image>().sprite = s_RScore[18];

                t_TD3RScoreText[0].text = ScoreSaveD3[14].ToString();
                t_TD3RScoreText[1].text = ScoreSaveD3[15].ToString();
                t_TD3RScoreText[2].text = ScoreSaveD3[16].ToString();
                t_TD3RScoreText[3].text = ScoreSaveD3[17].ToString();
                t_TD3RScoreText[4].text = ScoreSaveD3[18].ToString();
            }

            if (RScore == 19)
            {
                i_RScoreD3[0].GetComponent<Image>().sprite = s_RScore[15];
                i_RScoreD3[1].GetComponent<Image>().sprite = s_RScore[16];
                i_RScoreD3[2].GetComponent<Image>().sprite = s_RScore[17];
                i_RScoreD3[3].GetComponent<Image>().sprite = s_RScore[18];
                i_RScoreD3[4].GetComponent<Image>().sprite = s_RScore[19];

                t_TD3RScoreText[0].text = ScoreSaveD3[15].ToString();
                t_TD3RScoreText[1].text = ScoreSaveD3[16].ToString();
                t_TD3RScoreText[2].text = ScoreSaveD3[17].ToString();
                t_TD3RScoreText[3].text = ScoreSaveD3[18].ToString();
                t_TD3RScoreText[4].text = ScoreSaveD3[19].ToString();
            }

            if (RScore == 20)
            {
                i_RScoreD3[0].GetComponent<Image>().sprite = s_RScore[16];
                i_RScoreD3[1].GetComponent<Image>().sprite = s_RScore[17];
                i_RScoreD3[2].GetComponent<Image>().sprite = s_RScore[18];
                i_RScoreD3[3].GetComponent<Image>().sprite = s_RScore[19];
                i_RScoreD3[4].GetComponent<Image>().sprite = s_RScore[20];

                t_TD3RScoreText[0].text = ScoreSaveD3[16].ToString();
                t_TD3RScoreText[1].text = ScoreSaveD3[17].ToString();
                t_TD3RScoreText[2].text = ScoreSaveD3[18].ToString();
                t_TD3RScoreText[3].text = ScoreSaveD3[19].ToString();
                t_TD3RScoreText[4].text = ScoreSaveD3[20].ToString();
            }
    ...
    void RoundScore(int DartScore)
    {
        ...
        if (isDT && !isAT && !isBT && !isCT && Players == 2)
        {
            ScoreSaveD3[RScore] += DartScore;
            if (Round <= RoundStop)
            {
                if (RScore == 0)
                    t_TD3RScoreText[0].text = ScoreSaveD3[0].ToString();

                if (RScore == 1)
                    t_TD3RScoreText[1].text = ScoreSaveD3[1].ToString();

                if (RScore == 2)
                    t_TD3RScoreText[2].text = ScoreSaveD3[2].ToString();

                if (RScore == 3)
                    t_TD3RScoreText[3].text = ScoreSaveD3[3].ToString();

                if (RScore == 4)
                    t_TD3RScoreText[4].text = ScoreSaveD3[4].ToString();
    ...
    void Myturn() //각 플레이어의 차레일떄 이미지변화를 주는 함수
    {
        ...
        if (isAT && !isBT && !isCT && !isDT && Players == 2)
        {
            ...
            g_i_Player[3].GetComponent<Image>().sprite = s_TeamOff[2];
        ...
        if (isDT && !isAT && !isBT && !isCT && Players == 2)
        {
            ...
            g_i_Player[3].GetComponent<Image>().sprite = s_TeamOn[2];
            g_i_Player[0].GetComponent<Image>().sprite = s_TeamOff[2];
            g_i_Player[1].GetComponent<Image>().sprite = s_TeamOff[2];
            g_i_Player[2].GetComponent<Image>().sprite = s_TeamOff[2];
    ...
    void PlayerNumberMinus()//2플레이어에서 1플레이어로 넘겨주는 역활
    {
        ...
        Counting = 0;
        g_M_Score[Teams].SetActive(false);
        g_OffScore[Teams].SetActive(true);
        Players = 0;
        g_M_Score[Teams].SetActive(true);
        g_M_Score[Teams].GetComponent<csNumber>().SetNumber(TeamScore[Teams]);
    }
    ...
    void PPDScore(int Dart) //각 플레이어의 총합점수와 평균점수값을 나눔
    {
        ...
        else if (Teams == 2 && Players == 0)
        {
            ...
            t_PPDText[6].text = string.Format("{0:N2}", AverageC1);
        }
        else if (Teams == 2 && Players == 1)
        {
            TotalC2 += Dart;
            AverageC2 = TotalC2 / DartCountC2;
            t_PPDText[7].text = string.Format("{0:N2}", AverageC2);
        }
        else if (Teams == 2 && Players == 2)
        {
            TotalC3 += Dart;
            AverageC3 = TotalC3 / DartCountC3;
            t_PPDText[8].text = string.Format("{0:N2}", AverageC3);
        }
        else if (Teams == 3 && Players == 0)
        {
            TotalD1 += Dart;
            AverageD1 = TotalD1 / DartCountD1;
            t_PPDText[9].text = string.Format("{0:N2}", AverageD1);
        }
        else if (Teams == 3 && Players == 1)
        {
            TotalD2 += Dart;
            AverageD2 = TotalD2 / DartCountD2;
            t_PPDText[10].text = string.Format("{0:N2}", AverageD2);
        }
        else if (Teams == 3 && Players == 2)
        {
            TotalD3 += Dart;
            AverageD3 = TotalD3 / DartCountD3;
            t_PPDText[11].text = string.Format("{0:N2}", AverageD3);
        }

        if (Teams == 0)
            AvarageAT = AverageA1 + AverageA2 + AverageA3 / 3;
        else if (Teams == 1)
            AverageBT = AverageB1 + AverageB2 + AverageB3 / 3;
        else if (Teams == 2)
            AverageCT = AverageC1 + AverageC2 + AverageC3 / 3;
        else if (Teams == 3)
            AverageDT = AverageD1 + AverageD2 + AverageD3 / 3;
    }
}
