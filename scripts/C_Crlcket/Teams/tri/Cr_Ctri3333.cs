...
public class Cr_Ctri3333 : MonoBehaviour
{
    ...
    public GameObject[] g_DT3RMark1 = new GameObject[3];
    public GameObject[] g_DT3RMark2 = new GameObject[3];
    public GameObject[] g_DT3RMark3 = new GameObject[3];
    public GameObject[] g_DT3RMark4 = new GameObject[3];
    public GameObject[] g_DT3RMark5 = new GameObject[3];
    ...
    public Image[] i_RScoreD3 = new Image[5];
    ...
    public int[] MarkSaveD3 = new int[45];
    ...
    void MyTurn()
    {
        ...
        if (isAT && Players == 2)
        {
            ...
            g_i_Team[3].GetComponent<Image>().sprite = s_TeamOff[2];
        ...
        if (isDT && Players == 2)
        {
            ...
            g_i_Team[3].GetComponent<Image>().sprite = s_TeamOn[2];
            g_i_Team[0].GetComponent<Image>().sprite = s_TeamOff[2];
            g_i_Team[1].GetComponent<Image>().sprite = s_TeamOff[2];
            g_i_Team[2].GetComponent<Image>().sprite = s_TeamOff[2];
    ...
    void ImageUp()
    {
        ...
        if (isAT && !isBT && !isCT && !isDT && Players == 2)
        {
            if (RScore == 5)
            {
        ...
        if (isBT && !isCT && !isDT && !isAT && Players == 2)
        {
            if (RScore == 5)
            {
        ...
        if (isCT && !isDT && !isAT && !isBT && Players == 2)
        {
        ...
        if (isDT && !isAT && !isBT && !isCT && Players == 0)
        {
            if (RScore == 5)
            {
                ...
                g_DT1RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[4]];
                g_DT1RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[5]];
                g_DT1RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[6]];

                g_DT1RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[7]];
                g_DT1RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[8]];
                g_DT1RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[9]];

                g_DT1RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[10]];
                g_DT1RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[11]];
                g_DT1RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[12]];

                g_DT1RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[13]];
                g_DT1RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[14]];
                g_DT1RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[15]];

                g_DT1RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[16]];
                g_DT1RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[17]];
                g_DT1RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[18]];
            }
            ...
            if (RScore == 6)
            {
                ...
                g_DT1RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[7]];
                g_DT1RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[8]];
                g_DT1RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[9]];

                g_DT1RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[10]];
                g_DT1RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[11]];
                g_DT1RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[12]];

                g_DT1RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[13]];
                g_DT1RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[14]];
                g_DT1RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[15]];

                g_DT1RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[16]];
                g_DT1RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[17]];
                g_DT1RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[18]];

                g_DT1RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[19]];
                g_DT1RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[20]];
                g_DT1RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[21]];
            }
            ...
            if (RScore == 7)
            {
                ...
                g_DT1RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[10]];
                g_DT1RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[11]];
                g_DT1RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[12]];

                g_DT1RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[13]];
                g_DT1RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[14]];
                g_DT1RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[15]];

                g_DT1RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[16]];
                g_DT1RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[17]];
                g_DT1RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[18]];

                g_DT1RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[19]];
                g_DT1RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[20]];
                g_DT1RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[21]];

                g_DT1RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[22]];
                g_DT1RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[23]];
                g_DT1RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[24]];
            }
            ...
            if (RScore == 8)
            {
                ...
                g_DT1RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[13]];
                g_DT1RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[14]];
                g_DT1RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[15]];

                g_DT1RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[16]];
                g_DT1RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[17]];
                g_DT1RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[18]];

                g_DT1RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[19]];
                g_DT1RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[20]];
                g_DT1RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[21]];

                g_DT1RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[22]];
                g_DT1RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[23]];
                g_DT1RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[24]];

                g_DT1RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[25]];
                g_DT1RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[26]];
                g_DT1RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[27]];
            }
            ...
            if (RScore == 9)
            {
                ...
                g_DT1RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[16]];
                g_DT1RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[17]];
                g_DT1RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[18]];

                g_DT1RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[19]];
                g_DT1RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[20]];
                g_DT1RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[21]];

                g_DT1RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[22]];
                g_DT1RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[23]];
                g_DT1RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[24]];

                g_DT1RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[25]];
                g_DT1RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[26]];
                g_DT1RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[27]];

                g_DT1RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[28]];
                g_DT1RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[29]];
                g_DT1RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[30]];
            }
            ...
            if (RScore == 10)
            {
                ...
                g_DT1RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[19]];
                g_DT1RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[20]];
                g_DT1RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[21]];

                g_DT1RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[22]];
                g_DT1RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[23]];
                g_DT1RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[24]];

                g_DT1RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[25]];
                g_DT1RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[26]];
                g_DT1RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[27]];

                g_DT1RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[28]];
                g_DT1RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[29]];
                g_DT1RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[30]];

                g_DT1RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[31]];
                g_DT1RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[32]];
                g_DT1RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[33]];
            }
            ...
            if (RScore == 11)
            {
                ...
                g_DT1RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[22]];
                g_DT1RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[23]];
                g_DT1RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[24]];

                g_DT1RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[25]];
                g_DT1RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[26]];
                g_DT1RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[27]];

                g_DT1RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[28]];
                g_DT1RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[29]];
                g_DT1RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[30]];

                g_DT1RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[31]];
                g_DT1RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[32]];
                g_DT1RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[33]];

                g_DT1RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[34]];
                g_DT1RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[35]];
                g_DT1RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[36]];
            }
            ...
            if (RScore == 12)
            {
                ...
                g_DT1RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[25]];
                g_DT1RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[26]];
                g_DT1RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[27]];

                g_DT1RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[28]];
                g_DT1RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[29]];
                g_DT1RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[30]];

                g_DT1RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[31]];
                g_DT1RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[32]];
                g_DT1RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[33]];

                g_DT1RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[34]];
                g_DT1RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[35]];
                g_DT1RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[36]];

                g_DT1RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[37]];
                g_DT1RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[38]];
                g_DT1RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[39]];
            }
            ...
            if (RScore == 13)
            {
                ...
                g_DT1RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[28]];
                g_DT1RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[29]];
                g_DT1RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[30]];

                g_DT1RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[31]];
                g_DT1RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[32]];
                g_DT1RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[33]];

                g_DT1RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[34]];
                g_DT1RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[35]];
                g_DT1RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[36]];

                g_DT1RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[37]];
                g_DT1RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[38]];
                g_DT1RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[39]];
            ...
            if (RScore == 14)
            {
                ...
                g_DT1RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[31]];
                g_DT1RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[32]];
                g_DT1RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[33]];

                g_DT1RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[34]];
                g_DT1RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[35]];
                g_DT1RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[36]];

                g_DT1RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[37]];
                g_DT1RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[38]];
                g_DT1RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[39]];

                g_DT1RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[40]];
                g_DT1RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[41]];
                g_DT1RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[42]];

                g_DT1RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[43]];
                g_DT1RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[44]];
                g_DT1RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD1[45]];
            }
        }
        ...
        if (isDT && !isAT && !isBT && !isCT && Players == 1)
        {
            ...
            if (RScore == 5)
            {
                ...
                g_DT2RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[4]];
                g_DT2RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[5]];
                g_DT2RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[6]];

                g_DT2RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[7]];
                g_DT2RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[8]];
                g_DT2RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[9]];

                g_DT2RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[10]];
                g_DT2RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[11]];
                g_DT2RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[12]];

                g_DT2RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[13]];
                g_DT2RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[14]];
                g_DT2RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[15]];

                g_DT2RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[16]];
                g_DT2RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[17]];
                g_DT2RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[18]];
            }
            ...
            if (RScore == 6)
            {
                ...
                g_DT2RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[7]];
                g_DT2RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[8]];
                g_DT2RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[9]];

                g_DT2RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[10]];
                g_DT2RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[11]];
                g_DT2RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[12]];

                g_DT2RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[13]];
                g_DT2RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[14]];
                g_DT2RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[15]];

                g_DT2RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[16]];
                g_DT2RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[17]];
                g_DT2RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[18]];

                g_DT2RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[19]];
                g_DT2RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[20]];
                g_DT2RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2[21]];
            }
            ...
            if (RScore == 7)
            {
                ...
                g_DT2RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD2
];
                g_DT3RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[42]];
            }

            if (RScore == 14)
            {
                i_RScoreD3[0].GetComponent<Image>().sprite = s_RScore[10];
                i_RScoreD3[1].GetComponent<Image>().sprite = s_RScore[11];
                i_RScoreD3[2].GetComponent<Image>().sprite = s_RScore[12];
                i_RScoreD3[3].GetComponent<Image>().sprite = s_RScore[13];
                i_RScoreD3[4].GetComponent<Image>().sprite = s_RScore[14];

                g_DT3RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[31]];
                g_DT3RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[32]];
                g_DT3RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[33]];

                g_DT3RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[34]];
                g_DT3RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[35]];
                g_DT3RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[36]];

                g_DT3RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[37]];
                g_DT3RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[38]];
                g_DT3RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[39]];

                g_DT3RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[40]];
                g_DT3RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[41]];
                g_DT3RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[42]];

                g_DT3RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[43]];
                g_DT3RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[44]];
                g_DT3RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[45]];
            }
        }
    }
    ...
    void RoundScore(int MarkScore)
    {
        ...
        if (isCT && !isDT && !isAT && !isBT && Players == 0)
        {
            ...
            if (Round <= RoundStop)
            {
                ...
                if (RScore == 8)
                {
                    g_CT1RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveC1[13]];
                    g_CT1RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveC1[14]];
                    g_CT1RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveC1[15]];

                    g_CT1RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveC1[16]];
                    g_CT1RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveC1[17]];
                    g_CT1RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveC1[18]];

                    g_CT1RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveC1[19]];
                    g_CT1RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveC1[20]];
                    g_CT1RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveC1[21]];

                    g_CT1RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveC1[22]];
                    g_CT1RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveC1[23]];
                    g_CT1RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveC1[24]];

                    g_CT1RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveC1[25]];
                    g_CT1RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveC1[26]];
                    g_CT1RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveC1[27]];
        ...
        if (isCT && !isDT && !isAT && !isBT && Players == 2)
        {
            ...
            if (Round <= RoundStop)
            {
                ...
                if (RScore == 10)
                {
                    g_CT3RMark1[0].GetComponent<Image>().sprite = s_CTMark[MarkSaveC3[19]];
                    g_CT3RMark1[1].GetComponent<Image>().sprite = s_CTMark[MarkSaveC3[20]];
                    g_CT3RMark1[2].GetComponent<Image>().sprite = s_CTMark[MarkSaveC3[20]];
        ...
        if (isDT && !isAT && !isBT && !isCT && Players == 2)
        {
            MarkSaveD3[DT3MarkCounting] = MarkScore;  //0이면 1마크 1이면 2마크 2이면 3마크
            if (Round <= RoundStop)
            {
                if (RScore == 0)
                    g_DT3RMark1[Counting].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[DT3MarkCounting]];

                if (RScore == 1)
                    g_DT3RMark2[Counting].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[DT3MarkCounting]];

                if (RScore == 2)
                    g_DT3RMark3[Counting].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[DT3MarkCounting]];

                if (RScore == 3)
                    g_DT3RMark4[Counting].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[DT3MarkCounting]];

                if (RScore == 4)
                    g_DT3RMark5[Counting].GetComponent<Image>().sprite = s_DTMark[MarkSaveD3[DT3MarkCounting]];
    ...
    void LineScore()
    {
        if (Counting != 3 && gmg.isAni == false)
        {
            ...
            else if (DT_20Mark <= 0 && !isDT_20Mark)
            {
                ...
                {
                    DT_20Mark *= -1;
                    TeamScore[0] += DT_20Mark;
                    g_P_Score[0].GetComponent<csNumber>().SetNumber(TeamScore[0]);
                    g_OffScore[0].GetComponent<csNumber>().SetNumber(TeamScore[0]);
                    TeamScore[1] += DT_20Mark;
                    g_P_Score[1].GetComponent<csNumber>().SetNumber(TeamScore[1]);
                    g_OffScore[1].GetComponent<csNumber>().SetNumber(TeamScore[1]);
                    TeamScore[2] += DT_20Mark;
                    g_P_Score[2].GetComponent<csNumber>().SetNumber(TeamScore[2]);
                    g_OffScore[2].GetComponent<csNumber>().SetNumber(TeamScore[2]);
                }
                isDT_20Mark = true;
            ...
            else if (DT_19Mark <= 0 && !isDT_19Mark)
            {
                ...
                {
                    DT_19Mark *= -1;
                    TeamScore[0] += DT_19Mark;
                    g_P_Score[0].GetComponent<csNumber>().SetNumber(TeamScore[0]);
                    g_OffScore[0].GetComponent<csNumber>().SetNumber(TeamScore[0]);
                    TeamScore[1] += DT_19Mark;
                    g_P_Score[1].GetComponent<csNumber>().SetNumber(TeamScore[1]);
                    g_OffScore[1].GetComponent<csNumber>().SetNumber(TeamScore[1]);
                    TeamScore[2] += DT_19Mark;
                    g_P_Score[2].GetComponent<csNumber>().SetNumber(TeamScore[2]);
                    g_OffScore[2].GetComponent<csNumber>().SetNumber(TeamScore[2]);
                }
                isDT_19Mark = true;
            ...
            else if (DT_18Mark <= 0 && !isDT_18Mark)
            {
                ...
                {
                    DT_18Mark *= -1;
                    TeamScore[0] += DT_18Mark;
                    g_P_Score[0].GetComponent<csNumber>().SetNumber(TeamScore[0]);
                    g_OffScore[0].GetComponent<csNumber>().SetNumber(TeamScore[0]);
                    TeamScore[1] += DT_18Mark;
                    g_P_Score[1].GetComponent<csNumber>().SetNumber(TeamScore[1]);
                    g_OffScore[1].GetComponent<csNumber>().SetNumber(TeamScore[1]);
                    TeamScore[2] += DT_18Mark;
                    g_P_Score[2].GetComponent<csNumber>().SetNumber(TeamScore[2]);
                    g_OffScore[2].GetComponent<csNumber>().SetNumber(TeamScore[2]);
                }
                isDT_18Mark = true;
            ...
            else if (DT_17Mark <= 0 && !isDT_17Mark)
            {
                ...
                {
                    DT_17Mark *= -1;
                    TeamScore[0] += DT_17Mark;
                    g_P_Score[0].GetComponent<csNumber>().SetNumber(TeamScore[0]);
                    g_OffScore[0].GetComponent<csNumber>().SetNumber(TeamScore[0]);
                    TeamScore[1] += DT_17Mark;
                    g_P_Score[1].GetComponent<csNumber>().SetNumber(TeamScore[1]);
                    g_OffScore[1].GetComponent<csNumber>().SetNumber(TeamScore[1]);
                    TeamScore[2] += DT_17Mark;
                    g_P_Score[2].GetComponent<csNumber>().SetNumber(TeamScore[2]);
                    g_OffScore[2].GetComponent<csNumber>().SetNumber(TeamScore[2]);
                }
                isDT_17Mark = true;
            ...
            else if (DT_16Mark <= 0 && !isDT_16Mark)
            {
                ...
                {
                    DT_16Mark *= -1;
                    TeamScore[0] += DT_16Mark;
                    g_P_Score[0].GetComponent<csNumber>().SetNumber(TeamScore[0]);
                    g_OffScore[0].GetComponent<csNumber>().SetNumber(TeamScore[0]);
                    TeamScore[1] += DT_16Mark;
                    g_P_Score[1].GetComponent<csNumber>().SetNumber(TeamScore[1]);
                    g_OffScore[1].GetComponent<csNumber>().SetNumber(TeamScore[1]);
                    TeamScore[2] += DT_16Mark;
                    g_P_Score[2].GetComponent<csNumber>().SetNumber(TeamScore[2]);
                    g_OffScore[2].GetComponent<csNumber>().SetNumber(TeamScore[2]);
                }
                isDT_16Mark = true;
            ...
            else if (DT_15Mark <= 0 && !isDT_15Mark)
            {
                ...
                {
                    DT_15Mark *= -1;
                    TeamScore[0] += DT_15Mark;
                    g_P_Score[0].GetComponent<csNumber>().SetNumber(TeamScore[0]);
                    g_OffScore[0].GetComponent<csNumber>().SetNumber(TeamScore[0]);
                    TeamScore[1] += DT_15Mark;
                    g_P_Score[1].GetComponent<csNumber>().SetNumber(TeamScore[1]);
                    g_OffScore[1].GetComponent<csNumber>().SetNumber(TeamScore[1]);
                    TeamScore[2] += DT_15Mark;
                    g_P_Score[2].GetComponent<csNumber>().SetNumber(TeamScore[2]);
                    g_OffScore[2].GetComponent<csNumber>().SetNumber(TeamScore[2]);
                }
                isDT_15Mark = true;
            ...
            else if (DT_BullMark <= 0 && !isDT_BullMark)
            {
                ...
                {
                    DT_BullMark *= -1;
                    TeamScore[0] += DT_BullMark;
                    g_P_Score[0].GetComponent<csNumber>().SetNumber(TeamScore[0]);
                    g_OffScore[0].GetComponent<csNumber>().SetNumber(TeamScore[0]);
                    TeamScore[1] += DT_BullMark;
                    g_P_Score[1].GetComponent<csNumber>().SetNumber(TeamScore[1]);
                    g_OffScore[1].GetComponent<csNumber>().SetNumber(TeamScore[1]);
                    TeamScore[2] += DT_BullMark;
                    g_P_Score[2].GetComponent<csNumber>().SetNumber(TeamScore[2]);
                    g_OffScore[2].GetComponent<csNumber>().SetNumber(TeamScore[2]);
                }
                isDT_BullMark = true;
    ...
    void MPRScore(int Dart)
    {
        ...
        if (Teams == 1 && Players == 0)
        {
            ...
            t_MPRText4.text = string.Format("{0:N2}", AverageB1);
        }
        ...
        if (Teams == 1 && Players == 1)
        {
            ...
            t_MPRText5.text = string.Format("{0:N2}", AverageB2);
        }
        ...
        if (Teams == 1 && Players == 2)
        {
            ...
            t_MPRText6.text = string.Format("{0:N2}", AverageB3);
        }
        ...
        if (Teams == 2 && Players == 0)
        {
            ...
            t_MPRText7.text = string.Format("{0:N2}", AverageC1);
        }
        ...
        if (Teams == 2 && Players == 1)
        {
            ...
            t_MPRText8.text = string.Format("{0:N2}", AverageC2);
        }
        ...
        if (Teams == 2 && Players == 2)
        {
            ...
            t_MPRText9.text = string.Format("{0:N2}", AverageC3);
        }
        ...
        if (Teams == 3 && Players == 0)
        {
            ...
            t_MPRText10.text = string.Format("{0:N2}", AverageD1);
        }
        ...
        if (Teams == 3 && Players == 1)
        {
            ...
            t_MPRText11.text = string.Format("{0:N2}", AverageD2);
        }

        if (Teams == 3 && Players == 2)
        {
            TotalD3 += Dart;
            AverageD3 = TotalD3 / RoundCountingDT3;
            t_MPRText12.text = string.Format("{0:N2}", AverageD3);
        }

        if (Teams == 0)
            AverageATotla = AverageA1 + AverageA2 + AverageA3 / 3;

        if (Teams == 1)
            AverageBTotla = AverageB1 + AverageB2 + AverageB3 / 3;

        if (Teams == 2)
            AverageCTotla = AverageC1 + AverageC2 + AverageC3 / 3;

        if (Teams == 3)
            AverageDTotla = AverageD1 + AverageD2 + AverageD3 / 3;
    }
