...
public class Cr_CTwoPlayer : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (csSingleton.getInstance.g_bTarget)
        {
            ...
            {
                if (Round <= RoundStop && gmg.isAni == false)
                {
                    ...
                    else if(is20AllMark || is19AllMark || is18AllMark || is17AllMark || is16AllMark || is15AllMark || isBullAllMark)
                    {
                        if (Players == 0)
                            P1MarkCounting++;
                        else if (Players == 1)
            ...
            {
                if(Counting!=3&&!isSpace && !isRead && !isWin)
                {
                    if (Players == 0)
                        P1MarkCounting++;
                    else if (Players == 1)
