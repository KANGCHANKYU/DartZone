...
public class Cr_CFourPlayer : MonoBehaviour
{
    ...
    [Header("P4 Mark Score")]
    public int P4_20Mark = 60;
    public int P4_19Mark = 57;
    public int P4_18Mark = 54;
    public int P4_17Mark = 51;
    public int P4_16Mark = 48;
    public int P4_15Mark = 45;
    public int P4_BullMark = 75;
        ...
        if (csSingleton.getInstance.g_bTarget)
        {
            ...
            csSingleton.getInstance.g_nTargetBasicScore == 17 || csSingleton.getInstance.g_nTargetBasicScore == 16 || csSingleton.getInstance.g_nTargetBasicScore == 15 && gmg.isAni == false)
            {
                if (Round <= RoundStop && gmg.isAni == false && !isSpace && !isRead && !isWin)
                {
                    ...
                    else if (Players == 3 && !isRead && !isSpace && !isWin && isP4_20Mark && !is20AllMark && csSingleton.getInstance.g_nTargetBasicScore == 20)
                    {
                        if (Counting == 0)
                        {
                            P4MarkCounting++;
                    ...
                    else if (Players == 3 && !isRead && !isSpace && !isWin && isP4_19Mark && !is19AllMark && csSingleton.getInstance.g_nTargetBasicScore == 19)
                    {
                        if (Counting == 0)
                        {
                            P4MarkCounting++;
                    ...
                    else if (Players == 3 && !isRead && !isSpace && !isWin && isP4_18Mark && !is18AllMark && csSingleton.getInstance.g_nTargetBasicScore == 18)
                    {
                        if (Counting == 0)
                        {
                            P4MarkCounting++;
                    ...
                    else if (Players == 3 && !isRead && !isSpace && !isWin && isP4_17Mark && !is17AllMark && csSingleton.getInstance.g_nTargetBasicScore == 17)
                    {
                        if (Counting == 0)
                        {
                            P4MarkCounting++;
                    ...
                    else if (Players == 3 && !isRead && !isSpace && !isWin && isP4_16Mark && !is16AllMark && csSingleton.getInstance.g_nTargetBasicScore == 16)
                    {
                        if (Counting == 0)
                        {
                            P4MarkCounting++;
                    ...
                    else if (Players == 3 && !isRead && !isSpace && !isWin && isP4_15Mark && !is15AllMark && csSingleton.getInstance.g_nTargetBasicScore == 15)
                    {
                        if (Counting == 0)
                        {
                            P4MarkCounting++;
                    ...
                    else if (Players == 3 && !isRead && !isSpace && !isWin && isP4_BullMark && !isBullAllMark && csSingleton.getInstance.g_nTargetBasicScore == 25)
                    {
                        if (Counting == 0)
                        {
                            P4MarkCounting++;
    ...
    void GameEndRead()
    {
        ...
        if (PlayerScore[0] == PlayerScore[1] && !isWin)
        {
        ...
        if (PlayerScore[0] == PlayerScore[2] && !isWin)
        {
        ...
        if (PlayerScore[0] == PlayerScore[3] && !isWin)
        {
        ...
        if (PlayerScore[1] == PlayerScore[2] && !isWin)
        {
        ...
        if (PlayerScore[1] == PlayerScore[3] && !isWin)
        {
        ...
        if (PlayerScore[2] == PlayerScore[3] && !isWin)
        {
    ...
    void Comparison()
    {
        if (isP1_20Mark && isP2_20Mark && isP3_20Mark && isP4_20Mark)
            is20AllMark = true;

        if (isP1_19Mark && isP2_19Mark && isP3_19Mark && isP4_19Mark)
            is19AllMark = true;

        if (isP1_18Mark && isP2_18Mark && isP3_18Mark && isP4_18Mark)
            is18AllMark = true;

        if (isP1_17Mark && isP2_17Mark && isP3_17Mark && isP4_17Mark)
            is17AllMark = true;

        if (isP1_16Mark && isP2_16Mark && isP3_16Mark && isP4_16Mark)
            is16AllMark = true;

        if (isP1_15Mark && isP2_15Mark && isP3_15Mark && isP4_15Mark)
            is15AllMark = true;

        if (isP1_BullMark && isP2_BullMark && isP3_BullMark && isP4_BullMark)
            isBullAllMark = true;
    }
    void MyTurn()
    {
        ...
        if (isP4)
        {
            ...
            g_P1.transform.localScale = new Vector3(0.65f, 0.65f);
            g_P2.transform.localScale = new Vector3(0.65f, 0.65f);
            g_P3.transform.localScale = new Vector3(0.65f, 0.65f);
            g_P4.transform.localScale = new Vector3(0.85f, 0.85f);
    ...
    void MainMark()
    {
        ...
        if (isP1_20Mark && isP2_20Mark && isP3_20Mark && isP4_20Mark)
        {
            ...
            g_P4MainMark[0].GetComponent<Image>().sprite = s_OffMark;
        }
        else if (isP1_19Mark && isP2_19Mark && isP3_19Mark && isP4_19Mark)
        {
            ...
            g_P4MainMark[1].GetComponent<Image>().sprite = s_OffMark;
        }
        else if (isP1_18Mark && isP2_18Mark && isP3_18Mark && isP4_18Mark)
        {
            ...
            g_P4MainMark[2].GetComponent<Image>().sprite = s_OffMark;
        }
        else if (isP1_17Mark && isP2_17Mark && isP3_17Mark && isP4_17Mark)
        {
            ...
            g_P4MainMark[3].GetComponent<Image>().sprite = s_OffMark;
        }
        else if (isP1_16Mark && isP2_16Mark && isP3_16Mark && isP4_16Mark)
        {
            ...
            g_P4MainMark[4].GetComponent<Image>().sprite = s_OffMark;
        }
        else if (isP1_15Mark && isP2_15Mark && isP3_15Mark && isP4_15Mark)
        {
            ...
            g_P4MainMark[5].GetComponent<Image>().sprite = s_OffMark;
        }
        else if (isP1_BullMark && isP2_BullMark && isP3_BullMark && isP4_BullMark)
        {
            ...
            g_P4MainMark[6].GetComponent<Image>().sprite = s_OffMark;
        }

        else if (isP1_20Mark && isP1_19Mark && isP1_18Mark && isP1_17Mark && isP1_16Mark && isP1_15Mark && isP1_BullMark)
            isP1AllMark = true;

        else if (isP2_20Mark && isP2_19Mark && isP2_18Mark && isP2_17Mark && isP2_16Mark && isP2_15Mark && isP2_BullMark)
            isP2AllMark = true;

        else if (isP3_20Mark && isP3_19Mark && isP3_18Mark && isP3_17Mark && isP3_16Mark && isP3_15Mark && isP3_BullMark)
            isP3AllMark = true;

        else if (isP4_20Mark && isP4_19Mark && isP4_18Mark && isP4_17Mark && isP4_16Mark && isP4_15Mark && isP4_BullMark)
            isP4AllMark = true;
    }
    void LineScore()
    {
        if (Counting != 3 && gmg.isAni == false)
        {
            ...
            /*-----------------------------------------------------------------*/
            if (Players == 3 && !isP4_20Mark && csSingleton.getInstance.g_nTargetBasicScore == 20)
            {
                if (Players == 3)
                    P4MarkCounting++;
                a_source.PlayOneShot(ac_shoot1, 1.0f);
                P4_20Mark -= csSingleton.getInstance.g_nTargetScore;
                MPRScore(csSingleton.getInstance.g_nTargetScore / csSingleton.getInstance.g_nTargetBasicScore);
                RoundScore(csSingleton.getInstance.g_nTargetScore / csSingleton.getInstance.g_nTargetBasicScore);
                g_P_Score[Players].GetComponent<csNumber>().SetNumber(PlayerScore[Players]);
                g_Dart[Counting].GetComponent<Image>().sprite = s_OnDart;
            ...
            else if (Players == 3 && !isP4_19Mark && csSingleton.getInstance.g_nTargetBasicScore == 19)
            {
                if (Players == 3)
                    P4MarkCounting++;
                a_source.PlayOneShot(ac_shoot1, 1.0f);
                P4_19Mark -= csSingleton.getInstance.g_nTargetScore;
                MPRScore(csSingleton.getInstance.g_nTargetScore / csSingleton.getInstance.g_nTargetBasicScore);
                RoundScore(csSingleton.getInstance.g_nTargetScore / csSingleton.getInstance.g_nTargetBasicScore);
                g_P_Score[Players].GetComponent<csNumber>().SetNumber(PlayerScore[Players]);
                g_Dart[Counting].GetComponent<Image>().sprite = s_OnDart;
            ...
            else if (Players == 3 && !isP4_18Mark && csSingleton.getInstance.g_nTargetBasicScore == 18)
            {
                if (Players == 3)
                    P4MarkCounting++;
                a_source.PlayOneShot(ac_shoot1, 1.0f);
                P4_18Mark -= csSingleton.getInstance.g_nTargetScore;
                MPRScore(csSingleton.getInstance.g_nTargetScore / csSingleton.getInstance.g_nTargetBasicScore);
                RoundScore(csSingleton.getInstance.g_nTargetScore / csSingleton.getInstance.g_nTargetBasicScore);
                g_P_Score[Players].GetComponent<csNumber>().SetNumber(PlayerScore[Players]);
                g_Dart[Counting].GetComponent<Image>().sprite = s_OnDart;
            ...
            else if (Players == 3 && !isP4_17Mark && csSingleton.getInstance.g_nTargetBasicScore == 17)
            {
                if (Players == 3)
                    P4MarkCounting++;
                a_source.PlayOneShot(ac_shoot1, 1.0f);
                P4_17Mark -= csSingleton.getInstance.g_nTargetScore;
                MPRScore(csSingleton.getInstance.g_nTargetScore / csSingleton.getInstance.g_nTargetBasicScore);
                RoundScore(csSingleton.getInstance.g_nTargetScore / csSingleton.getInstance.g_nTargetBasicScore);
                g_P_Score[Players].GetComponent<csNumber>().SetNumber(PlayerScore[Players]);
                g_Dart[Counting].GetComponent<Image>().sprite = s_OnDart;
            ...
            else if (Players == 3 && !isP4_16Mark && csSingleton.getInstance.g_nTargetBasicScore == 16)
            {
                if (Players == 3)
                    P4MarkCounting++;
                a_source.PlayOneShot(ac_shoot1, 1.0f);
                P4_16Mark -= csSingleton.getInstance.g_nTargetScore;
                MPRScore(csSingleton.getInstance.g_nTargetScore / csSingleton.getInstance.g_nTargetBasicScore);
                RoundScore(csSingleton.getInstance.g_nTargetScore / csSingleton.getInstance.g_nTargetBasicScore);
                g_P_Score[Players].GetComponent<csNumber>().SetNumber(PlayerScore[Players]);
                g_Dart[Counting].GetComponent<Image>().sprite = s_OnDart;
            ...
            else if (Players == 3 && !isP4_15Mark && csSingleton.getInstance.g_nTargetBasicScore == 15)
            {
                if (Players == 3)
                    P4MarkCounting++;
                a_source.PlayOneShot(ac_shoot1, 1.0f);
                P4_15Mark -= csSingleton.getInstance.g_nTargetScore;
                MPRScore(csSingleton.getInstance.g_nTargetScore / csSingleton.getInstance.g_nTargetBasicScore);
                RoundScore(csSingleton.getInstance.g_nTargetScore / csSingleton.getInstance.g_nTargetBasicScore);
                g_P_Score[Players].GetComponent<csNumber>().SetNumber(PlayerScore[Players]);
                g_Dart[Counting].GetComponent<Image>().sprite = s_OnDart;
            ...
            else if (Players == 3 && !isP4_BullMark && csSingleton.getInstance.g_nTargetBasicScore == 25)
            {
                if (Players == 3)
                    P4MarkCounting++;
                a_source.PlayOneShot(ac_shoot1, 1.0f);
                P4_BullMark -= csSingleton.getInstance.g_nTargetScore;
                MPRScore(csSingleton.getInstance.g_nTargetScore / csSingleton.getInstance.g_nTargetBasicScore);
                RoundScore(csSingleton.getInstance.g_nTargetScore / csSingleton.getInstance.g_nTargetBasicScore);
                g_P_Score[Players].GetComponent<csNumber>().SetNumber(PlayerScore[Players]);
                g_Dart[Counting].GetComponent<Image>().sprite = s_OnDart;
            ...
            {
                if (!isP2_20Mark || !isP3_20Mark || !isP4_20Mark)
                {
                    P1_20Mark *= -1;
            ...
            {
                if (!isP2_19Mark || !isP3_19Mark || !isP4_19Mark)
                {
                    P1_19Mark *= -1;
            ...
            {
                if (!isP2_18Mark || !isP3_18Mark || !isP4_18Mark)
                {
                    P1_18Mark *= -1;
            ...
            {
                if (!isP2_17Mark || !isP3_17Mark || !isP4_17Mark)
                {
                    P1_17Mark *= -1;
            ...
            {
                if (!isP2_16Mark || !isP3_16Mark || !isP4_16Mark)
                {
                    P1_16Mark *= -1;
            ...
            {
                if (!isP2_15Mark || !isP3_15Mark || !isP4_15Mark)
                {
                    P1_15Mark *= -1;
            ...
            {
                if (!isP2_BullMark || !isP3_BullMark || !isP4_BullMark)
                {
                    P1_BullMark *= -1;
            ...
            {
                if (!isP1_20Mark || !isP3_20Mark || !isP4_20Mark)
                {
                    P2_20Mark *= -1;
            ...
            {
                if (!isP1_19Mark || !isP3_19Mark || !isP4_19Mark)
                {
                    P2_19Mark *= -1;
            ...
            {
                if (!isP1_18Mark || !isP3_18Mark || !isP4_18Mark)
                {
                    P2_18Mark *= -1;
            ...
            {
                if (!isP1_17Mark || !isP3_17Mark || !isP4_17Mark)
                {
                    P2_17Mark *= -1;
            ...
            {
                if (!isP1_16Mark || !isP3_16Mark || !isP4_16Mark)
                {
                    P2_16Mark *= -1;
            ...
            {
                if (!isP1_15Mark || !isP3_15Mark || !isP4_15Mark)
                {
                    P2_15Mark *= -1;
            ...
            {
                if (!isP1_BullMark || !isP3_BullMark || !isP4_BullMark)
                {
                    P2_BullMark *= -1;
            ...
            {
                if (!isP1_20Mark || !isP2_20Mark || !isP4_20Mark)
                {
                    P3_20Mark *= -1;
            ...
            {
                if (!isP1_19Mark || !isP2_19Mark || !isP4_19Mark)
                {
                    P3_19Mark *= -1;
            ...
            {
                if (!isP1_18Mark || !isP2_18Mark || !isP4_18Mark)
                {
                    P3_18Mark *= -1;
            ...
            {
                if (!isP1_17Mark || !isP2_17Mark || !isP4_17Mark)
                {
                    P3_17Mark *= -1;
            ...
            {
                if (!isP1_16Mark || !isP2_16Mark || !isP4_16Mark)
                {
                    P3_16Mark *= -1;
            ...
            {
                if (!isP1_15Mark || !isP2_15Mark || !isP4_15Mark)
                {
                    P3_15Mark *= -1;
            ...
            {
                if (!isP1_BullMark || !isP2_BullMark || !isP4_BullMark)
                {
                    P3_BullMark *= -1;
            ...
            /*-----------------------------------------------------------------*/
            else if (P4_20Mark <= 0 && !isP4_20Mark)
            {
                if (!isP1_20Mark || !isP2_20Mark || !isP3_20Mark)
                {
                    P4_20Mark *= -1;
                    PlayerScore[0] += P4_20Mark;
                    g_P_Score[0].GetComponent<csNumber>().SetNumber(PlayerScore[0]);
                    g_OffScore[0].GetComponent<csNumber>().SetNumber(PlayerScore[0]);
                    PlayerScore[1] += P4_20Mark;
                    g_P_Score[1].GetComponent<csNumber>().SetNumber(PlayerScore[1]);
                    g_OffScore[1].GetComponent<csNumber>().SetNumber(PlayerScore[1]);
                    PlayerScore[2] += P4_20Mark;
                    g_P_Score[2].GetComponent<csNumber>().SetNumber(PlayerScore[2]);
                    g_OffScore[2].GetComponent<csNumber>().SetNumber(PlayerScore[2]);
                }
                isP4_20Mark = true;
            ...
            else if (P4_19Mark <= 0 && !isP4_19Mark)
            {
                if (!isP1_19Mark || !isP2_19Mark || !isP3_19Mark)
                {
                    P4_19Mark *= -1;
                    PlayerScore[0] += P4_19Mark;
                    g_P_Score[0].GetComponent<csNumber>().SetNumber(PlayerScore[0]);
                    g_OffScore[0].GetComponent<csNumber>().SetNumber(PlayerScore[0]);
                    PlayerScore[1] += P4_19Mark;
                    g_P_Score[1].GetComponent<csNumber>().SetNumber(PlayerScore[1]);
                    g_OffScore[1].GetComponent<csNumber>().SetNumber(PlayerScore[1]);
                    PlayerScore[2] += P4_19Mark;
                    g_P_Score[2].GetComponent<csNumber>().SetNumber(PlayerScore[2]);
                    g_OffScore[2].GetComponent<csNumber>().SetNumber(PlayerScore[2]);
                }
                isP4_19Mark = true;
            ...
            else if (P4_18Mark <= 0 && !isP4_18Mark)
            {
                if (!isP1_18Mark || !isP2_18Mark || !isP3_18Mark)
                {
                    P4_18Mark *= -1;
                    PlayerScore[0] += P4_18Mark;
                    g_P_Score[0].GetComponent<csNumber>().SetNumber(PlayerScore[0]);
                    g_OffScore[0].GetComponent<csNumber>().SetNumber(PlayerScore[0]);
                    PlayerScore[1] += P4_18Mark;
                    g_P_Score[1].GetComponent<csNumber>().SetNumber(PlayerScore[1]);
                    g_OffScore[1].GetComponent<csNumber>().SetNumber(PlayerScore[1]);
                    PlayerScore[2] += P4_18Mark;
                    g_P_Score[2].GetComponent<csNumber>().SetNumber(PlayerScore[2]);
                    g_OffScore[2].GetComponent<csNumber>().SetNumber(PlayerScore[2]);
                }
                isP4_18Mark = true;
            ...
            else if (P4_17Mark <= 0 && !isP4_17Mark)
            {
                if (!isP1_17Mark || !isP2_17Mark || !isP3_17Mark)
                {
                    P4_17Mark *= -1;
                    PlayerScore[0] += P4_17Mark;
                    g_P_Score[0].GetComponent<csNumber>().SetNumber(PlayerScore[0]);
                    g_OffScore[0].GetComponent<csNumber>().SetNumber(PlayerScore[0]);
                    PlayerScore[1] += P4_17Mark;
                    g_P_Score[1].GetComponent<csNumber>().SetNumber(PlayerScore[1]);
                    g_OffScore[1].GetComponent<csNumber>().SetNumber(PlayerScore[1]);
                    PlayerScore[2] += P4_17Mark;
                    g_P_Score[2].GetComponent<csNumber>().SetNumber(PlayerScore[2]);
                    g_OffScore[2].GetComponent<csNumber>().SetNumber(PlayerScore[2]);
                }
                isP4_17Mark = true;
            ...
            else if (P4_16Mark <= 0 && !isP4_16Mark)
            {
                if (!isP1_16Mark || !isP2_16Mark || !isP3_16Mark)
                {
                    P4_16Mark *= -1;
                    PlayerScore[0] += P4_16Mark;
                    g_P_Score[0].GetComponent<csNumber>().SetNumber(PlayerScore[0]);
                    g_OffScore[0].GetComponent<csNumber>().SetNumber(PlayerScore[0]);
                    PlayerScore[1] += P4_16Mark;
                    g_P_Score[1].GetComponent<csNumber>().SetNumber(PlayerScore[1]);
                    g_OffScore[1].GetComponent<csNumber>().SetNumber(PlayerScore[1]);
                    PlayerScore[2] += P4_16Mark;
                    g_P_Score[2].GetComponent<csNumber>().SetNumber(PlayerScore[2]);
                    g_OffScore[2].GetComponent<csNumber>().SetNumber(PlayerScore[2]);
                }
                isP4_16Mark = true;
            ...
            else if (P4_15Mark <= 0 && !isP4_15Mark)
            {
                if (!isP1_15Mark || !isP2_15Mark || !isP3_15Mark)
                {
                    P4_15Mark *= -1;
                    PlayerScore[0] += P4_15Mark;
                    g_P_Score[0].GetComponent<csNumber>().SetNumber(PlayerScore[0]);
                    g_OffScore[0].GetComponent<csNumber>().SetNumber(PlayerScore[0]);
                    PlayerScore[1] += P4_15Mark;
                    g_P_Score[1].GetComponent<csNumber>().SetNumber(PlayerScore[1]);
                    g_OffScore[1].GetComponent<csNumber>().SetNumber(PlayerScore[1]);
                    PlayerScore[2] += P4_15Mark;
                    g_P_Score[2].GetComponent<csNumber>().SetNumber(PlayerScore[2]);
                    g_OffScore[2].GetComponent<csNumber>().SetNumber(PlayerScore[2]);
                }
                isP4_15Mark = true;
            ...
            else if (P4_BullMark <= 0 && !isP4_BullMark)
            {
                if (!isP1_BullMark || !isP2_BullMark || !isP3_BullMark)
                {
                    P4_BullMark *= -1;
                    PlayerScore[0] += P4_BullMark;
                    g_P_Score[0].GetComponent<csNumber>().SetNumber(PlayerScore[0]);
                    g_OffScore[0].GetComponent<csNumber>().SetNumber(PlayerScore[0]);
                    PlayerScore[1] += P4_BullMark;
                    g_P_Score[1].GetComponent<csNumber>().SetNumber(PlayerScore[1]);
                    g_OffScore[1].GetComponent<csNumber>().SetNumber(PlayerScore[1]);
                    PlayerScore[2] += P4_BullMark;
                    g_P_Score[2].GetComponent<csNumber>().SetNumber(PlayerScore[2]);
                    g_OffScore[2].GetComponent<csNumber>().SetNumber(PlayerScore[2]);
                }
                isP4_BullMark = true;
