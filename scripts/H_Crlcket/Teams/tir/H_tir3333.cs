...
public class H_tir3333 : MonoBehaviour
{
    ...
    public int[] MarkSaveDT3 = new int[45];
    ...
    void MyTurn()
    {
        ...
        if (isAT && Players == 2)
        {
            ...
            g_i_Player[3].GetComponent<Image>().sprite = s_PlayerOff[2];
        ...
        if (isDT && Players == 2)
        {
            ...
            g_i_Player[3].GetComponent<Image>().sprite = s_PlayerOn[2];
            g_i_Player[0].GetComponent<Image>().sprite = s_PlayerOff[2];
            g_i_Player[1].GetComponent<Image>().sprite = s_PlayerOff[2];
            g_i_Player[2].GetComponent<Image>().sprite = s_PlayerOff[2];
    ...
    void ImageUp()
    {
        ...
        if (isDT && !isAT && !isBT && !isCT && Players == 0)
        {
            if (RScore == 5)
            {
                ...
                g_DT1RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[4]];
                g_DT1RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[5]];
                g_DT1RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[6]];

                g_DT1RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[7]];
                g_DT1RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[8]];
                g_DT1RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[9]];

                g_DT1RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[10]];
                g_DT1RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[11]];
                g_DT1RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[12]];

                g_DT1RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[13]];
                g_DT1RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[14]];
                g_DT1RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[15]];

                g_DT1RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[16]];
                g_DT1RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[17]];
                g_DT1RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[18]];
            }
            ...
            if (RScore == 6)
            {
                ...
                g_DT1RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[7]];
                g_DT1RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[8]];
                g_DT1RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[9]];

                g_DT1RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[10]];
                g_DT1RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[11]];
                g_DT1RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[12]];

                g_DT1RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[13]];
                g_DT1RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[14]];
                g_DT1RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[15]];

                g_DT1RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[16]];
                g_DT1RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[17]];
                g_DT1RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[18]];

                g_DT1RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[19]];
                g_DT1RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[20]];
                g_DT1RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[21]];
            }
            ...
            if (RScore == 7)
            {
                ...
                g_DT1RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[10]];
                g_DT1RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[11]];
                g_DT1RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[12]];

                g_DT1RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[13]];
                g_DT1RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[14]];
                g_DT1RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[15]];

                g_DT1RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[16]];
                g_DT1RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[17]];
                g_DT1RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[18]];

                g_DT1RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[19]];
                g_DT1RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[20]];
                g_DT1RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[21]];

                g_DT1RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[22]];
                g_DT1RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[23]];
                g_DT1RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[24]];
            }
            ...
            if (RScore == 8)
            {
                ...
                g_DT1RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[13]];
                g_DT1RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[14]];
                g_DT1RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[15]];

                g_DT1RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[16]];
                g_DT1RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[17]];
                g_DT1RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[18]];

                g_DT1RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[19]];
                g_DT1RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[20]];
                g_DT1RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[21]];

                g_DT1RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[22]];
                g_DT1RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[23]];
                g_DT1RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[24]];

                g_DT1RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[25]];
                g_DT1RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[26]];
                g_DT1RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[27]];
            }
            ...
            if (RScore == 9)
            {
                ...
                g_DT1RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[16]];
                g_DT1RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[17]];
                g_DT1RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[18]];

                g_DT1RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[19]];
                g_DT1RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[20]];
                g_DT1RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[21]];

                g_DT1RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[22]];
                g_DT1RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[23]];
                g_DT1RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[24]];

                g_DT1RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[25]];
                g_DT1RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[26]];
                g_DT1RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[27]];

                g_DT1RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[28]];
                g_DT1RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[29]];
                g_DT1RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[30]];
            }
            ...
            if (RScore == 10)
            {
                ...
                g_DT1RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[19]];
                g_DT1RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[20]];
                g_DT1RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[21]];

                g_DT1RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[22]];
                g_DT1RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[23]];
                g_DT1RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[24]];

                g_DT1RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[25]];
                g_DT1RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[26]];
                g_DT1RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[27]];

                g_DT1RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[28]];
                g_DT1RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[29]];
                g_DT1RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[30]];

                g_DT1RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[31]];
                g_DT1RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[32]];
                g_DT1RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[33]];
            }
            ...
            if (RScore == 11)
            {
                ...
                g_DT1RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[22]];
                g_DT1RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[23]];
                g_DT1RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[24]];

                g_DT1RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[25]];
                g_DT1RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[26]];
                g_DT1RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[27]];

                g_DT1RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[28]];
                g_DT1RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[29]];
                g_DT1RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[30]];

                g_DT1RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[31]];
                g_DT1RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[32]];
                g_DT1RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[33]];

                g_DT1RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[34]];
                g_DT1RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[35]];
                g_DT1RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[36]];
            }
            ...
            if (RScore == 12)
            {
                ...
                g_DT1RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[25]];
                g_DT1RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[26]];
                g_DT1RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[27]];

                g_DT1RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[28]];
                g_DT1RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[29]];
                g_DT1RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[30]];

                g_DT1RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[31]];
                g_DT1RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[32]];
                g_DT1RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[33]];

                g_DT1RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[34]];
                g_DT1RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[35]];
                g_DT1RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[36]];

                g_DT1RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[37]];
                g_DT1RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[38]];
                g_DT1RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[39]];
            }
            ...
            if (RScore == 13)
            {
                ...
                g_DT1RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[28]];
                g_DT1RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[29]];
                g_DT1RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[30]];

                g_DT1RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[31]];
                g_DT1RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[32]];
                g_DT1RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[33]];

                g_DT1RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[34]];
                g_DT1RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[35]];
                g_DT1RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[36]];

                g_DT1RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[37]];
                g_DT1RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[38]];
                g_DT1RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[39]];
            ...
            if (RScore == 14)
            {
                ...
                g_DT1RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[31]];
                g_DT1RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[32]];
                g_DT1RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[33]];

                g_DT1RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[34]];
                g_DT1RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[35]];
                g_DT1RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[36]];

                g_DT1RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[37]];
                g_DT1RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[38]];
                g_DT1RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[39]];

                g_DT1RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[40]];
                g_DT1RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[41]];
                g_DT1RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[42]];

                g_DT1RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[43]];
                g_DT1RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[44]];
                g_DT1RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT1[45]];
            }
        }
        ...
        if (isDT && !isAT && !isBT && !isCT && Players == 1)
        {
            ...
            if (RScore == 5)
            {
                ...
                g_DT2RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[4]];
                g_DT2RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[5]];
                g_DT2RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[6]];

                g_DT2RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[7]];
                g_DT2RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[8]];
                g_DT2RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[9]];

                g_DT2RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[10]];
                g_DT2RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[11]];
                g_DT2RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[12]];

                g_DT2RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[13]];
                g_DT2RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[14]];
                g_DT2RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[15]];

                g_DT2RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[16]];
                g_DT2RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[17]];
                g_DT2RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[18]];
            }
            ...
            if (RScore == 6)
            {
                ...
                g_DT2RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[7]];
                g_DT2RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[8]];
                g_DT2RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[9]];

                g_DT2RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[10]];
                g_DT2RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[11]];
                g_DT2RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[12]];

                g_DT2RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[13]];
                g_DT2RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[14]];
                g_DT2RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[15]];

                g_DT2RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[16]];
                g_DT2RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[17]];
                g_DT2RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[18]];

                g_DT2RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[19]];
                g_DT2RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[20]];
                g_DT2RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[21]];
            }
            ...
            if (RScore == 7)
            {
                ...
                g_DT2RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[10]];
                g_DT2RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[11]];
                g_DT2RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[12]];

                g_DT2RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[13]];
                g_DT2RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[14]];
                g_DT2RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[15]];

                g_DT2RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[16]];
                g_DT2RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[17]];
                g_DT2RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[18]];

                g_DT2RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[19]];
                g_DT2RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[20]];
                g_DT2RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[21]];

                g_DT2RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[22]];
                g_DT2RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[23]];
                g_DT2RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[24]];
            }
            ...
            if (RScore == 8)
            {
                ...
                g_DT2RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[13]];
                g_DT2RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[14]];
                g_DT2RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[15]];

                g_DT2RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[16]];
                g_DT2RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[17]];
                g_DT2RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[18]];

                g_DT2RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[19]];
                g_DT2RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[20]];
                g_DT2RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[21]];

                g_DT2RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[22]];
                g_DT2RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[23]];
                g_DT2RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[24]];

                g_DT2RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[25]];
                g_DT2RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[26]];
                g_DT2RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[27]];
            }
            ...
            if (RScore == 9)
            {
                ...
                g_DT2RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[16]];
                g_DT2RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[17]];
                g_DT2RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[18]];

                g_DT2RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[19]];
                g_DT2RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[20]];
                g_DT2RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[21]];

                g_DT2RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[22]];
                g_DT2RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[23]];
                g_DT2RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[24]];

                g_DT2RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[25]];
                g_DT2RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[26]];
                g_DT2RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[27]];

                g_DT2RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[28]];
                g_DT2RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[29]];
                g_DT2RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[30]];
            }
            ...
            if (RScore == 10)
            {
                ...
                g_DT2RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[19]];
                g_DT2RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[20]];
                g_DT2RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[21]];

                g_DT2RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[22]];
                g_DT2RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[23]];
                g_DT2RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[24]];

                g_DT2RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[25]];
                g_DT2RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[26]];
                g_DT2RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[27]];

                g_DT2RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[28]];
                g_DT2RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[29]];
                g_DT2RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[30]];

                g_DT2RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[31]];
                g_DT2RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[32]];
                g_DT2RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[33]];
            }
            ...
            if (RScore == 11)
            {
                ...
                g_DT2RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[22]];
                g_DT2RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[23]];
                g_DT2RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[24]];

                g_DT2RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[25]];
                g_DT2RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[26]];
                g_DT2RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[27]];

                g_DT2RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[28]];
                g_DT2RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[29]];
                g_DT2RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[30]];

                g_DT2RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[31]];
                g_DT2RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[32]];
                g_DT2RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[33]];

                g_DT2RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[34]];
                g_DT2RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[35]];
                g_DT2RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[36]];
            }
            ...
            if (RScore == 12)
            {
                ...
                g_DT2RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[25]];
                g_DT2RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[26]];
                g_DT2RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[27]];

                g_DT2RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[28]];
                g_DT2RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[29]];
                g_DT2RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[30]];

                g_DT2RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[31]];
                g_DT2RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[32]];
                g_DT2RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[33]];

                g_DT2RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[34]];
                g_DT2RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[35]];
                g_DT2RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[36]];

                g_DT2RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[37]];
                g_DT2RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[38]];
                g_DT2RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[39]];
            }
            ...
            if (RScore == 13)
            {
                ...
                g_DT2RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[28]];
                g_DT2RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[29]];
                g_DT2RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[30]];

                g_DT2RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[31]];
                g_DT2RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[32]];
                g_DT2RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[33]];

                g_DT2RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[34]];
                g_DT2RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[35]];
                g_DT2RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[36]];

                g_DT2RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[37]];
                g_DT2RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[38]];
                g_DT2RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[39]];
            ...
            if (RScore == 14)
            {
                ...
                g_DT2RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[31]];
                g_DT2RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[32]];
                g_DT2RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[33]];

                g_DT2RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[34]];
                g_DT2RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[35]];
                g_DT2RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[36]];

                g_DT2RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[37]];
                g_DT2RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[38]];
                g_DT2RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[39]];

                g_DT2RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[40]];
                g_DT2RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[41]];
                g_DT2RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[42]];

                g_DT2RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[43]];
                g_DT2RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[44]];
                g_DT2RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT2[45]];
            }
        }
        ...
        if (isDT && !isAT && !isBT && !isCT && Players == 2)
        {
            if (RScore == 5)
            {
                ...
                g_DT3RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[4]];
                g_DT3RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[5]];
                g_DT3RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[6]];

                g_DT3RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[7]];
                g_DT3RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[8]];
                g_DT3RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[9]];

                g_DT3RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[10]];
                g_DT3RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[11]];
                g_DT3RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[12]];

                g_DT3RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[13]];
                g_DT3RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[14]];
                g_DT3RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[15]];

                g_DT3RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[16]];
                g_DT3RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[17]];
                g_DT3RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[18]];
            }
            ...
            if (RScore == 6)
            {
                ...
                g_DT3RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[7]];
                g_DT3RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[8]];
                g_DT3RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[9]];

                g_DT3RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[10]];
                g_DT3RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[11]];
                g_DT3RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[12]];

                g_DT3RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[13]];
                g_DT3RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[14]];
                g_DT3RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[15]];

                g_DT3RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[16]];
                g_DT3RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[17]];
                g_DT3RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[18]];

                g_DT3RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[19]];
                g_DT3RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[20]];
                g_DT3RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[21]];
            }
            ...
            if (RScore == 7)
            {
                ...
                g_DT3RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[10]];
                g_DT3RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[11]];
                g_DT3RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[12]];

                g_DT3RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[13]];
                g_DT3RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[14]];
                g_DT3RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[15]];

                g_DT3RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[16]];
                g_DT3RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[17]];
                g_DT3RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[18]];

                g_DT3RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[19]];
                g_DT3RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[20]];
                g_DT3RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[21]];

                g_DT3RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[22]];
                g_DT3RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[23]];
                g_DT3RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[24]];
            }
            ...
            if (RScore == 8)
            {
                ...
                g_DT3RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[13]];
                g_DT3RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[14]];
                g_DT3RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[15]];

                g_DT3RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[16]];
                g_DT3RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[17]];
                g_DT3RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[18]];

                g_DT3RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[19]];
                g_DT3RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[20]];
                g_DT3RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[21]];

                g_DT3RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[22]];
                g_DT3RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[23]];
                g_DT3RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[24]];

                g_DT3RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[25]];
                g_DT3RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[26]];
                g_DT3RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[27]];
            }
            ...
            if (RScore == 9)
            {
                ...
                g_DT3RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[16]];
                g_DT3RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[17]];
                g_DT3RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[18]];

                g_DT3RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[19]];
                g_DT3RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[20]];
                g_DT3RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[21]];

                g_DT3RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[22]];
                g_DT3RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[23]];
                g_DT3RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[24]];

                g_DT3RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[25]];
                g_DT3RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[26]];
                g_DT3RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[27]];

                g_DT3RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[28]];
                g_DT3RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[29]];
                g_DT3RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[30]];
            }
            ...
            if (RScore == 10)
            {
                ...
                g_DT3RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[19]];
                g_DT3RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[20]];
                g_DT3RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[21]];

                g_DT3RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[22]];
                g_DT3RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[23]];
                g_DT3RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[24]];

                g_DT3RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[25]];
                g_DT3RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[26]];
                g_DT3RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[27]];

                g_DT3RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[28]];
                g_DT3RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[29]];
                g_DT3RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[30]];

                g_DT3RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[31]];
                g_DT3RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[32]];
                g_DT3RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[33]];
            }
            ...
            if (RScore == 11)
            {
                ...
                g_DT3RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[22]];
                g_DT3RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[23]];
                g_DT3RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[24]];

                g_DT3RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[25]];
                g_DT3RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[26]];
                g_DT3RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[27]];

                g_DT3RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[28]];
                g_DT3RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[29]];
                g_DT3RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[30]];

                g_DT3RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[31]];
                g_DT3RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[32]];
                g_DT3RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[33]];

                g_DT3RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[34]];
                g_DT3RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[35]];
                g_DT3RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[36]];
            }
            ...
            if (RScore == 12)
            {
                ...
                g_DT3RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[25]];
                g_DT3RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[26]];
                g_DT3RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[27]];

                g_DT3RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[28]];
                g_DT3RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[29]];
                g_DT3RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[30]];

                g_DT3RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[31]];
                g_DT3RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[32]];
                g_DT3RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[33]];

                g_DT3RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[34]];
                g_DT3RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[35]];
                g_DT3RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[36]];

                g_DT3RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[37]];
                g_DT3RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[38]];
                g_DT3RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[39]];
            }
            ...
            if (RScore == 13)
            {
                ...
                g_DT3RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[28]];
                g_DT3RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[29]];
                g_DT3RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[30]];

                g_DT3RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[31]];
                g_DT3RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[32]];
                g_DT3RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[33]];

                g_DT3RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[34]];
                g_DT3RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[35]];
                g_DT3RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[36]];

                g_DT3RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[37]];
                g_DT3RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[38]];
                g_DT3RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[39]];

                g_DT3RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[40]];
                g_DT3RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[41]];
                g_DT3RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[42]];
            }
            ...
            if (RScore == 14)
            {
                ...
                g_DT3RMark1[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[31]];
                g_DT3RMark1[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[32]];
                g_DT3RMark1[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[33]];

                g_DT3RMark2[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[34]];
                g_DT3RMark2[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[35]];
                g_DT3RMark2[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[36]];

                g_DT3RMark3[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[37]];
                g_DT3RMark3[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[38]];
                g_DT3RMark3[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[39]];

                g_DT3RMark4[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[40]];
                g_DT3RMark4[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[41]];
                g_DT3RMark4[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[42]];

                g_DT3RMark5[0].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[43]];
                g_DT3RMark5[1].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[44]];
                g_DT3RMark5[2].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[45]];
            }
        }
    }
    void RoundScore(int MarkScore)
    {
        ...
        if (isCT && !isDT && !isAT && !isBT && Players == 0)
        {
            ...
            if (Round <= RoundStop)
            {
                ...
                if (RScore == 8)
                {
                    g_CT1RMark1[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveCT1[13]];
                    g_CT1RMark1[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveCT1[14]];
                    g_CT1RMark1[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveCT1[15]];

                    g_CT1RMark2[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveCT1[16]];
                    g_CT1RMark2[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveCT1[17]];
                    g_CT1RMark2[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveCT1[18]];

                    g_CT1RMark3[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveCT1[19]];
                    g_CT1RMark3[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveCT1[20]];
                    g_CT1RMark3[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveCT1[21]];

                    g_CT1RMark4[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveCT1[22]];
                    g_CT1RMark4[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveCT1[23]];
                    g_CT1RMark4[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveCT1[24]];

                    g_CT1RMark5[0].GetComponent<Image>().sprite = s_BTMark[MarkSaveCT1[25]];
                    g_CT1RMark5[1].GetComponent<Image>().sprite = s_BTMark[MarkSaveCT1[26]];
                    g_CT1RMark5[2].GetComponent<Image>().sprite = s_BTMark[MarkSaveCT1[27]];
        ...
        if (isCT && !isDT && !isAT && !isBT && Players == 2)
        {
            ...
            if (Round <= RoundStop)
            {
                ...
                if (RScore == 10)
                {
                    g_CT3RMark1[0].GetComponent<Image>().sprite = s_CTMark[MarkSaveCT3[19]];
                    g_CT3RMark1[1].GetComponent<Image>().sprite = s_CTMark[MarkSaveCT3[20]];
                    g_CT3RMark1[2].GetComponent<Image>().sprite = s_CTMark[MarkSaveCT3[20]];
        ...
        if (isDT && !isAT && !isBT && !isCT && Players == 2)
        {
            MarkSaveDT3[DT3MarkCounting] = MarkScore;  //0이면 1마크 1이면 2마크 2이면 3마크
            if (Round <= RoundStop)
            {
                if (RScore == 0)
                    g_DT3RMark1[Counting].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[DT3MarkCounting]];

                if (RScore == 1)
                    g_DT3RMark2[Counting].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[DT3MarkCounting]];

                if (RScore == 2)
                    g_DT3RMark3[Counting].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[DT3MarkCounting]];

                if (RScore == 3)
                    g_DT3RMark4[Counting].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[DT3MarkCounting]];

                if (RScore == 4)
                    g_DT3RMark5[Counting].GetComponent<Image>().sprite = s_DTMark[MarkSaveDT3[DT3MarkCounting]];
    ...
    void MPRScore(int Dart)
    {
        ...
        {
            TotalD3 += Dart;
            AverageD3 = TotalD3 / RoundCountingD3;
