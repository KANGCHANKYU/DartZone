...
public class H_ThreePlayer : MonoBehaviour
{
    ...
    public bool isP3_BullAllLine = false;
    ...
    void MainMark()
    {
        ...
        /*--------------------------------------------------------------*/
        if (isP1_20Line && isP2_20Line && isP3_20Line)
        {
        ...
        if (isP1_19Line && isP2_19Line && isP2_19Line)
        {
        ...
        if (isP1_18Line && isP2_18Line && isP3_18Line)
        {
        ...
        if (isP1_17Line && isP2_17Line && isP3_17Line)
        {
        ...
        if (isP1_16Line && isP2_16Line && isP3_16Line)
        {
        ...
        if (isP1_15Line && isP2_15Line && isP3_15Line)
        {
        ...
        if (isP1_BullLine && isP2_BullLine && isP3_BullLine)
        {
    ...
    void LineScore()
    {
        if (Counting != 3 && gmg.isAni == false)
        {
            ...
            {
                if (!isP2_BullLine || !isP3_BullLine)
                {
                    P1_BullLMark *= -1;
            ...
            {
                if (!isP1_BullLine || !isP3_BullLine)
                {
                    P2_BullLMark *= -1;
